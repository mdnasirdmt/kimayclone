! function() {
    ...
    function t(e, n) {
        ...
        if (n = n || {}, this.trackingClick = !1, this.trackingClickStart = 0, this.targetElement = null, this.touchStartX = 0, this.touchStartY = 0, this.lastTouchIdentifier = 0, this.touchBoundary = n.touchBoundary || 10, this.layer = e, this.tapDelay = n.tapDelay || 200, this.tapTimeout = n.tapTimeout || 700, !t.notNeeded(e)) {
            for (var r = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], a = this, l = 0, h = r.length; h > l; l++) a[r[l]] = s(a[r[l]], a);
    ...
    t.prototype.needsClick = function(t) {
        ...
        var e, r, a, l, h, c = this.targetElement;
...
function() {
        ...
        function n(e) {
            function n() {
                if (!c) {
                    ...
                    if (a = function() {
                        ...
                        r.appendChild(o);
                        var p = a(o);
                        h = 200 === i(p.width), r.removeChild(o)
                    }
                }
            }
            ...
            return function(t) {
                if (n(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                    ...
                    for (var c = s.isBorderBox = !(!l || !e[l] || "border-box" !== e[l]), p = 0, u = o.length; u > p; p++) {
                        var d = o[p],
                            f = e[d];
                        f = r(t, f);
                        var m = parseFloat(f);
                    ...
                    var g = s.paddingLeft + s.paddingRight,
                        ...
                        b = c && h,
                        T = i(e.width);
                    !1 !== T && (s.width = T + (b ? 0 : g + w));
                    var S = i(e.height);
                    return !1 !== S && (s.height = S + (b ? 0 : v + x)), s.innerWidth = s.width - (g + w), s.innerHeight = s.height - (v + x), s.outerWidth = s.width + y, s.outerHeight = s.height + _, s
                }
            }
        }
    ...
    function(t, e) {
        ...
        n.isArray = function(t) {
            ...
            for (var s = [], o = 0, r = (t = n.makeArray(t)).length; r > o; o++) {
                var a = t[o];
                if (n.isElement(a))
                    if (e) {
                        i(a, e) && s.push(a);
                        for (var l = a.querySelectorAll(e), h = 0, c = l.length; c > h; h++) s.push(l[h])
                    } else s.push(a)
            }
            return s
            ...
            e(function() {
                for (var e = n.toDashed(s), r = document.querySelectorAll(".js-" + e), a = "data-" + e + "-options", l = 0, h = r.length; h > l; l++) {
                    ...
                    try {
                        ...
                        o && o.error("Error parsing " + a + " on " + p.nodeName.toLowerCase() + (p.id ? "#" + p.id : "") + ": " + t);
                        continue
                    }
                    var d = new i(p, c),
                        f = t.jQuery;
    ...
    function(t, e) {
        ...
        s.extend(o.prototype, e.prototype), o.prototype._create = function() {
            ...
            l = isNaN(l) ? 0 : l, h = isNaN(h) ? 0 : h, l -= i ? r.paddingLeft : r.paddingRight, h -= n ? r.paddingTop : r.paddingBottom, this.position.x = l, this.position.y = h
    ...
    function(t, e) {
        ...
        return n.prototype._resetLayout = function() {
            ...
            for (var s = this._getColGroup(n), o = Math.min.apply(Math, s), r = i.indexOf(s, o), a = {
                    x: this.columnWidth * r,
                    y: o
                }, l = o + t.size.outerHeight, h = this.cols + 1 - s.length, c = 0; h > c; c++) this.colYs[r + c] = l;
            return a
    ...
    function(t, e) {
        ...
        c.Item = o, c.LayoutMode = r, c.prototype._create = function() {
    ...
    function(t) {
        ...
        var o = /\+/g,
            r = t.cookie = function(o, a, l) {
                ...
                for (var p = o ? void 0 : {}, u = document.cookie ? document.cookie.split("; ") : [], d = 0, f = u.length; f > d; d++) {
                    var m = u[d].split("="),
                        g = i(m.shift()),
                        v = m.join("=");
                    if (o === g) {
                ...
                if (s)
                    for (var o = 0, r = s.length; r > o; ++o) {
                        var l = s[o].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/),
                            ...
                            p = l[3] || "",
                            u = null;
                        l = l[2], a.hasOwnProperty(l) && (u = a[l], u = Number(t[u])), null !== u && ("!" === c && (u = n(p, u)), "" === c && 10 > u && (u = "0" + u.toString()), i = i.replace(h, u.toString()))
                    }
                return i.replace(/%%/, "%")
            }
        }
    ...
    function(t) {
        t.fn.justifiedGallery = function(e) {
            ...
            function n(t, e) {
                var n = !1;
                for (var s in e.settings.sizeRangeSuffixes)
                    if (0 !== e.settings.sizeRangeSuffixes[s].length) {
                        if (i(t, e.settings.sizeRangeSuffixes[s])) return e.settings.sizeRangeSuffixes[s]
                    } else n = !0;
                if (n) return "";
            ...
            function s(t, e, i, s) {
                var o = t.match(s.settings.extension),
                    r = null != o ? o[0] : "",
                    a = t.replace(s.settings.extension, "");
                return (a = function(t, e) {
                    return t.substring(0, t.length - e.length)
                }(a, n(a, s))) + (function(t, e, i) {
                    var n;
                    return 100 >= (n = t > e ? t : e) ? i.settings.sizeRangeSuffixes.lt100 : 240 >= n ? i.settings.sizeRangeSuffixes.lt240 : 320 >= n ? i.settings.sizeRangeSuffixes.lt320 : 500 >= n ? i.settings.sizeRangeSuffixes.lt500 : 640 >= n ? i.settings.sizeRangeSuffixes.lt640 : i.settings.sizeRangeSuffixes.lt1024
                }(e, i, s) + r)
            }

            function o(e) {
                var i = t(e.currentTarget).find(".caption");
                e.data.settings.cssAnimation ? i.addClass("caption-visible").removeClass("caption-hidden") : i.stop().fadeTo(e.data.settings.captionSettings.animationDuration, e.data.settings.captionSettings.visibleOpacity)
            }

            function r(e) {
                var i = t(e.currentTarget).find(".caption");
                e.data.settings.cssAnimation ? i.removeClass("caption-visible").removeClass("caption-hidden") : i.stop().fadeTo(e.data.settings.captionSettings.animationDuration, e.data.settings.captionSettings.nonVisibleOpacity)
            }
            ...
            function l(t, e) {
                e.settings.cssAnimation ? t.removeClass("entry-visible") : t.stop().fadeTo(0, 0)
            }

            function h(t) {
                var e = t.find("> img");
                return 0 === e.length && (e = t.find("> a > img")), e
            }

            function c(e, i, n, l, c, p, u) {
                function d() {
                    m !== v && f.attr("src", v)
                }
                var f = h(e);
                f.css("width", l), f.css("height", c), f.css("margin-left", -l / 2), f.css("margin-top", -c / 2), e.width(l), e.height(p), e.css("top", n), e.css("left", i);
                var m = f.attr("src"),
                    v = s(m, l, c, u);
                f.one("error", function() {
                    f.attr("src", f.data("jg.originalSrc"))
                }), "skipped" === f.data("jg.loaded") ? g(m, function() {
                    a(e, d, u), f.data("jg.loaded", !0)
                }) : a(e, d, u);
                var y = e.data("jg.captionMouseEvents");
                if (!0 === u.settings.captions) {
                    var _ = e.find(".caption");
                    if (0 === _.length) {
                        var w = f.attr("alt");
                        void 0 === w && (w = e.attr("title")), void 0 !== w && (_ = t('<div class="caption">' + w + "</div>"), e.append(_))
                    }
                    0 !== _.length && (u.settings.cssAnimation || _.stop().fadeTo(u.settings.imagesAnimationDuration, u.settings.captionSettings.nonVisibleOpacity), void 0 === y && (y = {
                        mouseenter: o,
                        mouseleave: r
                    }, e.on("mouseenter", void 0, u, y.mouseenter), e.on("mouseleave", void 0, u, y.mouseleave), e.data("jg.captionMouseEvents", y)))
                } else void 0 !== y && (e.off("mouseenter", void 0, u, y.mouseenter), e.off("mouseleave", void 0, u, y.mouseleave), e.removeData("jg.captionMouseEvents"))
            }
            ...
            function u(t, e) {
                var i, n, s, o, r = t.settings,
                    a = t.border;
                if (o = function(t, e) {
                        var i, n, s, o, r, a, l = t.settings,
                            c = !0,
                            p = 0,
                            u = t.galleryWidth - 2 * t.border - (t.buildingRow.entriesBuff.length - 1) * l.margins,
                            d = u / t.buildingRow.aspectRatio,
                            f = t.buildingRow.width / u > l.justifyThreshold;
                        if (e && "hide" === l.lastRow && !f) {
                            for (i = 0; i < t.buildingRow.entriesBuff.length; i++) n = t.buildingRow.entriesBuff[i], l.cssAnimation ? n.removeClass("entry-visible") : n.stop().fadeTo(0, 0);
                            return -1
                        }
                        for (e && !f && "nojustify" === l.lastRow && (c = !1), i = 0; i < t.buildingRow.entriesBuff.length; i++) o = (s = h(t.buildingRow.entriesBuff[i])).data("jg.imgw") / s.data("jg.imgh"), c ? (r = i === t.buildingRow.entriesBuff.length - 1 ? u : d * o, a = d) : (r = l.rowHeight * o, a = l.rowHeight), u -= Math.round(r), s.data("jg.jimgw", Math.round(r)), s.data("jg.jimgh", Math.ceil(a)), (0 === i || p > a) && (p = a);
                        return l.fixedHeight && p > l.rowHeight && (p = l.rowHeight), {
                            minHeight: p,
                            justify: c
                        }
                    }(t, e), s = o.minHeight, e && "hide" === r.lastRow && -1 === s) return t.buildingRow.entriesBuff = [], t.buildingRow.aspectRatio = 0, void(t.buildingRow.width = 0);
                r.maxRowHeight > 0 && r.maxRowHeight < s ? s = r.maxRowHeight : 0 === r.maxRowHeight && 1.5 * r.rowHeight < s && (s = 1.5 * r.rowHeight);
                for (var l = 0; l < t.buildingRow.entriesBuff.length; l++) n = h(i = t.buildingRow.entriesBuff[l]), c(i, a, t.offY, n.data("jg.jimgw"), n.data("jg.jimgh"), s, t), a += n.data("jg.jimgw") + r.margins;
                t.$gallery.height(t.offY + s + t.border + (t.spinner.active ? t.spinner.$el.innerHeight() : 0)), (!e || s <= t.settings.rowHeight && o.justify) && (t.offY += s + t.settings.margins, t.buildingRow.entriesBuff = [], t.buildingRow.aspectRatio = 0, t.buildingRow.width = 0, t.$gallery.trigger("jg.rowflush"))
            }
            ...
            function f(t, e) {
                d(t), t.imgAnalyzerTimeout = setTimeout(function() {
                    m(t, e)
                }, .001), m(t, e)
            }

            function m(e, i) {
                for (var n, s = e.settings, o = e.lastAnalyzedIndex + 1; o < e.entries.length; o++) {
                    var r = t(e.entries[o]),
                        a = h(r);
                    if (!0 === a.data("jg.loaded") || "skipped" === a.data("jg.loaded")) {
                        n = o >= e.entries.length - 1;
                        var l = e.galleryWidth - 2 * e.border - (e.buildingRow.entriesBuff.length - 1) * s.margins,
                            c = a.data("jg.imgw") / a.data("jg.imgh");
                        if (l / (e.buildingRow.aspectRatio + c) < s.rowHeight && (u(e, n), ++e.yield.flushed >= e.yield.every)) return void f(e, i);
                        e.buildingRow.entriesBuff.push(r), e.buildingRow.aspectRatio += c, e.buildingRow.width += c * s.rowHeight, e.lastAnalyzedIndex = o
                    } else if ("error" !== a.data("jg.loaded")) return
                }
                e.buildingRow.entriesBuff.length > 0 && u(e, !0), e.spinner.active && (e.spinner.active = !1, e.$gallery.height(e.$gallery.height() - e.spinner.$el.innerHeight()), e.spinner.$el.detach(), function(t) {
                    clearInterval(t.intervalId), t.intervalId = null
                }(e.spinner)), d(e), e.$gallery.trigger(i ? "jg.resize" : "jg.complete")
            }
            ...
            return this.each(function(i, n) {
                ...
                if (void 0 === o) {
                    if (null != e && "object" != typeof e) throw "The argument must be an object";
                    var r = t('<div class="spinner"><span></span><span></span><span></span></div>'),
                        a = t.extend({}, v, e),
                        c = a.border >= 0 ? a.border : a.margins;
                    o = {
                        settings: a,
                    ...
                    for (var u = 0; u < o.buildingRow.entriesBuff.length; u++) l(o.buildingRow.entriesBuff[u], o);
                else o.settings = t.extend({}, o.settings, e), o.border = o.settings.border >= 0 ? o.settings.border : o.settings.margins, p(o);
                if (function(t) {
                        function e(t) {
                        ...
                        if (e("lt100"), e("lt240"), e("lt320"), e("lt500"), e("lt640"), e("lt1024"), i(n, "rowHeight"), i(n, "maxRowHeight"), n.maxRowHeight > 0 && n.maxRowHeight < n.rowHeight && (n.maxRowHeight = n.rowHeight), i(n, "margins"), i(n, "border"), "nojustify" !== n.lastRow && "justify" !== n.lastRow && "hide" !== n.lastRow) throw 'lastRow must be "nojustify", "justify" or "hide"';
                    ...
                    }(o), o.entries = s.find("> a, > div:not(.spinner)").toArray(), 0 !== o.entries.length) {
                    o.settings.randomize && (o.entries.sort(function() {
                        return 2 * Math.random() - 1
                    }), t.each(o.entries, function() {
                        t(this).appendTo(s)
                    }));
                    var d = !1,
                        m = !1;
                    t.each(o.entries, function(e, i) {
                            var n = t(i),
                                r = h(n);
                            if (n.addClass("jg-entry"), !0 !== r.data("jg.loaded") && "skipped" !== r.data("jg.loaded")) {
                                null !== o.settings.rel && n.attr("rel", o.settings.rel), null !== o.settings.target && n.attr("target", o.settings.target);
                                var a = void 0 !== r.data("safe-src") ? r.data("safe-src") : r.attr("src");
                                r.data("jg.originalSrc", a), r.attr("src", a);
                                var l = parseInt(r.attr("width"), 10),
                                    c = parseInt(r.attr("height"), 10);
                                if (!0 !== o.settings.waitThumbnailsLoad && !isNaN(l) && !isNaN(c)) return r.data("jg.imgw", l), r.data("jg.imgh", c), r.data("jg.loaded", "skipped"), m = !0, f(o, !1), !0;
                                r.data("jg.loaded", !1), d = !0, !1 === o.spinner.active && (o.spinner.active = !0, s.append(o.spinner.$el), s.height(o.offY + o.spinner.$el.innerHeight()), function(t) {
                                ...
                                }(o.spinner)), g(a, function(t) {
                                    r.data("jg.imgw", t.width), r.data("jg.imgh", t.height), r.data("jg.loaded", !0), f(o, !1)
                                }, function() {
                                    r.data("jg.loaded", "error"), f(o, !1)
                                })
                            }
                        }), d || m || f(o, !1),
                        function(t) {
                            t.checkWidthIntervalId = setInterval(function() {
                                var e = parseInt(t.$gallery.width(), 10);
                                t.galleryWidth !== e && (t.galleryWidth = e, p(t), f(t, !0))
    ...
    function(t) {
        ...
        var e, i, n, s, o, r, a = "Close",
            ...
            b = function(i, n) {
                e.ev.triggerHandler(u + i, n), e.st.callbacks && (i = i.charAt(0).toLowerCase() + i.slice(1), e.st.callbacks[i] && e.st.callbacks[i].apply(e, t.isArray(n) ? n : [n]))
            },
            T = function(i) {
        ...
        v.prototype = {
            ...
            open: function(i) {
                ...
                if (!e.isOpen) {
                    ...
                    b("BeforeOpen"), e.st.showCloseBtn && (e.st.closeBtnInside ? (w(h, function(t, e, i, n) {
                    ...
                    return e.isIE7 && (v += " mfp-ie7"), v && e._addClassToMFP(v), e.updateItemHTML(), b("BuildControls"), t("html").css(m), e.bgOverlay.add(e.wrap).prependTo(e.st.prependTo || t(document.body)), e._lastFocusedEl = document.activeElement, setTimeout(function() {
                        e.content ? (e._addClassToMFP(f), e._setFocus()) : e.bgOverlay.addClass(f), n.on("focusin" + d, e._onFocusIn)
                    }, 16), e.isOpen = !0, e.updateSize(u), b(c), i
                }
                e.updateItemHTML()
            },
            close: function() {
                e.isOpen && (b(l), e.isOpen = !1, e.st.removalDelay && !e.isLowIE && e.supportsTransition ? (e._addClassToMFP(m), setTimeout(function() {
                    e._close()
            ...
            updateItemHTML: function() {
                ...
                e.appendContent(r, n), i.preloaded = !0, b(p, i), s = i.type, e.container.prepend(e.contentContainer), b("AfterChange")
            },
            appendContent: function(t, i) {
                e.content = t, t ? e.st.showCloseBtn && e.st.closeBtnInside && !0 === e.currTemplate[i] ? e.content.find(".mfp-close").length || e.content.append(T()) : e.content = t : e.content = "", b("BeforeAppend"), e.container.addClass("mfp-" + i + "-holder"), e.contentContainer.append(e.content)
            },
            parseEl: function(i) {
                var n, s = e.items[i];
                if (s.tagName ? s = {
                ...
                return s.type = n || e.st.type || "inline", s.index = i, s.parsed = !0, e.items[i] = s, b("ElementParse", s), e.items[i]
            },
            ...
            updateStatus: function(t, n) {
                if (e.preloader) {
                    ...
                    b("UpdateStatus", s), t = s.status, n = s.text, e.preloader.html(n), e.preloader.find("a").on("click", function(t) {
            ...
            _parseMarkup: function(e, i, n) {
                var s;
                n.data && (i = t.extend(n.data, i)), b(h, [e, i, n]), t.each(i, function(t, i) {
        ...
        var k, C, P, E = "inline",
            O = function() {
                P && (C.after(P.addClass(k)).detach(), P = null)
            };
                ...
                getInline: function(i, n) {
                    if (O(), i.src) {
                        ...
                        if (o.length) {
                            ...
                            r && r.tagName && (C || (k = s.hiddenClass, C = x(k), k = "mfp-" + k), P = o.after(C).detach().removeClass(k)), e.updateStatus("ready")
        ...
        t.magnificPopup.registerModule(M, {
            ...
            proto: {
                initAjax: function() {
                    e.types.push(M), I = e.st.ajax.cursor, w(a + "." + M, A), w("BeforeChange." + M, A)
                },
                getAjax: function(i) {
                    ...
                    var n = t.extend({
                        ...
                        success: function(n, s, o) {
                            ...
                            b("ParseAjax", r), e.appendContent(t(r.data), M), i.finished = !0, z(), e._setFocus(), setTimeout(function() {
                                e.wrap.addClass(f)
            ...
            proto: {
                initImage: function() {
                    ...
                    e.types.push("image"), w(c + n, function() {
                        ...
                        i.cursor && t(document.body).removeClass(i.cursor), _.off("resize" + d)
                ...
                _onImageHasSize: function(t) {
                    t.img && (t.hasSize = !0, R && clearInterval(R), t.isCheckingImgSize = !1, b("ImageHasSize", t), t.imgHidden && (e.content && e.content.removeClass("mfp-loading"), t.imgHidden = !1))
                },
                    ...
                    var i = 0,
                        ...
                        s = function(o) {
                            R && clearInterval(R), R = setInterval(function() {
                                return n.naturalWidth > 0 ? void e._onImageHasSize(t) : (i > 200 && clearInterval(R), void(3 === ++i ? s(10) : 40 === i ? s(50) : 100 === i && s(500)))
                            }, o)
                        };
                    s(1)
                },
                getImage: function(i, n) {
                    var s = 0,
                        o = function() {
                            i && (i.img[0].complete ? (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, b("ImageLoadComplete")) : 200 > ++s ? setTimeout(o, 100) : r())
                        },
                        r = function() {
        ...
        t.magnificPopup.registerModule("zoom", {
            ...
            proto: {
                ...
                _getOffset: function(i) {
                    ...
                    return void 0 === $ && ($ = void 0 !== document.createElement("p").style.MozTransform), $ ? a["-moz-transform"] = a.transform = "translate(" + s.left + "px," + s.top + "px)" : (a.left = s.left, a.top = s.top), a
                }
            }
        });
        var D = "iframe",
        ...
        t.magnificPopup.registerModule(D, {
            ...
            proto: {
                initIframe: function() {
                    e.types.push(D), w("BeforeChange", function(t, e, i) {
                        e !== i && (e === D ? j() : i === D && j(!0))
                    }), w(a + "." + D, function() {
                        j()
                    })
        ...
        t.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                initGallery: function() {
                    ...
                    return e.direction = !0, !(!i || !i.enabled) && (o += " mfp-gallery", w(c + s, function() {
                    ...
                    }), w(h + s, function(t, n, s, o) {
                        var r = e.items.length;
                        s.counter = r > 1 ? H(i.tCounter, o.index, r) : ""
                        ...
                        if (e.items.length > 1 && i.arrows && !e.arrowLeft) {
                            ...
                            s[a](function() {
                                ...
                                e.next()
                            }), e.isIE7 && (x("b", s[0], !1, !0), x("a", s[0], !1, !0), x("b", o[0], !1, !0), x("a", o[0], !1, !0)), e.container.append(s.add(o))
                        }
                    }), w(p + s, function() {
        ...
        t.magnificPopup.registerModule(N, {
            ...
            function() {
                var e = "ontouchstart" in window,
                    i = function() {
                        _.off("touchmove" + n + " touchend" + n)
                    },
                    n = ".mfpFastClick";
                t.fn.mfpFastClick = function(s) {
                    return t(this).each(function() {
                        var o, r, a, l, h, c, p, u = t(this);
                        e && u.on("touchstart" + n, function(t) {
                            h = !1, p = 1, c = t.originalEvent ? t.originalEvent.touches[0] : t.touches[0], a = c.clientX, l = c.clientY, _.on("touchmove" + n, function(t) {
                                c = t.originalEvent ? t.originalEvent.touches : t.touches, p = c.length, c = c[0], (Math.abs(c.clientX - a) > 10 || Math.abs(c.clientY - l) > 10) && (h = !0, i())
                            }).on("touchend" + n, function(t) {
                                i(), h || p > 1 || (o = !0, t.preventDefault(), clearTimeout(r), r = setTimeout(function() {
                                    o = !1
                                }, 1e3), s())
                            })
                        });
                    ...
                    t(this).off("touchstart" + n + " click" + n), e && _.off("touchmove" + n + " touchend" + n)
                }
            }(), S()
    }),
    function(t) {
        ...
        "use strict";
        var n, s, o, r, a, l, h, c, p, u, d, f, m, g, v, y, _, w, x, b, T, S, k, C, P;
        w = {
            paneClass: "nano-pane",
            ...
            windowContext: null
        }, g = "scroll", h = "mousedown", c = "mouseenter", p = "mousemove", d = "mousewheel", u = "mouseup", m = "resize", a = "drag", l = "enter", y = "up", o = "DOMMouseScroll", r = "down", v = "touchmove", n = "Microsoft Internet Explorer" === e.navigator.appName && /msie 7./i.test(e.navigator.appVersion) && e.ActiveXObject, s = null, S = e.requestAnimationFrame, _ = e.cancelAnimationFrame, C = i.createElement("div").style, P = function() {
            var t, e, i, n;
            for (t = i = 0, n = (e = ["t", "webkitT", "MozT", "msT", "OT"]).length; n > i; t = ++i)
                if (e[t], e[t] + "ransform" in C) return e[t].substr(0, e[t].length - 1);
            return !1
        }(), k = function(t) {
            return !1 !== P && ("" === P ? t : P + t.charAt(0).toUpperCase() + t.substr(1))
        }("transform"), b = !1 !== k, x = function() {
            var t, e, n;
            return (e = (t = i.createElement("div")).style).position = "absolute", e.width = "100px", e.height = "100px", e.overflow = g, e.top = "-9999px", i.body.appendChild(t), n = t.offsetWidth - t.clientWidth, i.body.removeChild(t), n
        }, T = function() {
            var t, i, n;
            ...
            return f.prototype.preventScrolling = function(t, e) {
                if (this.isActive)
                    if (t.type === o)(e === r && t.originalEvent.detail > 0 || e === y && t.originalEvent.detail < 0) && t.preventDefault();
                    else if (t.type === d) {
                ...
                var t, e;
                b ? (t = {})[k] = "translate(0, " + this.sliderTop + "px)" : t = {
                    top: this.sliderTop
                }, S ? (_ && this.scrollRAF && _(this.scrollRAF), this.scrollRAF = S((e = this, function() {
                ...
                this.events = {
                    down: (t = this, function(e) {
                        return t.isBeingDragged = !0, t.offsetY = e.pageY - t.slider.offset().top, t.slider.is(e.target) || (t.offsetY = 0), t.pane.addClass(t.options.activeClass), t.doc.bind(p, t.events[a]).bind(u, t.events.up), t.body.bind(c, t.events[l]), !1
                    }),
                    drag: function(t) {
                        return function(e) {
                    ...
                    up: function(t) {
                        return function(e) {
                            return t.isBeingDragged = !1, t.pane.removeClass(t.options.activeClass), t.doc.unbind(p, t.events[a]).unbind(u, t.events.up), t.body.unbind(c, t.events[l]), !1
                        }
                    }(this),
                    resize: function(t) {
                        return function(e) {
                ...
                var t;
                this.removeEvents(), t = this.events, this.options.disableResize || this.win.bind(m, t[m]), this.iOSNativeScrolling || (this.slider.bind(h, t[r]), this.pane.bind(h, t.panedown).bind(d + " " + o, t.wheel)), this.$content.bind(g + " " + d + " " + o + " " + v, t[g])
                ...
                var t, i, n, o, r;
                return o = (i = this.options).paneClass, r = i.sliderClass, i.contentClass, (n = this.$el.children("." + o)).length || n.children("." + r).length || this.$el.append('<div class="' + o + '"><div class="' + r + '" /></div>'), this.pane = this.$el.children("." + o), this.slider = this.pane.find("." + r), 0 === s && T() ? t = {
                    right: -14,
            ...
            }, f.prototype.scrollBottom = function(t) {
            ...
            }, f.prototype.scrollTop = function(t) {
            ...
            return this.each(function() {
                var i, n;
                if ((n = this.nanoscroller) || (i = t.extend({}, w, e), this.nanoscroller = n = new f(this, i)), e && "object" == typeof e) {
    ...
    function(t, e, i, n) {
        function s(e, i) {
            this.element = e, this.settings = t.extend({}, r, i), this._defaults = r, this._name = o, this.init()
        }
        var o = "panr",
            r = {
                sensitivity: 20,
        ...
        s.prototype = {
            init: function() {
                var e, i, n, s, o, r, a = this.settings,
                    l = t(this.element),
                    h = l.width(),
                    c = (l.height(), l.width() - a.sensitivity),
                    p = (h - c) / c;
                (a.scale || !a.scaleOnHover && a.scale) && TweenMax.set(l.find("img"), {
                    scale: a.scaleTo
                }), "string" === jQuery.type(a.moveTarget) && (a.moveTarget = t(this.element).parent(a.moveTarget)), a.moveTarget || (a.moveTarget = t(this.element)), a.moveTarget.on("mousemove", function(r) {
                    e = r.pageX - l.offset().left, i = r.pageY - l.offset().top, a.panX && (s = {
                        x: -p * e
                    }), a.panY && (o = {
                        y: -p * i
                    }), n = t.extend({}, s, o), TweenMax.to(l.find("img"), a.panDuration, n)
                }), a.moveTarget.on("mouseenter", function(t) {
                    a.scaleOnHover && TweenMax.to(l.find("img"), a.scaleDuration, {
                        scale: a.scaleTo
                    }), a.onEnter(l)
                    ...
                    TweenMax.to(l.find("img"), a.scaleDuration, r), a.onLeave(l)
                })
            }
        }, t.fn[o] = function(e) {
            return this.each(function() {
    ...
    function(t) {
        ...
        function i(e, i, n) {
            ...
            if (!(e.which > 1 || e.metaKey || e.ctrlKey || e.shiftKey || e.altKey || location.protocol !== o.protocol || location.hostname !== o.hostname || o.href.indexOf("#") > -1 && f(o) == f(location) || e.isDefaultPrevented())) {
                var r = {
                        url: o.href,
        ...
        function s(e) {
            function i(e, i, n) {
                n || (n = {}), n.relatedTarget = o;
                var s = t.Event(e, n);
                return l.trigger(s, i), !s.isDefaultPrevented()
            }
            e = t.extend(!0, {}, t.ajaxSettings, s.defaults, e), t.isFunction(e.url) && (e.url = e.url());
            var n, o = e.target,
                a = d(e.url).hash,
                l = e.context = g(e.container);
            e.data || (e.data = {}), t.isArray(e.data) ? e.data.push({
                name: "_pjax",
                value: l.selector
            }) : e.data._pjax = l.selector, e.beforeSend = function(t, s) {
                if ("GET" !== s.type && (s.timeout = 0), t.setRequestHeader("X-PJAX", "true"), t.setRequestHeader("X-PJAX-Container", l.selector), !i("pjax:beforeSend", [t, s])) return !1;
                s.timeout > 0 && (n = setTimeout(function() {
                    i("pjax:timeout", [t, e]) && t.abort("timeout")
                }, s.timeout), s.timeout = 0);
                var o = d(s.url);
                a && (o.hash = a), e.requestUrl = u(o)
            }, e.complete = function(t, s) {
                n && clearTimeout(n), i("pjax:complete", [t, s, e]), i("pjax:end", [t, e])
            }, e.error = function(t, n, s) {
                var o = _("", t, e),
                    a = i("pjax:error", [t, n, s, e]);
                "GET" == e.type && "abort" !== n && a && r(o.url)
            }, e.success = function(n, o, h) {
                var p = s.state,
                    u = "function" == typeof t.pjax.defaults.version ? t.pjax.defaults.version() : t.pjax.defaults.version,
                    f = h.getResponseHeader("X-PJAX-Version"),
                    m = _(n, h, e),
                    g = d(m.url);
                if (a && (g.hash = a, m.url = g.href), u && f && u !== f) r(m.url);
                else if (m.contents) {
                    if (s.state = {
                            id: e.id || c(),
                            url: m.url,
                            title: m.title,
                            container: l.selector,
                            fragment: e.fragment,
                            timeout: e.timeout
                        }, (e.push || e.replace) && window.history.replaceState(s.state, m.title, m.url), t.contains(e.container, document.activeElement)) try {
                        document.activeElement.blur()
                    } catch (t) {}
                    m.title && (document.title = m.title), i("pjax:beforeReplace", [m.contents, e], {
                        state: s.state,
                        previousState: p
                    }), l.html(m.contents);
                                ...
                                e.each(function() {
                                    ...
                                    if (!n.length) {
                                        var s = document.createElement("script"),
                                            o = t(this).attr("type");
                                        o && (s.type = o), s.src = t(this).attr("src"), document.head.appendChild(s)
                                    }
                                })
                            }
                        }(m.scripts);
                    var y = e.scrollTo;
                    if (a) {
                        var w = decodeURIComponent(a.slice(1)),
                            x = document.getElementById(w) || document.getElementsByName(w)[0];
                        x && (y = t(x).offset().top)
                    }
                    "number" == typeof y && t(window).scrollTop(y), i("pjax:success", [n, o, h, e])
                } else r(m.url)
            }, s.state || (s.state = {
                id: c(),
                ...
                fragment: e.fragment,
                timeout: e.timeout
            }, window.history.replaceState(s.state, document.title)), h(s.xhr), s.options = e;
            var f = s.xhr = t.ajax(e);
            return f.readyState > 0 && (e.push && !e.replace && (function(t, e) {
                P[t] = e, O.push(t), w(E, 0), w(O, s.defaults.maxCacheLength)
            }(s.state.id, p(l)), window.history.pushState(null, "", e.requestUrl)), i("pjax:start", [f, e]), i("pjax:send", [f, e])), s.xhr
        }
        ...
        function a(e) {
            ...
            if (o && o.container) {
                ...
                if (l.length) {
                    n && function(t, e, i) {
                        var n, o;
                        P[e] = i, "forward" === t ? (n = O, o = E) : (n = E, o = O), n.push(e), (e = o.pop()) && delete P[e], w(n, s.defaults.maxCacheLength)
                    }(i, n.id, p(l));
                    var u = t.Event("pjax:popstate", {
                        state: o,
                        direction: i
                    });
                    l.trigger(u);
                    ...
                    if (c) {
                        l.trigger("pjax:start", [null, d]), s.state = o, o.title && (document.title = o.title);
                        var f = t.Event("pjax:beforeReplace", {
                            state: o,
                            previousState: n
                        });
                        l.trigger(f, [c, d]), l.html(c), l.trigger("pjax:end", [null, d])
                    } else s(d);
                    l[0].offsetHeight
        ...
        function l(e) {
            ...
            else if (t.isArray(o)) t.each(o, function(e, i) {
                s.append(t("<input>", {
                    type: "hidden",
                    name: i.name,
                    value: i.value
        ...
        function _(e, i, n) {
            var s = {},
                o = /<html/i.test(e),
                r = i.getResponseHeader("X-PJAX-URL");
            if (s.url = r ? u(d(r)) : n.requestUrl, o) var a = t(y(e.match(/<head[^>]*>([\s\S.]*)<\/head>/i)[0])),
                l = t(y(e.match(/<body[^>]*>([\s\S.]*)<\/body>/i)[0]));
            else a = l = t(y(e));
            if (0 === l.length) return s;
            if (s.title = v(a, "title").last().text(), n.fragment) {
                if ("body" === n.fragment) var h = l;
                else h = v(l, n.fragment).first();
                h.length && (s.contents = "body" === n.fragment ? h : h.contents(), s.title || (s.title = h.attr("title") || h.data("title")))
            } else o || (s.contents = l);
            return s.contents && (s.contents = s.contents.not(function() {
                return t(this).is("title")
            }), s.contents.find("title").remove(), s.scripts = v(s.contents, "script[src]").remove(), s.contents = s.contents.not(s.scripts)), s.title && (s.title = t.trim(s.title)), s
        }
        ...
        function b() {
            t.fn.pjax = e, t.pjax = s, t.pjax.enable = t.noop, t.pjax.disable = T, t.pjax.click = i, t.pjax.submit = n, t.pjax.reload = o, t.pjax.defaults = {
                timeout: 650,
                push: !0,
                replace: !1,
                type: "GET",
        ...
        function T() {
            t.fn.pjax = function() {
                return this
            }, t.pjax = l, t.pjax.enable = b, t.pjax.disable = t.noop, t.pjax.click = t.noop, t.pjax.submit = t.noop, t.pjax.reload = function() {
        ...
        C && C.container && (s.state = C), "state" in window.history && (S = !1);
        var P = {},
            E = [],
            O = [];
    ...
    function(t, e, i, n) {
        ...
        (function() {
            return !!s("transition")
        })() && (t.support.transition = new String(o("transition")), t.support.transition.end = l.transition.end[t.support.transition]), p() && (t.support.animation = new String(o("animation")), t.support.animation.end = l.animation.end[t.support.animation]), h() && (t.support.transform = new String(o("transform")), t.support.transform3d = c())
    }(window.Zepto || window.jQuery, window, document),
    function(t) {
        function e(t) {
    ...
    function(t, e) {
        ...
        e.prototype.reset = function() {
            ...
            for (var e = [], i = 0, n = this.spaces.length; n > i; i++) {
                var s = this.spaces[i],
                    o = s.getMaximalFreeRects(t);
                o ? e.push.apply(e, o) : e.push(s)
            }
            ...
            for (var e = 0, i = t.length; i > e; e++) {
                ...
                if (n) {
                    var s = t.slice(0);
                    s.splice(e, 1);
                    for (var o = 0, r = 0, a = s.length; a > r; r++) {
                        var l = s[r],
                            h = e > r ? 0 : 1;
                        n.contains(l) && (t.splice(r + h - o, 1), o++)
                    }
                }
            }
            return t
    ...
    function(t, e) {
        ...
        var n = t("transform"),
            ...
            o = (s.prototype = new e.Item)._create;
    ...
    function(t, e) {
        ...
        return l.Item = o, l.prototype._create = function() {
            ...
            var n = i && i.needsPositioning,
                ...
                r = this;
            return function() {
                return ++s != o || (i && (t.remove(i.element, "is-positioning-post-drag"), i.isPlacing = !1, i.copyPlaceRectPosition()), r.unstamp(e), r.sortItemsByPosition(), n && r.emitEvent("dragItemPositioned", [i]), !0)
            }
    ...
    function(t, e) {
        ...
        (function(t, e) {
            for (var i in e) t[i] = e[i]
        })(n.prototype, e.prototype), n.prototype._getElementOffset = s, n.prototype._getMeasurement = o;
        var r = n.prototype._resetLayout;
    ...
    function(t) {
        ...
        t.ThreeSixty = function(e, i) {
            var n, s = this,
                o = [];
            s.$el = t(e), s.el = e, s.$el.data("ThreeSixty", s), s.init = function() {
                (n = t.extend({}, t.ThreeSixty.defaultOptions, i)).disableSpin && (n.currentFrame = 1, n.endFrame = 1), s.initProgress(), s.loadImages()
            }, s.resize = function() {}, s.initProgress = function() {
                s.$el.css({
                    width: n.width + "px",
                    height: n.height + "px",
                    "background-image": "none !important"
                }), n.styles && s.$el.css(n.styles), s.responsive(), s.$el.find(n.progress).css({
                    marginTop: n.height / 2 - 15 + "px"
                }), s.$el.find(n.progress).fadeIn("slow"), s.$el.find(n.imgList).hide()
            }, s.loadImages = function() {
                var e, i, r, a;
                e = document.createElement("li"), a = n.zeroBased ? 0 : 1, i = n.imgArray ? n.imgArray[n.loadedImages] : n.domain + n.imagePath + n.filePrefix + s.zeroPad(n.loadedImages + a) + n.ext + (s.browser.isIE() ? "?" + (new Date).getTime() : ""), r = t("<img>").attr("src", i).addClass("previous-image").appendTo(e), o.push(r), s.$el.find(n.imgList).append(e), t(r).load(function() {
                    s.imageLoaded()
                })
            }, s.imageLoaded = function() {
                n.loadedImages += 1, t(n.progress + " span").text(Math.floor(n.loadedImages / n.totalFrames * 100) + "%"), n.loadedImages >= n.totalFrames ? (n.disableSpin && o[0].removeClass("previous-image").addClass("current-image"), t(n.progress).fadeOut("slow", function() {
                    t(this).hide(), s.showImages(), s.showNavigation()
                })) : s.loadImages()
            }, s.showImages = function() {
                s.$el.find(".txtC").fadeIn(), s.$el.find(n.imgList).fadeIn(), s.ready = !0, n.ready = !0, n.drag && s.initEvents(), s.refresh(), s.initPlugins(), n.onReady(), setTimeout(function() {
                    s.responsive()
                }, 50)
            }, s.initPlugins = function() {
                t.each(n.plugins, function(e, i) {
                    if ("function" != typeof t[i]) throw new Error(i + " not available.");
                    t[i].call(s, s.$el, n)
                })
            }, s.showNavigation = function() {
                var e, i, o, r;
                n.navigation && !n.navigation_init && (e = t("<div/>").attr("class", "nav_bar"), i = t("<a/>").attr({
                    href: "#",
                    class: "nav_bar_next"
                }).html("next"), o = t("<a/>").attr({
                    href: "#",
                    class: "nav_bar_previous"
                }).html("previous"), r = t("<a/>").attr({
                    href: "#",
                    class: "nav_bar_play"
                }).html("play"), e.append(o), e.append(r), e.append(i), s.$el.prepend(e), i.bind("mousedown touchstart", s.next), o.bind("mousedown touchstart", s.previous), r.bind("mousedown touchstart", s.play_stop), n.navigation_init = !0)
            }, s.play_stop = function(e) {
                e.preventDefault(), n.autoplay ? (n.autoplay = !1, t(e.currentTarget).removeClass("nav_bar_stop").addClass("nav_bar_play"), clearInterval(n.play), n.play = null) : (n.autoplay = !0, n.play = setInterval(s.moveToNextFrame, n.playSpeed), t(e.currentTarget).removeClass("nav_bar_play").addClass("nav_bar_stop"))
            }, s.next = function(t) {
                t && t.preventDefault(), n.endFrame -= 5, s.refresh()
            }, s.previous = function(t) {
                t && t.preventDefault(), n.endFrame += 5, s.refresh()
            }, s.play = function(t, e) {
                var i = t || n.playSpeed,
                    o = e || n.autoplayDirection;
                n.autoplayDirection = o, n.autoplay || (n.autoplay = !0, n.play = setInterval(s.moveToNextFrame, i))
            }, s.stop = function() {
                n.autoplay && (n.autoplay = !1, clearInterval(n.play), n.play = null)
            }, s.moveToNextFrame = function() {
                1 === n.autoplayDirection ? n.endFrame -= 1 : n.endFrame += 1, s.refresh()
            }, s.gotoAndPlay = function(t) {
                if (n.disableWrap) n.endFrame = t, s.refresh();
                else {
                    var e = Math.ceil(n.endFrame / n.totalFrames);
                    0 === e && (e = 1);
                    var i, o = e > 1 ? n.endFrame - (e - 1) * n.totalFrames : n.endFrame,
                        r = n.totalFrames - o;
                    i = t - o > 0 ? t - o < o + (n.totalFrames - t) ? n.endFrame + (t - o) : n.endFrame - (o + (n.totalFrames - t)) : r + t > o - t ? n.endFrame - (o - t) : n.endFrame + (r + t), o !== t && (n.endFrame = i, s.refresh())
                }
            }, s.initEvents = function() {
                s.$el.bind("mousedown touchstart touchmove touchend mousemove click", function(t) {
                    t.preventDefault(), "mousedown" === t.type && 1 === t.which || "touchstart" === t.type ? (n.pointerStartPosX = s.getPointerEvent(t).pageX, n.dragging = !0, n.onDragStart(n.currentFrame)) : "touchmove" === t.type ? s.trackPointer(t) : "touchend" === t.type && (n.dragging = !1, n.onDragStop(n.endFrame))
                }), t(document).bind("mouseup", function(e) {
                    n.dragging = !1, n.onDragStop(n.endFrame), t(this).css("cursor", "none")
                }), t(window).bind("resize", function(t) {
                    s.responsive()
                }), t(document).bind("mousemove", function(t) {
                    n.dragging ? (t.preventDefault(), !s.browser.isIE && n.showCursor && s.$el.css("cursor", "url(assets/images/hand_closed.png), auto")) : !s.browser.isIE && n.showCursor && s.$el.css("cursor", "url(assets/images/hand_open.png), auto"), s.trackPointer(t)
                ...
                n.ready && n.dragging && (n.pointerEndPosX = s.getPointerEvent(t).pageX, n.monitorStartTime < (new Date).getTime() - n.monitorInt && (n.pointerDistance = n.pointerEndPosX - n.pointerStartPosX, n.pointerDistance > 0 ? n.endFrame = n.currentFrame + Math.ceil((n.totalFrames - 1) * n.speedMultiplier * (n.pointerDistance / s.$el.width())) : n.endFrame = n.currentFrame + Math.floor((n.totalFrames - 1) * n.speedMultiplier * (n.pointerDistance / s.$el.width())), n.disableWrap && (n.endFrame = Math.min(n.totalFrames - (n.zeroBased ? 1 : 0), n.endFrame), n.endFrame = Math.max(n.zeroBased ? 0 : 1, n.endFrame)), s.refresh(), n.monitorStartTime = (new Date).getTime(), n.pointerStartPosX = s.getPointerEvent(t).pageX))
            }, s.refresh = function() {
                0 === n.ticker && (n.ticker = setInterval(s.render, Math.round(1e3 / n.framerate)))
            }, s.render = function() {
                var t;
                n.currentFrame !== n.endFrame ? (t = n.endFrame < n.currentFrame ? Math.floor(.1 * (n.endFrame - n.currentFrame)) : Math.ceil(.1 * (n.endFrame - n.currentFrame)), s.hidePreviousFrame(), n.currentFrame += t, s.showCurrentFrame(), s.$el.trigger("frameIndexChanged", [s.getNormalizedCurrentFrame(), n.totalFrames])) : (window.clearInterval(n.ticker), n.ticker = 0)
            }, s.hidePreviousFrame = function() {
                o[s.getNormalizedCurrentFrame()].removeClass("current-image").addClass("previous-image")
            }, s.showCurrentFrame = function() {
                o[s.getNormalizedCurrentFrame()].removeClass("previous-image").addClass("current-image")
            }, s.getNormalizedCurrentFrame = function() {
                var t, e;
                return n.disableWrap ? (t = Math.min(n.currentFrame, n.totalFrames - (n.zeroBased ? 1 : 0)), e = Math.min(n.endFrame, n.totalFrames - (n.zeroBased ? 1 : 0)), t = Math.max(t, n.zeroBased ? 0 : 1), e = Math.max(e, n.zeroBased ? 0 : 1), n.currentFrame = t, n.endFrame = e) : 0 > (t = Math.ceil(n.currentFrame % n.totalFrames)) && (t += n.totalFrames - (n.zeroBased ? 1 : 0)), t
            }, s.getCurrentFrame = function() {
                return n.currentFrame
            }, s.responsive = function() {
                n.responsive && s.$el.css({
                    height: s.$el.find(".current-image").first().css("height"),
                    width: "100%"
                })
            }, s.zeroPad = function(t) {
                var e = Math.log(n.totalFrames) / Math.LN10,
            ...
            }, s.browser = {}, s.browser.isIE = function() {
                var t = -1;
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        "use strict";
        var t, e, i, n, s, o, r, a, l, h, c, p, u, d, f, m;
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
                var n = function(t) {
                    ...
                    p = [];
                o.version = "1.18.4", c.constructor = o, c.kill()._gc = !1, o.killTweensOf = o.killDelayedCallsTo = i.killTweensOf, o.getTweensOf = i.getTweensOf, o.lagSmoothing = i.lagSmoothing, o.ticker = i.ticker, o.render = i.render, c.invalidate = function() {
                    ...
                    var n, s, o, l, h, c, p, u, d = this._dirty ? this.totalDuration() : this._totalDuration,
                        f = this._time,
                        m = this._totalTime,
                        g = this._cycle,
                        v = this._duration,
                        y = this._rawPrevTime;
                    if (t >= d - 1e-7 ? (this._totalTime = d, this._cycle = this._repeat, this._yoyo && 0 != (1 & this._cycle) ? (this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0) : (this._time = v, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1), this._reversed || (n = !0, s = "onComplete", i = i || this._timeline.autoRemoveChildren), 0 === v && (this._initted || !this.vars.lazy || i) && (this._startTime === this._timeline._duration && (t = 0), (0 > y || 0 >= t && t >= -1e-7 || y === r && "isPause" !== this.data) && y !== t && (i = !0, y > r && (s = "onReverseComplete")), this._rawPrevTime = u = !e || t || y === t ? t : r)) : 1e-7 > t ? (this._totalTime = this._time = this._cycle = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== m || 0 === v && y > 0) && (s = "onReverseComplete", n = this._reversed), 0 > t && (this._active = !1, 0 === v && (this._initted || !this.vars.lazy || i) && (y >= 0 && (i = !0), this._rawPrevTime = u = !e || t || y === t ? t : r)), this._initted || (i = !0)) : (this._totalTime = this._time = t, 0 !== this._repeat && (l = v + this._repeatDelay, this._cycle = this._totalTime / l >> 0, 0 !== this._cycle && this._cycle === this._totalTime / l && t >= m && this._cycle--, this._time = this._totalTime - this._cycle * l, this._yoyo && 0 != (1 & this._cycle) && (this._time = v - this._time), this._time > v ? this._time = v : this._time < 0 && (this._time = 0)), this._easeType ? (h = this._time / v, (1 === (c = this._easeType) || 3 === c && h >= .5) && (h = 1 - h), 3 === c && (h *= 2), 1 === (p = this._easePower) ? h *= h : 2 === p ? h *= h * h : 3 === p ? h *= h * h * h : 4 === p && (h *= h * h * h * h), 1 === c ? this.ratio = 1 - h : 2 === c ? this.ratio = h : this._time / v < .5 ? this.ratio = h / 2 : this.ratio = 1 - h / 2) : this.ratio = this._ease.getRatio(this._time / v)), f !== this._time || i || g !== this._cycle) {
                        if (!this._initted) {
                        ...
                        for (!1 !== this._lazy && (this._lazy = !1), this._active || !this._paused && this._time !== f && t >= 0 && (this._active = !0), 0 === m && (2 === this._initted && t > 0 && this._init(), this._startAt && (t >= 0 ? this._startAt.render(t, e, i) : s || (s = "_dummyGS")), this.vars.onStart && (0 !== this._totalTime || 0 === v) && (e || this._callback("onStart"))), o = this._firstPT; o;) o.f ? o.t[o.p](o.c * this.ratio + o.s) : o.t[o.p] = o.c * this.ratio + o.s, o = o._next;
                        this._onUpdate && (0 > t && this._startAt && this._startTime && this._startAt.render(t, e, i), e || (this._totalTime !== m || s) && this._callback("onUpdate")), this._cycle !== g && (e || this._gc || this.vars.onRepeat && this._callback("onRepeat")), s && (!this._gc || i) && (0 > t && this._startAt && !this._onUpdate && this._startTime && this._startAt.render(t, e, i), n && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[s] && this._callback(s), 0 === v && this._rawPrevTime === r && u !== r && (this._rawPrevTime = 0))
                ...
                }, o.staggerTo = o.allTo = function(t, e, r, a, c, u, d) {
                    a = a || 0;
                    var f, m, g, v, y = 0,
                        _ = [],
                        w = function() {
                            r.onComplete && r.onComplete.apply(r.onCompleteScope || this, arguments), c.apply(d || r.callbackScope || this, u || p)
                        },
                        x = r.cycle,
                    ...
                    for (h(t) || ("string" == typeof t && (t = i.selector(t) || t), l(t) && (t = n(t))), t = t || [], 0 > a && ((t = n(t)).reverse(), a *= -1), f = t.length - 1, g = 0; f >= g; g++) {
                        ...
                        if (x && s(m, t, g), b) {
                            for (v in b = m.startAt = {}, r.startAt) b[v] = r.startAt[v];
                            s(m.startAt, t, g)
                        }
                        m.delay = y + (m.delay || 0), g === f && c && (m.onComplete = w), _[g] = new o(t[g], e, m), y += a
                    }
                    return _
                ...
                o.killAll = function(t, i, n, s) {
                    ...
                    if (null != t) {
                        var s, r, c, p, u, d = a.tweenLookup;
                        if ("string" == typeof t && (t = i.selector(t) || t), l(t) && (t = n(t)), h(t))
                            for (p = t.length; --p > -1;) o.killChildTweensOf(t[p], e);
                        else {
                            for (c in s = [], d)
                                for (r = d[c].target.parentNode; r;) r === t && (s = s.concat(d[c].tweens)), r = r.parentNode;
                            for (u = s.length, p = 0; u > p; p++) e && s[p].totalTime(s[p].totalDuration()), s[p]._enabled(!1, !1)
                        }
                    }
                };
                var f = function(t, i, n, s) {
                    i = !1 !== i, n = !1 !== n;
                    for (var o, r, a = d(s = !1 !== s), l = i && n && s, h = a.length; --h > -1;) r = a[h], (l || r instanceof e || (o = r.target === r.vars.onComplete) && n || i && !o) && r.paused(t)
                };
                ...
                var n = function(t) {
                    ...
                    g = n.prototype = new e;
                return n.version = "1.18.4", g.constructor = n, g.kill()._gc = g._forcingPlayhead = g._hasPause = !1, g.to = function(t, e, n, s) {
                    var o = n.repeat && p.TweenMax || i;
                    return e ? this.add(new o(t, e, n), s) : this.set(t, n, s)
                }, g.from = function(t, e, n, s) {
                    return this.add((n.repeat && p.TweenMax || i).from(t, e, n), s)
                    ...
                    var p, f, g = new n({
                        ...
                        v = s.cycle;
                    for ("string" == typeof t && (t = i.selector(t) || t), a(t = t || []) && (t = m(t)), 0 > (o = o || 0) && ((t = m(t)).reverse(), o *= -1), f = 0; f < t.length; f++)(p = u(s)).startAt && (p.startAt = u(p.startAt), p.startAt.cycle && d(p.startAt, t, f)), v && d(p, t, f), g.to(t[f], e, p, f * o);
                    return this.add(g, r)
                    ...
                    if ("number" != typeof o && (o = this._parseTimeOrLabel(o, 0, !0, s)), !(s instanceof t)) {
                        if (s instanceof Array || s && s.push && l(s)) {
                            for (r = r || "normal", a = a || 0, h = o, c = s.length, p = 0; c > p; p++) l(u = s[p]) && (u = new n({
                                tweens: u
                    ...
                    var n, o, r, a, l, p, u, d = this._dirty ? this.totalDuration() : this._totalDuration,
                        f = this._time,
                        m = this._startTime,
                        g = this._timeScale,
                        v = this._paused;
                    ...
                    if (this._time !== f && this._first || i || l || p) {
                        if (this._initted || (this._initted = !0), this._active || !this._paused && this._time !== f && t > 0 && (this._active = !0), 0 === f && this.vars.onStart && 0 !== this._time && (e || this._callback("onStart")), (u = this._time) >= f)
                            for (n = this._first; n && (r = n._next, u === this._time && (!this._paused || v));)(n._active || n._startTime <= u && !n._paused && !n._gc) && (p === n && this.pause(), n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (t - n._startTime) * n._timeScale, e, i) : n.render((t - n._startTime) * n._timeScale, e, i)), n = r;
                        else
                        ...
                        this._onUpdate && (e || (h.length && c(), this._callback("onUpdate"))), a && (this._gc || (m === this._startTime || g !== this._timeScale) && (0 === this._time || d >= this.totalDuration()) && (o && (h.length && c(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[a] && this._callback(a)))
                    }
                    ...
                    if (!arguments.length) {
                        if (this._dirty) {
                            for (var e, i, n = 0, s = this._last, o = 999999999999; s;) e = s._prev, s._dirty && s.totalDuration(), s._startTime > o && this._sortChildren && !s._paused ? this.add(s, s._startTime - s._delay) : o = s._startTime, s._startTime < 0 && !s._paused && (n -= s._startTime, this._timeline.smoothChildTiming && (this._startTime += s._startTime / this._timeScale), this.shiftChildren(-s._startTime, !1, -9999999999), o = 0), (i = s._startTime + s._totalDuration / s._timeScale) > n && (n = i), s = e;
                ...
                return h.constructor = n, h.kill()._gc = !1, n.version = "1.18.4", h.invalidate = function() {
                    ...
                    this._gc && this._enabled(!0, !1);
                    var n, o, l, h, c, p, u, d, f = this._dirty ? this.totalDuration() : this._totalDuration,
                        m = this._duration,
                        g = this._time,
                        v = this._totalTime,
                        y = this._startTime,
                        ...
                        x = this._paused,
                        b = this._cycle;
                    if (t >= f - 1e-7) this._locked || (this._totalTime = f, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (o = !0, h = "onComplete", c = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 >= t && t >= -1e-7 || 0 > w || w === s) && w !== t && this._first && (c = !0, w > s && (h = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : s, this._yoyo && 0 != (1 & this._cycle) ? this._time = t = 0 : (this._time = m, t = m + 1e-4);
                    else if (1e-7 > t)
                        if (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== g || 0 === m && w !== s && (w > 0 || 0 > t && w >= 0) && !this._locked) && (h = "onReverseComplete", o = this._reversed), 0 > t) this._active = !1, this._timeline.autoRemoveChildren && this._reversed ? (c = o = !0, h = "onReverseComplete") : w >= 0 && this._first && (c = !0), this._rawPrevTime = t;
                        else {
                            if (this._rawPrevTime = m || !e || t || this._rawPrevTime === t ? t : s, 0 === t && o)
                                for (n = this._first; n && 0 === n._startTime;) n._duration || (o = !1), n = n._next;
                            t = 0, this._initted || (c = !0)
                        }
                    else if (0 === m && 0 > w && (c = !0), this._time = this._rawPrevTime = t, this._locked || (this._totalTime = t, 0 !== this._repeat && (p = m + this._repeatDelay, this._cycle = this._totalTime / p >> 0, 0 !== this._cycle && this._cycle === this._totalTime / p && t >= v && this._cycle--, this._time = this._totalTime - this._cycle * p, this._yoyo && 0 != (1 & this._cycle) && (this._time = m - this._time), this._time > m ? (this._time = m, t = m + 1e-4) : this._time < 0 ? this._time = t = 0 : t = this._time)), this._hasPause && !this._forcingPlayhead && !e) {
                        if ((t = this._time) >= g)
                    ...
                    if (this._cycle !== b && !this._locked) {
                        ...
                        this._time = E, this._totalTime = k, this._cycle = C, this._rawPrevTime = P
                    }
                    if (this._time !== g && this._first || i || c || u) {
                        if (this._initted || (this._initted = !0), this._active || !this._paused && this._totalTime !== v && t > 0 && (this._active = !0), 0 === v && this.vars.onStart && 0 !== this._totalTime && (e || this._callback("onStart")), (d = this._time) >= g)
                            for (n = this._first; n && (l = n._next, d === this._time && (!this._paused || x));)(n._active || n._startTime <= this._time && !n._paused && !n._gc) && (u === n && this.pause(), n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (t - n._startTime) * n._timeScale, e, i) : n.render((t - n._startTime) * n._timeScale, e, i)), n = l;
                        else
                        ...
                        this._onUpdate && (e || (r.length && a(), this._callback("onUpdate"))), h && (this._locked || this._gc || (y === this._startTime || _ !== this._timeScale) && (0 === this._time || f >= this.totalDuration()) && (o && (r.length && a(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[h] && this._callback(h)))
                ...
                var s = {
                    ...
                    u = (h + c) / 2,
                    d = (u - p) / 8;
                return s.b = l + (t - l) / 4, o.b = p + d, s.c = o.a = (s.b + o.b) / 2, o.c = r.a = (p + u) / 2, r.b = u - d, a.b = c + (n - c) / 4, r.c = a.a = (r.b + a.b) / 2, [s, o, r, a]
            }, l = function(t, s, o, r, l) {
                var h, c, p, u, d, f, m, g, v, y, _, w, x, b = t.length - 1,
                    T = 0,
                    S = t[0].a;
                for (h = 0; b > h; h++) c = (d = t[T]).a, p = d.d, u = t[T + 1].d, l ? (_ = e[h], x = ((w = i[h]) + _) * s * .25 / (r ? .5 : n[h] || .5), g = p - ((f = p - (p - c) * (r ? .5 * s : 0 !== _ ? x / _ : 0)) + (((m = p + (u - p) * (r ? .5 * s : 0 !== w ? x / w : 0)) - f) * (3 * _ / (_ + w) + .5) / 4 || 0))) : g = p - ((f = p - (p - c) * s * .5) + (m = p + (u - p) * s * .5)) / 2, f += g, m += g, d.c = v = f, d.b = 0 !== h ? S : S = d.a + .6 * (d.c - d.a), d.da = p - c, d.ca = v - c, d.ba = S - c, o ? (y = a(c, S, v, p), t.splice(T, 1, y[0], y[1], y[2], y[3]), T += 4) : T++, S = m;
                (d = t[T]).b = S, d.c = S + .4 * (d.d - S), d.da = d.d - d.a, d.ca = d.c - d.a, d.ba = S - d.a, o && (y = a(d.a, S, d.c, d.d), t.splice(T, 1, y[0], y[1], y[2], y[3]))
            }, h = function(t, n, s, o) {
                var a, l, h, c, p, u, d = [];
                if (o)
                    for (l = (t = [o].concat(t)).length; --l > -1;) "string" == typeof(u = t[l][n]) && "=" === u.charAt(1) && (t[l][n] = o[n] + Number(u.charAt(0) + u.substr(2)));
                if (0 > (a = t.length - 2)) return d[0] = new r(t[0][n], 0, 0, t[-1 > a ? 0 : 1][n]), d;
                for (l = 0; a > l; l++) h = t[l][n], c = t[l + 1][n], d[l] = new r(h, 0, 0, c), s && (p = t[l + 2][n], e[l] = (e[l] || 0) + (c - h) * (c - h), i[l] = (i[l] || 0) + (p - c) * (p - c));
                return d[l] = new r(t[l][n], 0, 0, t[l + 1][n]), d
            }, c = function(t, o, r, a, c, p) {
                var u, d, f, m, g, v, y, _, w = {},
                    x = [],
                    b = p || t[0];
                for (d in c = "string" == typeof c ? "," + c + "," : ",x,y,z,left,top,right,bottom,marginTop,marginLeft,marginRight,marginBottom,paddingLeft,paddingTop,paddingRight,paddingBottom,backgroundPosition,backgroundPosition_y,", null == o && (o = 1), t[0]) x.push(d);
                if (t.length > 1) {
                    for (_ = t[t.length - 1], y = !0, u = x.length; --u > -1;)
                        if (d = x[u], Math.abs(b[d] - _[d]) > .05) {
                            y = !1;
                            break
                        }
                    y && (t = t.concat(), p && t.unshift(p), t.push(t[1]), p = t[t.length - 3])
                }
                for (e.length = i.length = n.length = 0, u = x.length; --u > -1;) d = x[u], s[d] = -1 !== c.indexOf("," + d + ","), w[d] = h(t, d, s[d], p);
                for (u = e.length; --u > -1;) e[u] = Math.sqrt(e[u]), i[u] = Math.sqrt(i[u]);
                if (!a) {
                    for (u = x.length; --u > -1;)
                        if (s[d])
                            for (v = (f = w[x[u]]).length - 1, m = 0; v > m; m++) g = f[m + 1].da / i[m] + f[m].da / e[m] || 0, n[m] = (n[m] || 0) + g * g;
                    for (u = n.length; --u > -1;) n[u] = Math.sqrt(n[u])
                }
                for (u = x.length, m = r ? 4 : 1; --u > -1;) f = w[d = x[u]], l(f, o, r, a, s[d]), y && (f.splice(0, m), f.splice(f.length - m, m));
                return w
            }, p = function(t, e, i) {
                var n, s, o, a, l, h, c, p, u, d, f, m = {},
                ...
                for (h = y.length; --h > -1;) {
                    for (m[u = y[h]] = l = [], d = 0, p = t.length, c = 0; p > c; c++) n = null == i ? t[c][u] : "string" == typeof(f = t[c][u]) && "=" === f.charAt(1) ? i[u] + Number(f.charAt(0) + f.substr(2)) : Number(f), v && c > 1 && p - 1 > c && (l[d++] = (n + l[d - 2]) / 2), l[d++] = n;
                    for (p = d - g + 1, d = 0, c = 0; p > c; c += g) n = l[c], s = l[c + 1], o = l[c + 2], a = 2 === g ? 0 : l[c + 3], l[d++] = f = 3 === g ? new r(n, s, o, a) : new r(n, (2 * s + n) / 3, (2 * s + o) / 3, o);
                    l.length = d
                }
                return m
            }, u = function(t, e, i) {
                for (var n, s, o, r, a, l, h, c, p, u, d, f = 1 / i, m = t.length; --m > -1;)
                    for (o = (u = t[m]).a, r = u.d - o, a = u.c - o, l = u.b - o, n = s = 0, c = 1; i >= c; c++) n = s - (s = ((h = f * c) * h * r + 3 * (p = 1 - h) * (h * a + p * l)) * h), e[d = m * i + c - 1] = (e[d] || 0) + n * n
            }, d = function(t, e) {
                var i, n, s, o, r = [],
                    a = [],
                    l = 0,
                ...
                for (s = r.length, n = 0; s > n; n++) l += Math.sqrt(r[n]), d[o = n % e] = l, o === c && (h += l, p[o = n / e >> 0] = d, a[o] = h, l = 0, d = []);
                return {
                    length: h,
                    lengths: a,
                    segments: p
                ...
                init: function(t, e, i) {
                    ...
                    if (this._beziers = "cubic" !== e.type && "quadratic" !== e.type && "soft" !== e.type ? c(l, isNaN(e.curviness) ? 1 : e.curviness, !1, "thruBasic" === e.type, e.correlate, a) : p(l, e.type, h), this._segCount = this._beziers[n].length, this._timeRes) {
                ...
                set: function(e) {
                    var i, n, s, o, r, a, l, h, c, p, u = this._segCount,
                        d = this._func,
                        f = this._target,
                        m = e !== this._startRatio;
                    if (this._timeRes) {
                        if (c = this._lengths, p = this._curSeg, e *= this._length, s = this._li, e > this._l2 && u - 1 > s) {
                            for (h = u - 1; h > s && (this._l2 = c[++s]) <= e;);
                            this._l1 = c[s - 1], this._li = s, this._curSeg = p = this._segments[s], this._s2 = p[this._s1 = this._si = 0]
                        } else if (e < this._l1 && s > 0) {
                            for (; s > 0 && (this._l1 = c[--s]) >= e;);
                            0 === s && e < this._l1 ? this._l1 = 0 : s++, this._l2 = c[s], this._li = s, this._curSeg = p = this._segments[s], this._s1 = p[(this._si = p.length - 1) - 1] || 0, this._s2 = p[this._si]
                        }
                        if (i = s, e -= this._l1, s = this._si, e > this._s2 && s < p.length - 1) {
                            for (h = p.length - 1; h > s && (this._s2 = p[++s]) <= e;);
                            this._s1 = p[s - 1], this._si = s
                        } else if (e < this._s1 && s > 0) {
                            for (; s > 0 && (this._s1 = p[--s]) >= e;);
                            0 === s && e < this._s1 ? this._s1 = 0 : s++, this._s2 = p[s], this._si = s
                        }
                        a = (s + (e - this._s1) / (this._s2 - this._s1)) * this._prec || 0
                    } else a = (e - (i = 0 > e ? 0 : e >= 1 ? u - 1 : u * e >> 0) * (1 / u)) * u;
                    for (n = 1 - a, s = this._props.length; --s > -1;) o = this._props[s], l = (a * a * (r = this._beziers[o][i]).da + 3 * n * (a * r.ca + n * r.ba)) * a + r.a, this._round[o] && (l = Math.round(l)), d[o] ? f[o](l) : f[o] = l;
                    if (this._autoRotate) {
                        var g, v, y, _, w, x, b, T = this._autoRotate;
                        for (s = T.length; --s > -1;) o = T[s][2], x = T[s][3] || 0, b = !0 === T[s][4] ? 1 : t, r = this._beziers[T[s][0]], g = this._beziers[T[s][1]], r && g && (r = r[i], g = g[i], v = r.a + (r.b - r.a) * a, v += ((_ = r.b + (r.c - r.b) * a) - v) * a, _ += (r.c + (r.d - r.c) * a - _) * a, y = g.a + (g.b - g.a) * a, y += ((w = g.b + (g.c - g.b) * a) - y) * a, w += (g.c + (g.d - g.c) * a - w) * a, l = m ? Math.atan2(w - y, _ - v) * b + x : this._initialRotations[s], d[o] ? f[o](l) : f[o] = l)
                    }
                }
                ...
                if (t) {
                    ...
                    e._registerComplexSpecialProp("bezier", {
                        parser: function(t, e, o, r, a, l) {
                            ...
                            var h, c, p, u = e.values,
                                d = u.length - 1,
                                m = [],
                                g = {};
                            if (0 > d) return a;
                            for (h = 0; d >= h; h++) p = i(t, u[h], r, a, l, d !== h), m[h] = p.end;
                            for (c in e) g[c] = e[c];
                            return g.values = m, (a = new s(t, "bezier", 0, 0, p.pt, 2)).data = p, a.plugin = l, a.setRatio = n, 0 === g.autoRotate && (g.autoRotate = !0), !g.autoRotate || g.autoRotate instanceof Array || (h = !0 === g.autoRotate ? 0 : Number(g.autoRotate), g.autoRotate = null != p.end.left ? [
                                ["left", "top", "rotation", h, !1]
                            ] : null != p.end.x && [
                                ["x", "y", "rotation", h, !1]
                            ]), g.autoRotate && (r._transform || r._enableTransforms(!1), p.autoRotate = r._target._gsTransform), l._onInitTween(p.proxy, g, r._tween), a
                        }
                    })
                }
                ...
                h.constructor = r, r.version = "1.18.4", r.API = 2, r.defaultTransformPerspective = 0, r.defaultSkewType = "compensated", r.defaultSmoothOrigin = !0, h = "px", r.suffixMap = {
                    top: h,
                    right: h,
                    bottom: h,
                    left: h,
                ...
                var c, p, u, d, f, m, g = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
                    ...
                    W = function() {
                        var t = B.indexOf("Android"),
                            e = j("a");
                        return u = -1 !== B.indexOf("Safari") && -1 === B.indexOf("Chrome") && (-1 === t || Number(B.substr(t + 8, 1)) > 3), f = u && Number(B.substr(B.indexOf("Version/") + 8, 1)) < 6, d = -1 !== B.indexOf("Firefox"), (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(B) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(B)) && (m = parseFloat(RegExp.$1)), !!e && (e.style.cssText = "top:1px;opacity:.55;", /^0.55/.test(e.style.opacity))
                    }(),
                    q = function(t) {
                    ...
                    U = "",
                    V = function(t, e) {
                        var i, n, s = (e = e || F).style;
                        if (void 0 !== s[t]) return t;
                        for (t = t.charAt(0).toUpperCase() + t.substr(1), i = ["O", "Moz", "ms", "Ms", "Webkit"], n = 5; --n > -1 && void 0 === s[i[n] + t];);
                        return n >= 0 ? (Y = "-" + (U = 3 === n ? "ms" : i[n]).toLowerCase() + "-", U + t) : null
                    },
                    G = D.defaultView ? D.defaultView.getComputedStyle : function() {},
                    Z = r.getStyle = function(t, e, i, n, s) {
                        var o;
                        return W || "opacity" !== e ? (!n && t.style[e] ? o = t.style[e] : (i = i || G(t)) ? o = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(k, "-$1").toLowerCase()) : t.currentStyle && (o = t.currentStyle[e]), null == s || o && "none" !== o && "auto" !== o && "auto auto" !== o ? o : s) : q(t)
                    },
                    Q = N.convertToPixels = function(t, i, n, s, o) {
                        if ("px" === s || !s) return n;
                        ...
                        var a, l, h, c = O.test(i),
                            ...
                            u = F.style,
                            d = 0 > n;
                        if (d && (n = -n), "%" === s && -1 !== i.indexOf("border")) a = n / 100 * (c ? t.clientWidth : t.clientHeight);
                        else {
                            if (u.cssText = "border:0 solid red;position:" + Z(t, "position") + ";line-height:0;", "%" !== s && p.appendChild && "v" !== s.charAt(0) && "rem" !== s) u[c ? "borderLeftWidth" : "borderTopWidth"] = n + s;
                            else {
                                if (l = (p = t.parentNode || D.body)._gsCache, h = e.ticker.frame, l && c && l.time === h) return l.width * n / 100;
                                u[c ? "width" : "height"] = n + s
                            }
                            p.appendChild(F), a = parseFloat(F[c ? "offsetWidth" : "offsetHeight"]), p.removeChild(F), c && "%" === s && !1 !== r.cacheWidths && ((l = p._gsCache = p._gsCache || {}).time = h, l.width = a / n * 100), 0 !== a || o || (a = Q(t, i, n, s, !0))
                        }
                        return d ? -a : a
                    },
                    K = N.calculateOffset = function(t, e, i) {
                        ...
                        var n = "left" === e ? "Left" : "Top",
                            s = Z(t, "margin" + n, i);
                        return t["offset" + n] - (Q(t, e, parseFloat(s), s.replace(w, "")) || 0)
                    },
                    J = function(t, e) {
                        var i, n, s, o = {};
                        if (e = e || G(t, null))
                            if (i = e.length)
                                for (; --i > -1;)(-1 === (s = e[i]).indexOf("-transform") || Ct === s) && (o[s.replace(C, E)] = e.getPropertyValue(s));
                            else
                                for (i in e)(-1 === i.indexOf("Transform") || kt === i) && (o[i] = e[i]);
                        else if (e = t.currentStyle || t.style)
                            for (i in e) "string" == typeof i && void 0 === o[i] && (o[i.replace(C, E)] = e[i]);
                        return W || (o.opacity = q(t)), n = jt(t, e, !1), o.rotation = n.rotation, o.skewX = n.skewX, o.scaleX = n.scaleX, o.scaleY = n.scaleY, o.x = n.x, o.y = n.y, Et && (o.z = n.z, o.rotationX = n.rotationX, o.rotationY = n.rotationY, o.scaleZ = n.scaleZ), o.filters && delete o.filters, o
                    },
                    tt = function(t, e, i, n, s) {
                        var o, r, a, l = {},
                            h = t.style;
                        for (r in i) "cssText" !== r && "length" !== r && isNaN(r) && (e[r] !== (o = i[r]) || s && s[r]) && -1 === r.indexOf("Origin") && ("number" == typeof o || "string" == typeof o) && (l[r] = "auto" !== o || "left" !== r && "top" !== r ? "" !== o && "auto" !== o && "none" !== o || "string" != typeof e[r] || "" === e[r].replace(_, "") ? o : 0 : K(t, r), void 0 !== h[r] && (a = new mt(h, r, h[r], a)));
                        if (n)
                    ...
                    nt = function(t, e, i) {
                        ...
                        var n = parseFloat("width" === e ? t.offsetWidth : t.offsetHeight),
                            s = et[e],
                            o = s.length;
                        for (i = i || G(t, null); --o > -1;) n -= parseFloat(Z(t, "padding" + s[o], i, !0)) || 0, n -= parseFloat(Z(t, "border" + s[o] + "Width", i, !0)) || 0;
                        return n
                    },
                    st = function(t, e) {
                        ...
                        return null == o ? o = "center" === s ? "50%" : "0" : "center" === o && (o = "50%"), ("center" === s || isNaN(parseFloat(s)) && -1 === (s + "").indexOf("=")) && (s = "50%"), t = s + " " + o + (n.length > 2 ? " " + n[2] : ""), e && (e.oxp = -1 !== s.indexOf("%"), e.oyp = -1 !== o.indexOf("%"), e.oxr = "=" === s.charAt(1), e.oyr = "=" === o.charAt(1), e.ox = parseFloat(s.replace(_, "")), e.oy = parseFloat(o.replace(_, "")), e.v = t), e || t
                    },
                    ot = function(t, e) {
                    ...
                    at = function(t, e, i, n) {
                        var s, o, r, a, l;
                        return null == t ? a = e : "number" == typeof t ? a = t : (s = 360, o = t.split("_"), r = ((l = "=" === t.charAt(1)) ? parseInt(t.charAt(0) + "1", 10) * parseFloat(o[0].substr(2)) : parseFloat(o[0])) * (-1 === t.indexOf("rad") ? 1 : L) - (l ? 0 : e), o.length && (n && (n[i] = e + r), -1 !== t.indexOf("short") && ((r %= s) !== r % 180 && (r = 0 > r ? r + s : r - s)), -1 !== t.indexOf("_cw") && 0 > r ? r = (r + 9999999999 * s) % s - (r / s | 0) * s : -1 !== t.indexOf("ccw") && r > 0 && (r = (r - 9999999999 * s) % s - (r / s | 0) * s)), a = e + r), 1e-6 > a && a > -1e-6 && (a = 0), a
                    },
                    lt = {
                        aqua: [0, 255, 255],
                        lime: [0, 255, 0],
                        ...
                        if (t)
                            if ("number" == typeof t) i = [t >> 16, t >> 8 & 255, 255 & t];
                                ...
                                if ("," === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)), lt[t]) i = lt[t];
                                    ...
                                    } else r = Number(i[0]) % 360 / 360, a = Number(i[1]) / 100, n = 2 * (l = Number(i[2]) / 100) - (s = .5 >= l ? l * (a + 1) : l + a - l * a), i.length > 3 && (i[3] = Number(t[3])), i[0] = ht(r + 1 / 3, n, s), i[1] = ht(r, n, s), i[2] = ht(r - 1 / 3, n, s);
                                else i = t.match(g) || lt.transparent;
                                i[0] = Number(i[0]), i[1] = Number(i[1]), i[2] = Number(i[2]), i.length > 3 && (i[3] = Number(i[3]))
                            }
                        else i = lt.black;
                        return e && !u && (n = i[0] / 255, s = i[1] / 255, o = i[2] / 255, l = ((h = Math.max(n, s, o)) + (c = Math.min(n, s, o))) / 2, h === c ? r = a = 0 : (p = h - c, a = l > .5 ? p / (2 - h - c) : p / (h + c), r = h === n ? (s - o) / p + (o > s ? 6 : 0) : h === s ? (o - n) / p + 2 : (n - s) / p + 4, r *= 60), i[0] = r + .5 | 0, i[1] = 100 * a + .5 | 0, i[2] = 100 * l + .5 | 0), i
                    },
                    pt = function(t, e) {
                        var i, n, s, o = t.match(ut) || [],
                            r = 0,
                            a = o.length ? "" : t;
                        for (i = 0; i < o.length; i++) n = o[i], r += (s = t.substr(r, t.indexOf(n, r) - r)).length + n.length, 3 === (n = ct(n, e)).length && n.push(1), a += s + (e ? "hsla(" + n[0] + "," + n[1] + "%," + n[2] + "%," + n[3] : "rgba(" + n.join(",")) + ")";
                        return a + t.substr(r)
                    },
                ...
                ut = new RegExp(ut + ")", "gi"), r.colorStringFilter = function(t) {
                    var e, i = t[0] + t[1];
                    ut.test(i) && (e = -1 !== i.indexOf("hsl(") || -1 !== i.indexOf("hsla("), t[0] = pt(t[0], e), t[1] = pt(t[1], e)), ut.lastIndex = 0
                ...
                var dt = function(t, e, i, n) {
                        ...
                        return c ? s = e ? function(t) {
                            ...
                            if ("number" == typeof t) t += p;
                                ...
                                for (f = t.replace(z, "|").split("|"), d = 0; d < f.length; d++) f[d] = s(f[d]);
                                return f.join(",")
                            }
                            if (e = (t.match(ut) || [o])[0], d = (u = t.split(e).join("").match(y) || []).length, c > d--)
                                for (; ++d < c;) u[d] = i ? u[(d - 1) / 2 | 0] : r[d];
                            return a + u.join(h) + h + e + l + (-1 !== t.indexOf("inset") ? " inset" : "")
                        } : function(t) {
                            var e, o, u;
                            if ("number" == typeof t) t += p;
                            else if (n && z.test(t)) {
                                for (o = t.replace(z, "|").split("|"), u = 0; u < o.length; u++) o[u] = s(o[u]);
                                return o.join(",")
                            }
                            if (u = (e = t.match(y) || []).length, c > u--)
                    ...
                    gt = (N._parseToProxy = function(t, e, i, n, s, o) {
                        var r, a, l, h, c, p = n,
                            u = {},
                            d = {},
                            f = i._transform,
                            m = $;
                        for (i._transform = null, $ = e, n = c = i.parse(t, e, n, s), $ = m, o && (i._transform = f, p && (p._prev = null, p._prev && (p._prev._next = null))); n && n !== p;) {
                            if (n.type <= 1 && (d[a = n.p] = n.s + n.c, u[a] = n.s, o || (h = new mt(n, "s", a, h, n.r), n.c = 0), 1 === n.type))
                                for (r = n.l; --r > 0;) l = "xn" + r, d[a = n.p + "_" + l] = n.data[l], u[a] = n[l], o || (h = new mt(n, l, a, h, n.rxp[l]));
                            n = n._next
                        }
                        return {
                            proxy: u,
                    ...
                    }, N.CSSPropTween = function(t, e, n, s, r, a, l, h, c, p, u) {
                        this.t = t, this.p = e, this.s = n, this.c = s, this.n = l || e, t instanceof gt || o.push(this.n), this.r = h, this.type = a || 0, c && (this.pr = c, i = !0), this.b = void 0 === p ? n : p, this.e = void 0 === u ? n + s : u, r && (this._next = r, r._prev = this)
                    }),
                    vt = function(t, e, i, n, s, o) {
                        var r = new gt(t, e, i, n - i, s, -1, o);
                        return r.b = i, r.e = r.xs0 = n, r
                    },
                    yt = r.parseComplex = function(t, e, i, n, s, o, a, l, h, p) {
                        a = new gt(t, e, 0, 0, a, p ? 2 : 1, null, !1, l, i = i || o || "", n), n += "", s && ut.test(n + i) && (n = [i, n], r.colorStringFilter(n), i = n[0], n = n[1]);
                        var u, d, f, m, y, _, w, x, b, T, S, k, C, P = i.split(", ").join(",").split(" "),
                            E = n.split(", ").join(",").split(" "),
                            O = P.length,
                            I = !1 !== c;
                        for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (P = P.join(" ").replace(z, ", ").split(" "), E = E.join(" ").replace(z, ", ").split(" "), O = P.length), O !== E.length && (O = (P = (o || "").split(" ")).length), a.plugin = h, a.setRatio = p, ut.lastIndex = 0, u = 0; O > u; u++)
                            if (m = P[u], y = E[u], (x = parseFloat(m)) || 0 === x) a.appendXtra("", x, ot(y, x), y.replace(v, ""), I && -1 !== y.indexOf("px"), !0);
                            else if (s && ut.test(m)) k = ")" + ((k = y.indexOf(")") + 1) ? y.substr(k) : ""), C = -1 !== y.indexOf("hsl") && W, m = ct(m, C), y = ct(y, C), (b = m.length + y.length > 6) && !W && 0 === y[3] ? (a["xs" + a.l] += a.l ? " transparent" : "transparent", a.e = a.e.split(E[u]).join("transparent")) : (W || (b = !1), C ? a.appendXtra(b ? "hsla(" : "hsl(", m[0], ot(y[0], m[0]), ",", !1, !0).appendXtra("", m[1], ot(y[1], m[1]), "%,", !1).appendXtra("", m[2], ot(y[2], m[2]), b ? "%," : "%" + k, !1) : a.appendXtra(b ? "rgba(" : "rgb(", m[0], y[0] - m[0], ",", !0, !0).appendXtra("", m[1], y[1] - m[1], ",", !0).appendXtra("", m[2], y[2] - m[2], b ? "," : k, !0), b && (m = m.length < 4 ? 1 : m[3], a.appendXtra("", m, (y.length < 4 ? 1 : y[3]) - m, k, !1))), ut.lastIndex = 0;
                        else if (_ = m.match(g)) {
                            if (!(w = y.match(v)) || w.length !== _.length) return a;
                            for (f = 0, d = 0; d < _.length; d++) S = _[d], T = m.indexOf(S, f), a.appendXtra(m.substr(f, T - f), Number(S), ot(w[d], S), "", I && "px" === m.substr(T + S.length, 2), 0 === d), f = T + S.length;
                            a["xs" + a.l] += m.substr(f)
                ...
                h.xs0 = "", h._next = h._prev = h.xfirst = h.data = h.plugin = h.setRatio = h.rxp = null, h.appendXtra = function(t, e, i, n, s, o) {
                    var r = this,
                        a = r.l;
                    return r["xs" + a] += o && (a || r["xs" + a]) ? " " + t : t || "", i || 0 === a || r.plugin ? (r.l++, r.type = r.setRatio ? 2 : 1, r["xs" + r.l] = n || "", a > 0 ? (r.data["xn" + a] = e + i, r.rxp["xn" + a] = s, r["xn" + a] = e, r.plugin || (r.xfirst = new gt(r, "xn" + a, e, i, r.xfirst || r, 0, r.n, s, r.pr), r.xfirst.xs0 = 0), r) : (r.data = {
                        s: e + i
                    }, r.rxp = {}, r.s = e, r.c = i, r.r = s, r)) : (r["xs" + a] += e + (n || ""), r)
                };
                var wt = function(t, e) {
                        e = e || {}, this.p = e.prefix && V(t) || t, l[t] = l[this.p] = this, this.format = e.formatter || dt(e.defaultValue, e.color, e.collapsible, e.multi), e.parser && (this.parse = e.parser), this.clrs = e.color, this.multi = e.multi, this.keyword = e.keyword, this.dflt = e.defaultValue, this.pr = e.priority || 0
                    },
                    xt = N._registerComplexSpecialProp = function(t, e, i) {
                        "object" != typeof e && (e = {
                            parser: i
                        });
                        var n, s = t.split(","),
                            o = e.defaultValue;
                        for (i = i || [o], n = 0; n < s.length; n++) e.prefix = 0 === n && e.prefix, e.defaultValue = i[n] || o, new wt(s[n], e)
                    },
                    bt = function(t) {
                        if (!l[t]) {
                            ...
                            xt(t, {
                                parser: function(t, i, n, s, o, r, h) {
                                    ...
                                    return c ? (c._cssRegister(), l[n].parse(t, i, n, s, o, r, h)) : (X("Error: " + e + " js file not loaded."), o)
                                }
                            })
                        }
                    };
                (h = wt.prototype).parseComplex = function(t, e, i, n, s, o) {
                    var r, a, l, h, c, p, u = this.keyword;
                    if (this.multi && (z.test(i) || z.test(e) ? (a = e.replace(z, "|").split("|"), l = i.replace(z, "|").split("|")) : u && (a = [e], l = [i])), l) {
                        for (h = l.length > a.length ? l.length : a.length, r = 0; h > r; r++) e = a[r] = a[r] || this.dflt, i = l[r] = l[r] || this.dflt, u && ((c = e.indexOf(u)) !== (p = i.indexOf(u)) && (-1 === p ? a[r] = a[r].split(u).join("") : -1 === c && (a[r] += " " + u)));
                        e = a.join(", "), i = l.join(", ")
                    }
                    return yt(t, this.p, e, i, this.clrs, this.dflt, n, this.pr, s, o)
                    ...
                    xt(t, {
                        parser: function(t, n, s, o, r, a, l) {
                            var h = new gt(t, s, 0, 0, r, 2, s, !1, i);
                            return h.plugin = a, h.setRatio = e(t, n, o._tween, s), h
                        },
                        priority: i
                    })
                }, r.useSVGTransformAttr = u || d;
                var Tt, St = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                    ...
                    zt = D.documentElement,
                    At = function() {
                        var t, e, i, n = m || /Android/i.test(B) && !window.chrome;
                        return D.createElementNS && !n && (t = Mt("svg", zt), i = (e = Mt("rect", t, {
                            width: 100,
                            height: 50,
                            x: 100
                        })).getBoundingClientRect().width, e.style[Pt] = "50% 50%", e.style[kt] = "scaleX(0.5)", n = i === e.getBoundingClientRect().width && !(d && Et), zt.removeChild(t)), n
                    }(),
                    Rt = function(t, e, i, n, s, o) {
                        var a, l, h, c, p, u, d, f, m, g, v, y, _, w, x = t._gsTransform,
                            b = Dt(t, !0);
                        x && (_ = x.xOrigin, w = x.yOrigin), (!n || (a = n.split(" ")).length < 2) && (d = t.getBBox(), a = [(-1 !== (e = st(e).split(" "))[0].indexOf("%") ? parseFloat(e[0]) / 100 * d.width : parseFloat(e[0])) + d.x, (-1 !== e[1].indexOf("%") ? parseFloat(e[1]) / 100 * d.height : parseFloat(e[1])) + d.y]), i.xOrigin = c = parseFloat(a[0]), i.yOrigin = p = parseFloat(a[1]), n && b !== $t && (u = b[0], d = b[1], f = b[2], m = b[3], g = b[4], l = c * (m / (y = u * m - d * f)) + p * (-f / y) + (f * (v = b[5]) - m * g) / y, h = c * (-d / y) + p * (u / y) - (u * v - d * g) / y, c = i.xOrigin = a[0] = l, p = i.yOrigin = a[1] = h), x && (o && (i.xOffset = x.xOffset, i.yOffset = x.yOffset, x = i), s || !1 !== s && !1 !== r.defaultSmoothOrigin ? (l = c - _, h = p - w, x.xOffset += l * b[0] + h * b[2] - l, x.yOffset += l * b[1] + h * b[3] - h) : x.xOffset = x.yOffset = 0), o || t.setAttribute("data-svg-origin", a.join(" "))
                    },
                    Lt = function(t) {
                        return !!(It && t.getBBox && t.getCTM && function(t) {
                            try {
                                return t.getBBox()
                            } catch (t) {}
                    ...
                    Dt = function(t, e) {
                        ...
                        if (kt ? n = Z(t, Ct, null, !0) : t.currentStyle && (n = (n = t.currentStyle.filter.match(I)) && 4 === n.length ? [n[0].substr(4), Number(n[2].substr(4)), Number(n[1].substr(4)), n[3].substr(4), a.x || 0, a.y || 0].join(",") : ""), i = !n || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n, (a.svg || t.getBBox && Lt(t)) && (i && -1 !== (t.style[kt] + "").indexOf("matrix") && (n = t.style[kt], i = 0), s = t.getAttribute("transform"), i && s && (-1 !== s.indexOf("matrix") ? (n = s, i = 0) : -1 !== s.indexOf("translate") && (n = "matrix(1,0,0,1," + s.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(",") + ")", i = 0))), i) return $t;
                        for (s = (n || "").match(g) || [], _t = s.length; --_t > -1;) o = Number(s[_t]), s[_t] = (r = o - (o |= 0)) ? (1e5 * r + (0 > r ? -.5 : .5) | 0) / 1e5 + o : o;
                        return e && s.length > 6 ? [s[0], s[1], s[4], s[5], s[12], s[13]] : s
                    },
                    jt = N.getTransform = function(t, i, n, o) {
                        if (t._gsTransform && n && !o) return t._gsTransform;
                        var a, l, h, c, p, u, d = n && t._gsTransform || new Ot,
                            f = d.scaleX < 0,
                            m = 1e5,
                            g = Et && (parseFloat(Z(t, Pt, i, !1, "0 0 0").split(" ")[2]) || d.zOrigin) || 0,
                            v = parseFloat(r.defaultTransformPerspective) || 0;
                        if (d.svg = !(!t.getBBox || !Lt(t)), d.svg && (Rt(t, Z(t, Pt, s, !1, "50% 50%") + "", d, t.getAttribute("data-svg-origin")), Tt = r.useSVGTransformAttr || At), (a = Dt(t)) !== $t) {
                            if (16 === a.length) {
                                var y, _, w, x, b, T = a[0],
                                    S = a[1],
                                    k = a[2],
                                    ...
                                    j = a[11],
                                    F = Math.atan2(O, A);
                                d.zOrigin && (R = M * (D = -d.zOrigin) - a[12], $ = z * D - a[13], D = A * D + d.zOrigin - a[14]), d.rotationX = F * L, F && (y = P * (x = Math.cos(-F)) + M * (b = Math.sin(-F)), _ = E * x + z * b, w = O * x + A * b, M = P * -b + M * x, z = E * -b + z * x, A = O * -b + A * x, j = I * -b + j * x, P = y, E = _, O = w), F = Math.atan2(-k, A), d.rotationY = F * L, F && (_ = S * (x = Math.cos(-F)) - z * (b = Math.sin(-F)), w = k * x - A * b, z = S * b + z * x, A = k * b + A * x, j = C * b + j * x, T = y = T * x - M * b, S = _, k = w), F = Math.atan2(S, T), d.rotation = F * L, F && (T = T * (x = Math.cos(-F)) + P * (b = Math.sin(-F)), _ = S * x + E * b, E = S * -b + E * x, O = k * -b + O * x, S = _), d.rotationX && Math.abs(d.rotationX) + Math.abs(d.rotation) > 359.9 && (d.rotationX = d.rotation = 0, d.rotationY = 180 - d.rotationY), d.scaleX = (Math.sqrt(T * T + S * S) * m + .5 | 0) / m, d.scaleY = (Math.sqrt(E * E + z * z) * m + .5 | 0) / m, d.scaleZ = (Math.sqrt(O * O + A * A) * m + .5 | 0) / m, d.skewX = P || E ? Math.atan2(P, E) * L + d.rotation : d.skewX || 0, Math.abs(d.skewX) > 90 && Math.abs(d.skewX) < 270 && (f ? (d.scaleX *= -1, d.skewX += d.rotation <= 0 ? 180 : -180, d.rotation += d.rotation <= 0 ? 180 : -180) : (d.scaleY *= -1, d.skewX += d.skewX <= 0 ? 180 : -180)), d.perspective = j ? 1 / (0 > j ? -j : j) : 0, d.x = R, d.y = $, d.z = D, d.svg && (d.x -= d.xOrigin - (d.xOrigin * T - d.yOrigin * P), d.y -= d.yOrigin - (d.yOrigin * S - d.xOrigin * E))
                            } else if ((!Et || o || !a.length || d.x !== a[4] || d.y !== a[5] || !d.rotationX && !d.rotationY) && (void 0 === d.x || "none" !== Z(t, "display", i))) {
                                var H = a.length >= 6,
                                    N = H ? a[0] : 1,
                                    B = a[1] || 0,
                                    W = a[2] || 0,
                                    q = H ? a[3] : 1;
                                d.x = a[4] || 0, d.y = a[5] || 0, h = Math.sqrt(N * N + B * B), c = Math.sqrt(q * q + W * W), p = N || B ? Math.atan2(B, N) * L : d.rotation || 0, u = W || q ? Math.atan2(W, q) * L + p : d.skewX || 0, Math.abs(u) > 90 && Math.abs(u) < 270 && (f ? (h *= -1, u += 0 >= p ? 180 : -180, p += 0 >= p ? 180 : -180) : (c *= -1, u += 0 >= u ? 180 : -180)), d.scaleX = h, d.scaleY = c, d.rotation = p, d.skewX = u, Et && (d.rotationX = d.rotationY = d.z = 0, d.perspective = v, d.scaleZ = 1), d.svg && (d.x -= d.xOrigin - (d.xOrigin * N + d.yOrigin * W), d.y -= d.yOrigin - (d.xOrigin * B + d.yOrigin * q))
                            }
                            for (l in d.zOrigin = g, d) d[l] < 2e-5 && d[l] > -2e-5 && (d[l] = 0)
                        }
                    ...
                    Ft = function(t) {
                        ...
                        if (u) {
                            ...
                            if (null != n.ox && (b += (d = (n.oxp ? g * n.ox * .01 : n.ox) - g / 2) - (d * a + (f = (n.oyp ? v * n.oy * .01 : n.oy) - v / 2) * l), T += f - (d * h + f * c)), y ? _ += ", Dx=" + ((d = g / 2) - (d * a + (f = v / 2) * l) + b) + ", Dy=" + (f - (d * h + f * c) + T) + ")" : _ += ", sizingMethod='auto expand')", -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? p.filter = e.replace(M, _) : p.filter = _ + " " + e, (0 === t || 1 === t) && 1 === a && 0 === l && 0 === h && 1 === c && (y && -1 === _.indexOf("Dx=0, Dy=0") || x.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf(e.indexOf("Alpha")) && p.removeAttribute("filter")), !y) {
                                var S, k, C, P = 8 > m ? 1 : -1;
                                for (d = n.ieOffsetX || 0, f = n.ieOffsetY || 0, n.ieOffsetX = Math.round((g - ((0 > a ? -a : a) * g + (0 > l ? -l : l) * v)) / 2 + b), n.ieOffsetY = Math.round((v - ((0 > c ? -c : c) * v + (0 > h ? -h : h) * g)) / 2 + T), _t = 0; 4 > _t; _t++) C = (i = -1 !== (S = u[k = it[_t]]).indexOf("px") ? parseFloat(S) : Q(this.t, k, parseFloat(S), S.replace(w, "")) || 0) !== n[k] ? 2 > _t ? -n.ieOffsetX : -n.ieOffsetY : 2 > _t ? d - n.ieOffsetX : f - n.ieOffsetY, p[k] = (n[k] = Math.round(i - C * (0 === _t || 2 === _t ? 1 : P))) + "px"
                            }
                        }
                    },
                    Ht = N.set3DTransformRatio = N.setTransformRatio = function(t) {
                        var e, i, n, s, o, r, a, l, h, c, p, u, f, m, g, v, y, _, w, x, b, T, S, k = this.data,
                            C = this.t.style,
                            P = k.rotation,
                            E = k.rotationX,
                            O = k.rotationY,
                            ...
                            j = k.perspective,
                            F = k.force3D;
                        if (!((1 !== t && 0 !== t || "auto" !== F || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && F || $ || j || O || E || 1 !== z) || Tt && D || !Et) P || k.skewX || D ? (P *= R, T = k.skewX * R, S = 1e5, e = Math.cos(P) * I, s = Math.sin(P) * I, i = Math.sin(P - T) * -M, o = Math.cos(P - T) * M, T && "simple" === k.skewType && (y = Math.tan(T), i *= y = Math.sqrt(1 + y * y), o *= y, k.skewY && (e *= y, s *= y)), D && (A += k.xOrigin - (k.xOrigin * e + k.yOrigin * i) + k.xOffset, L += k.yOrigin - (k.xOrigin * s + k.yOrigin * o) + k.yOffset, Tt && (k.xPercent || k.yPercent) && (m = this.t.getBBox(), A += .01 * k.xPercent * m.width, L += .01 * k.yPercent * m.height), (m = 1e-6) > A && A > -m && (A = 0), m > L && L > -m && (L = 0)), w = (e * S | 0) / S + "," + (s * S | 0) / S + "," + (i * S | 0) / S + "," + (o * S | 0) / S + "," + A + "," + L + ")", D && Tt ? this.t.setAttribute("transform", "matrix(" + w) : C[kt] = (k.xPercent || k.yPercent ? "translate(" + k.xPercent + "%," + k.yPercent + "%) matrix(" : "matrix(") + w) : C[kt] = (k.xPercent || k.yPercent ? "translate(" + k.xPercent + "%," + k.yPercent + "%) matrix(" : "matrix(") + I + ",0,0," + M + "," + A + "," + L + ")";
                        else {
                            if (d && ((m = 1e-4) > I && I > -m && (I = z = 2e-5), m > M && M > -m && (M = z = 2e-5), !j || k.z || k.rotationX || k.rotationY || (j = 0)), P || k.skewX) P *= R, g = e = Math.cos(P), v = s = Math.sin(P), k.skewX && (P -= k.skewX * R, g = Math.cos(P), v = Math.sin(P), "simple" === k.skewType && (y = Math.tan(k.skewX * R), g *= y = Math.sqrt(1 + y * y), v *= y, k.skewY && (e *= y, s *= y))), i = -v, o = g;
                            else {
                                if (!(O || E || 1 !== z || j || D)) return void(C[kt] = (k.xPercent || k.yPercent ? "translate(" + k.xPercent + "%," + k.yPercent + "%) translate3d(" : "translate3d(") + A + "px," + L + "px," + $ + "px)" + (1 !== I || 1 !== M ? " scale(" + I + "," + M + ")" : ""));
                                e = o = 1, i = s = 0
                            }
                            h = 1, n = r = a = l = c = p = 0, u = j ? -1 / j : 0, f = k.zOrigin, m = 1e-6, x = ",", b = "0", (P = O * R) && (g = Math.cos(P), a = -(v = Math.sin(P)), c = u * -v, n = e * v, r = s * v, h = g, u *= g, e *= g, s *= g), (P = E * R) && (y = i * (g = Math.cos(P)) + n * (v = Math.sin(P)), _ = o * g + r * v, l = h * v, p = u * v, n = i * -v + n * g, r = o * -v + r * g, h *= g, u *= g, i = y, o = _), 1 !== z && (n *= z, r *= z, h *= z, u *= z), 1 !== M && (i *= M, o *= M, l *= M, p *= M), 1 !== I && (e *= I, s *= I, a *= I, c *= I), (f || D) && (f && (A += n * -f, L += r * -f, $ += h * -f + f), D && (A += k.xOrigin - (k.xOrigin * e + k.yOrigin * i) + k.xOffset, L += k.yOrigin - (k.xOrigin * s + k.yOrigin * o) + k.yOffset), m > A && A > -m && (A = b), m > L && L > -m && (L = b), m > $ && $ > -m && ($ = 0)), w = k.xPercent || k.yPercent ? "translate(" + k.xPercent + "%," + k.yPercent + "%) matrix3d(" : "matrix3d(", w += (m > e && e > -m ? b : e) + x + (m > s && s > -m ? b : s) + x + (m > a && a > -m ? b : a), w += x + (m > c && c > -m ? b : c) + x + (m > i && i > -m ? b : i) + x + (m > o && o > -m ? b : o), E || O || 1 !== z ? (w += x + (m > l && l > -m ? b : l) + x + (m > p && p > -m ? b : p) + x + (m > n && n > -m ? b : n), w += x + (m > r && r > -m ? b : r) + x + (m > h && h > -m ? b : h) + x + (m > u && u > -m ? b : u) + x) : w += ",0,0,0,0,1,0,", w += A + x + L + x + $ + x + (j ? 1 + -$ / j : 1) + ")", C[kt] = w
                        }
                    };
                (h = Ot.prototype).x = h.y = h.z = h.skewX = h.skewY = h.rotation = h.rotationX = h.rotationY = h.zOrigin = h.xPercent = h.yPercent = h.xOffset = h.yOffset = 0, h.scaleX = h.scaleY = h.scaleZ = 1, xt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
                    parser: function(t, e, i, n, o, a, l) {
                        if (n._lastParsedTransform === l) return o;
                        n._lastParsedTransform = l;
                        var h, c, p, u, d, f, m, g, v, y, _ = t._gsTransform,
                            w = t.style,
                            x = St.length,
                            b = l,
                            T = {},
                            S = "transformOrigin";
                        if (l.display ? (p = Z(t, "display"), w.display = "block", h = jt(t, s, !0, l.parseTransform), w.display = p) : h = jt(t, s, !0, l.parseTransform), n._transform = h, "string" == typeof b.transform && kt)(p = F.style)[kt] = b.transform, p.display = "block", p.position = "absolute", D.body.appendChild(F), c = jt(F, null, !1), h.svg && (g = h.xOrigin, v = h.yOrigin, c.x -= h.xOffset, c.y -= h.yOffset, (b.transformOrigin || b.svgOrigin) && (u = {}, Rt(t, st(b.transformOrigin), u, b.svgOrigin, b.smoothOrigin, !0), g = u.xOrigin, v = u.yOrigin, c.x -= u.xOffset - h.xOffset, c.y -= u.yOffset - h.yOffset), (g || v) && (y = Dt(F), c.x -= g - (g * y[0] + v * y[2]), c.y -= v - (g * y[1] + v * y[3]))), D.body.removeChild(F), c.perspective || (c.perspective = h.perspective), null != b.xPercent && (c.xPercent = rt(b.xPercent, h.xPercent)), null != b.yPercent && (c.yPercent = rt(b.yPercent, h.yPercent));
                        else if ("object" == typeof b) {
                            if (c = {
                                    scaleX: rt(null != b.scaleX ? b.scaleX : b.scale, h.scaleX),
                                    scaleY: rt(null != b.scaleY ? b.scaleY : b.scale, h.scaleY),
                                    scaleZ: rt(b.scaleZ, h.scaleZ),
                                    x: rt(b.x, h.x),
                                    y: rt(b.y, h.y),
                                    z: rt(b.z, h.z),
                                    xPercent: rt(b.xPercent, h.xPercent),
                                    yPercent: rt(b.yPercent, h.yPercent),
                                    perspective: rt(b.transformPerspective, h.perspective)
                                }, null != (m = b.directionalRotation))
                                if ("object" == typeof m)
                                    for (p in m) b[p] = m[p];
                                else b.rotation = m;
                            "string" == typeof b.x && -1 !== b.x.indexOf("%") && (c.x = 0, c.xPercent = rt(b.x, h.xPercent)), "string" == typeof b.y && -1 !== b.y.indexOf("%") && (c.y = 0, c.yPercent = rt(b.y, h.yPercent)), c.rotation = at("rotation" in b ? b.rotation : "shortRotation" in b ? b.shortRotation + "_short" : "rotationZ" in b ? b.rotationZ : h.rotation - h.skewY, h.rotation - h.skewY, "rotation", T), Et && (c.rotationX = at("rotationX" in b ? b.rotationX : "shortRotationX" in b ? b.shortRotationX + "_short" : h.rotationX || 0, h.rotationX, "rotationX", T), c.rotationY = at("rotationY" in b ? b.rotationY : "shortRotationY" in b ? b.shortRotationY + "_short" : h.rotationY || 0, h.rotationY, "rotationY", T)), c.skewX = at(b.skewX, h.skewX - h.skewY), (c.skewY = at(b.skewY, h.skewY)) && (c.skewX += c.skewY, c.rotation += c.skewY)
                        }
                        for (Et && null != b.force3D && (h.force3D = b.force3D, f = !0), h.skewType = b.skewType || h.skewType || r.defaultSkewType, (d = h.force3D || h.z || h.rotationX || h.rotationY || c.z || c.rotationX || c.rotationY || c.perspective) || null == b.scale || (c.scaleZ = 1); --x > -1;)((u = c[i = St[x]] - h[i]) > 1e-6 || -1e-6 > u || null != b[i] || null != $[i]) && (f = !0, o = new gt(h, i, h[i], u, o), i in T && (o.e = T[i]), o.xs0 = 0, o.plugin = a, n._overwriteProps.push(o.n));
                        return u = b.transformOrigin, h.svg && (u || b.svgOrigin) && (g = h.xOffset, v = h.yOffset, Rt(t, st(u), c, b.svgOrigin, b.smoothOrigin), o = vt(h, "xOrigin", (_ ? h : c).xOrigin, c.xOrigin, o, S), o = vt(h, "yOrigin", (_ ? h : c).yOrigin, c.yOrigin, o, S), (g !== h.xOffset || v !== h.yOffset) && (o = vt(h, "xOffset", _ ? g : h.xOffset, h.xOffset, o, S), o = vt(h, "yOffset", _ ? v : h.yOffset, h.yOffset, o, S)), u = Tt ? null : "0px 0px"), (u || Et && d && h.zOrigin) && (kt ? (f = !0, i = Pt, u = (u || Z(t, i, s, !1, "50% 50%")) + "", (o = new gt(w, i, 0, 0, o, -1, S)).b = w[i], o.plugin = a, Et ? (p = h.zOrigin, u = u.split(" "), h.zOrigin = (u.length > 2 && (0 === p || "0px" !== u[2]) ? parseFloat(u[2]) : p) || 0, o.xs0 = o.e = u[0] + " " + (u[1] || "50%") + " 0px", (o = new gt(h, "zOrigin", 0, 0, o, -1, o.n)).b = p, o.xs0 = o.e = h.zOrigin) : o.xs0 = o.e = u) : st(u + "", h)), f && (n._transformType = h.svg && Tt || !d && 3 !== this._transformType ? 2 : 3), o
                    },
                    prefix: !0
                }), xt("boxShadow", {
                    ...
                    parser: function(t, e, i, o, r, a) {
                        e = this.format(e);
                        var l, h, c, p, u, d, f, m, g, v, y, _, w, x, b, T, S = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
                            k = t.style;
                        for (g = parseFloat(t.offsetWidth), v = parseFloat(t.offsetHeight), l = e.split(" "), h = 0; h < S.length; h++) this.p.indexOf("border") && (S[h] = V(S[h])), -1 !== (u = p = Z(t, S[h], s, !1, "0px")).indexOf(" ") && (p = u.split(" "), u = p[0], p = p[1]), d = c = l[h], f = parseFloat(u), _ = u.substr((f + "").length), (w = "=" === d.charAt(1)) ? (m = parseInt(d.charAt(0) + "1", 10), d = d.substr(2), m *= parseFloat(d), y = d.substr((m + "").length - (0 > m ? 1 : 0)) || "") : (m = parseFloat(d), y = d.substr((m + "").length)), "" === y && (y = n[i] || _), y !== _ && (x = Q(t, "borderLeft", f, _), b = Q(t, "borderTop", f, _), "%" === y ? (u = x / g * 100 + "%", p = b / v * 100 + "%") : "em" === y ? (u = x / (T = Q(t, "borderLeft", 1, "em")) + "em", p = b / T + "em") : (u = x + "px", p = b + "px"), w && (d = parseFloat(u) + m + y, c = parseFloat(p) + m + y)), r = yt(k, S[h], u + " " + p, d + " " + c, !1, "0px", r);
                        return r
                    },
                    prefix: !0,
                    ...
                    parser: function(t, e, i, n, o, r) {
                        return yt(t.style, i, this.format(Z(t, i, s, !1, "0px 0px")), this.format(e), !1, "0px", o)
                    },
                    prefix: !0,
                    ...
                    defaultValue: "0 0",
                    parser: function(t, e, i, n, o, r) {
                        var a, l, h, c, p, u, d = "background-position",
                            f = s || G(t, null),
                            ...
                            v = this.format(e);
                        if (-1 !== g.indexOf("%") != (-1 !== v.indexOf("%")) && v.split(",").length < 2 && ((u = Z(t, "backgroundImage").replace(P, "")) && "none" !== u)) {
                            for (a = g.split(" "), l = v.split(" "), H.setAttribute("src", u), h = 2; --h > -1;)(c = -1 !== (g = a[h]).indexOf("%")) !== (-1 !== l[h].indexOf("%")) && (p = 0 === h ? t.offsetWidth - H.width : t.offsetHeight - H.height, a[h] = c ? parseFloat(g) / 100 * p + "px" : parseFloat(g) / p * 100 + "%");
                            g = a.join(" ")
                        }
                    ...
                    parser: function(t, e, i, n, o, r) {
                        var a, l, h;
                        return 9 > m ? (l = t.currentStyle, h = 8 > m ? " " : ",", a = "rect(" + l.clipTop + h + l.clipRight + h + l.clipBottom + h + l.clipLeft + ")", e = this.format(e).split(",").join(h)) : (a = this.format(Z(t, this.p, s, !1, this.dflt)), e = this.format(e)), this.parseComplex(t.style, a, e, o, r)
                    }
                }), xt("textShadow", {
                ...
                xt("opacity,alpha,autoAlpha", {
                    ...
                    parser: function(t, e, i, n, o, r) {
                        var a = parseFloat(Z(t, "opacity", s, !1, "1")),
                            l = t.style,
                            h = "autoAlpha" === i;
                        return "string" == typeof e && "=" === e.charAt(1) && (e = ("-" === e.charAt(0) ? -1 : 1) * parseFloat(e.substr(2)) + a), h && 1 === a && "hidden" === Z(t, "visibility", s) && 0 !== e && (a = 0), W ? o = new gt(l, "opacity", a, e - a, o) : ((o = new gt(l, "opacity", 100 * a, 100 * (e - a), o)).xn1 = h ? 1 : 0, l.zoom = 1, o.type = 2, o.b = "alpha(opacity=" + o.s + ")", o.e = "alpha(opacity=" + (o.s + o.c) + ")", o.data = t, o.plugin = r, o.setRatio = Nt), h && ((o = new gt(l, "visibility", 0, 0, o, -1, null, !1, 0, 0 !== a ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit")).xs0 = "inherit", n._overwriteProps.push(o.n), n._overwriteProps.push(i)), o
                    }
                });
                var Bt = function(t, e) {
                ...
                xt("className", {
                    parser: function(t, e, n, o, r, a, l) {
                        var h, c, p, u, d, f = t.getAttribute("class") || "",
                            m = t.style.cssText;
                        if ((r = o._classNamePT = new gt(t, n, 0, 0, r, 2)).setRatio = Wt, r.pr = -11, i = !0, r.b = f, c = J(t, s), p = t._gsClassPT) {
                            for (u = {}, d = p.data; d;) u[d.p] = 1, d = d._next;
                            p.setRatio(1)
                        }
                        return t._gsClassPT = r, r.e = "=" !== e.charAt(1) ? e : f.replace(new RegExp("(?:\\s|^)" + e.substr(2) + "(?![\\w-])"), "") + ("+" === e.charAt(0) ? " " + e.substr(2) : ""), t.setAttribute("class", r.e), h = tt(t, c, J(t), l, u), t.setAttribute("class", f), r.data = h.firstMPT, t.style.cssText = m, r.xfirst = o.parse(t, h.difs, r, a)
                    }
                });
                var qt = function(t) {
                    if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                        ...
                        if ("all" === this.e) r.cssText = "", s = !0;
                            ...
                            for (n = (e = this.e.split(" ").join("").split(",")).length; --n > -1;) i = e[n], l[i] && (l[i].parse === a ? s = !0 : i = "transformOrigin" === i ? Pt : l[i].p), Bt(r, i);
                        s && (Bt(r, kt), (o = this.t._gsTransform) && (o.svg && (this.t.removeAttribute("data-svg-origin"), this.t.removeAttribute("transform")), delete this.t._gsTransform))
                    }
                };
                for (xt("clearProps", {
                        parser: function(t, e, n, s, o) {
                            return (o = new gt(t, n, 0, 0, o, 2)).setRatio = qt, o.e = e, o.pr = -10, o.data = s._tween, i = !0, o
                        }
                ...
                (h = r.prototype)._firstPT = h._lastParsedTransform = h._transform = null, h._onInitTween = function(t, e, a) {
                    ...
                    this._target = t, this._tween = a, this._vars = e, c = e.autoRound, i = !1, n = e.suffixMap || r.suffixMap, s = G(t, ""), o = this._overwriteProps;
                    var h, d, m, g, v, y, _, w, x, T = t.style;
                    if (p && "" === T.zIndex && (("auto" === (h = Z(t, "zIndex", s)) || "" === h) && this._addLazySet(T, "zIndex", 0)), "string" == typeof e && (g = T.cssText, h = J(t, s), T.cssText = g + ";" + e, h = tt(t, h, J(t)).difs, !W && b.test(e) && (h.opacity = parseFloat(RegExp.$1)), e = h, T.cssText = g), e.className ? this._firstPT = d = l.className.parse(t, e.className, "className", this, null, null, e) : this._firstPT = d = this.parse(t, e, null), this._transformType) {
                        for (x = 3 === this._transformType, kt ? u && (p = !0, "" === T.zIndex && (("auto" === (_ = Z(t, "zIndex", s)) || "" === _) && this._addLazySet(T, "zIndex", 0)), f && this._addLazySet(T, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (x ? "visible" : "hidden"))) : T.zoom = 1, m = d; m && m._next;) m = m._next;
                        w = new gt(t, "transform", 0, 0, null, 2), this._linkCSSP(w, null, m), w.setRatio = kt ? Ht : Ft, w.data = this._transform || jt(t, s, !0), w.tween = a, w.pr = -1, o.pop()
                    }
                    if (i) {
                        for (; d;) {
                ...
                var Yt = function(t, e, i) {
                    ...
                    if (t.slice)
                        ...
                        for (s = (n = t.childNodes).length; --s > -1;) r = (o = n[s]).type, o.style && (e.push(J(o)), i && i.push(o)), 1 !== r && 9 !== r && 11 !== r || !o.childNodes.length || Yt(o, e, i)
                };
                return r.cascadeTo = function(t, i, n) {
                    ...
                    for (t = l._targets || l.target, Yt(t, c, u), l.render(i, !0, !0), Yt(t, p), l.render(0, !0, !0), l._enabled(!0), s = u.length; --s > -1;)
                        if ((o = tt(u[s], c[s], p[s])).firstMPT) {
                            for (r in o = o.difs, n) d[r] && (o[r] = n[r]);
            ...
            function() {
                ...
                init: function(t, e, i) {
                    ...
                    var n, s, o, r, a, l = !0 === e.useRadians ? 2 * Math.PI : 360;
                    for (n in e) "useRadians" !== n && (s = (a = (e[n] + "").split("_"))[0], o = parseFloat("function" != typeof t[n] ? t[n] : t[n.indexOf("set") || "function" != typeof t["get" + n.substr(3)] ? n : "get" + n.substr(3)]()), r = (this.finals[n] = "string" == typeof s && "=" === s.charAt(1) ? o + parseInt(s.charAt(0) + "1", 10) * Number(s.substr(2)) : Number(s) || 0) - o, a.length && (-1 !== (s = a.join("_")).indexOf("short") && ((r %= l) !== r % (l / 2) && (r = 0 > r ? r + l : r - l)), -1 !== s.indexOf("_cw") && 0 > r ? r = (r + 9999999999 * l) % l - (r / l | 0) * l : -1 !== s.indexOf("ccw") && r > 0 && (r = (r - 9999999999 * l) % l - (r / l | 0) * l)), (r > 1e-6 || -1e-6 > r) && (this._addTween(t, n, o, o + r, n), this._overwriteProps.push(n)));
                    return !0
                },
                set: function(t) {
                    var e;
                ...
                return g.constructor = m, g.getRatio = function(t) {
                    ...
                    for (h.sort(function(t, e) {
                            return t.x - e.x
                        }), a = new u(1, 1, null), d = p; --d > -1;) r = h[d], a = new u(r.x, r.y, a);
        ...
        if (!i.TweenLite) {
            var n, s, o, r, a, l = function(t) {
                ...
                m = function(e, n, s, o) {
                    ...
                    this.check = function(a) {
                        for (var h, c, p, u, d, g = n.length, v = g; --g > -1;)(h = f[n[g]] || new m(n[g], [])).gsClass ? (r[g] = h.gsClass, v--) : a && h.sc.push(this);
                        if (0 === v && s)
                            for (p = (c = ("com.greensock." + e).split(".")).pop(), u = l(c.join("."))[p] = this.gsClass = s.apply(s, r), o && (i[p] = u, !(d = "undefined" != typeof module && module.exports) && "function" == typeof define && define.amd ? define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + e.split(".").pop(), [], function() {
                                    return u
                                }) : "TweenMax" === e && d && (module.exports = u)), g = 0; g < this.sc.length; g++) this.sc[g].check()
                    }, this.check(!0)
                },
            ...
            var y = [0, 0, 1, 1],
                ...
                b = w.register = function(t, e, i, n) {
                    for (var s, o, r, a, l = e.split(","), c = l.length, p = (i || "easeIn,easeOut,easeInOut").split(","); --c > -1;)
                        for (o = l[c], s = n ? v("easing." + o, null, !0) : h.easing[o] || {}, r = p.length; --r > -1;) a = p[r], x[o + "." + a] = x[a + o] = s[a] = t.getRatio ? t : t[a] || new t
                };
            ...
            (o = T.prototype).addEventListener = function(t, e, i, n, s) {
                ...
                var o, l, h = this._listeners[t],
                    c = 0;
                for (null == h && (this._listeners[t] = h = []), l = h.length; --l > -1;)(o = h[l]).c === e && o.s === i ? h.splice(l, 1) : 0 === c && o.pr < s && (c = l + 1);
                h.splice(c, 0, {
                    c: e,
                    s: i,
                    up: n,
            ...
            var S = t.requestAnimationFrame,
                ...
                P = C();
            for (s = (n = ["ms", "moz", "webkit", "o"]).length; --s > -1 && !S;) S = t[n[s] + "RequestAnimationFrame"], k = t[n[s] + "CancelAnimationFrame"] || t[n[s] + "CancelRequestAnimationFrame"];
            v("Ticker", function(t, e) {
                var i, n, s, o, l, h = this,
                    ...
                    g = function(t) {
                        var e, r, a = C() - P;
                        a > f && (p += a - m), P += a, h.time = (P - p) / 1e3, e = h.time - l, (!i || e > 0 || !0 === t) && (h.frame++, l += e + (e >= o ? .004 : o - e), r = !0), !0 !== t && (s = n(g)), r && h.dispatchEvent("tick")
                    };
                T.call(h), h.time = h.frame = 0, h.tick = function() {
                    ...
                    null != s && (d && k ? k(s) : clearTimeout(s), n = u, s = null, h === r && (a = !1))
                }, h.wake = function(t) {
                    null !== s ? h.sleep() : t ? p += -P + (P = C()) : h.frame > 10 && (P = C() - f + 5), n = 0 === i ? u : d && S ? S : function(t) {
            ...
            r = E.ticker = new h.Ticker, (o = E.prototype)._dirty = o._gc = o._initted = o._paused = !1, o._totalTime = o._time = 0, o._rawPrevTime = -1, o._next = o._last = o._onUpdate = o._timeline = o.timeline = null, o._paused = !1;
            var O = function() {
                a && C() - P > 2e3 && r.wake(), setTimeout(O, 2e3)
            };
            O(), o.play = function(t, e) {
                ...
                if (this._timeline) {
                    ...
                    this._gc && this._enabled(!0, !1), (this._totalTime !== t || 0 === this._duration) && (A.length && V(), this.render(t, e, !1), A.length && V())
                }
                return this
            ...
            (o = M.prototype = new E).constructor = M, o.kill()._gc = !1, o.ratio = 0, o._firstPT = o._targets = o._overwrittenProps = o._startAt = null, o._notifyPluginsOfEnabled = o._lazy = !1, M.version = "1.18.4", M.defaultEase = o._ease = new w(null, null, 1, 1), M.defaultOverwrite = "auto", M.ticker = r, M.autoSleep = 120, M.lagSmoothing = function(t, e) {
                r.lagSmoothing(t, e)
            ...
            var A = [],
                ...
                D = function(t, e, i, n) {
                    var s, o, r, a, l, h, c, p = [t, e],
                        u = 0,
                        d = "",
                        f = 0;
                    for (p.start = t, i && (i(p), t = p[0], e = p[1]), p.length = 0, s = t.match(L) || [], o = e.match(L) || [], n && (n._next = null, n.blob = 1, p._firstPT = n), l = o.length, a = 0; l > a; a++) c = o[a], d += (h = e.substr(u, e.indexOf(c, u) - u)) || !a ? h : ",", u += h.length, f ? f = (f + 1) % 5 : "rgba(" === h.substr(-5) && (f = 1), c === s[a] || s.length <= a ? d += c : (d && (p.push(d), d = ""), r = parseFloat(s[a]), p.push(r), p._firstPT = {
                        _next: p._firstPT,
                        t: p,
                        p: p.length - 1,
                        s: r,
                    ...
                    return (d += e.substr(u)) && p.push(d), p.setRatio = $, p
                },
                j = function(t, e, i, n, s, o, r, a) {
                    var l, h = "get" === i ? t[e] : i,
                        c = typeof t[e],
                    ...
                    return "number" !== c && ("function" === c && "get" === i && (l = e.indexOf("set") || "function" != typeof t["get" + e.substr(3)] ? e : "get" + e.substr(3), u.s = h = r ? t[l](r) : t[l]()), "string" == typeof h && (r || isNaN(h)) ? (u.fp = r, u = {
                        t: D(h, n, a || M.defaultStringFilter, u),
                        p: "setRatio",
                        s: 0,
                        c: 1,
                        f: 2,
                        ...
                        n: s || e,
                        pr: 0
                    }) : p || (u.s = parseFloat(h), u.c = parseFloat(n) - u.s || 0)), u.c ? ((u._next = this._firstPT) && (u._next._prev = u), this._firstPT = u, u) : void 0
                },
                F = M._internals = {
                    isArray: d,
                    isSelector: z,
                ...
                X = E._rootFramesTimeline = new I,
                Y = E._rootTimeline = new I,
                U = 30,
                V = F.lazyRender = function() {
                    var t, e = A.length;
                    for (R = {}; --e > -1;)(t = A[e]) && !1 !== t._lazy && (t.render(t._lazy[0], t._lazy[1], !0), t._lazy = !1);
                    A.length = 0
                };
            Y._startTime = r.time, X._startTime = r.frame, Y._active = X._active = !0, setTimeout(V, 1), E._updateRoot = M.render = function() {
                var t, e, i;
                if (A.length && V(), Y.render((r.time - Y._startTime) * Y._timeScale, !1, !1), X.render((r.frame - X._startTime) * X._timeScale, !1, !1), A.length && V(), r.frame >= U) {
                    for (i in U = r.frame + (parseInt(M.autoSleep, 10) || 120), N) {
                        for (t = (e = N[i].tweens).length; --t > -1;) e[t]._gc && e.splice(t, 1);
                        0 === e.length && delete N[i]
                    }
                    if ((!(i = Y._first) || i._paused) && M.autoSleep && !X._first && 1 === r._listeners.tick.length) {
            ...
            var G = function(t, e, i) {
                ...
                Q = function(t, e, i, n, s) {
                    ...
                    var h, p = e._startTime + c,
                        u = [],
                        d = 0,
                        f = 0 === e._duration;
                    for (o = s.length; --o > -1;)(a = s[o]) === e || a._gc || a._paused || (a._timeline !== e._timeline ? (h = h || K(e, 0, f), 0 === K(a, h, f) && (u[d++] = a)) : a._startTime <= p && a._startTime + a.totalDuration() / a._timeScale > p && ((f || !a._initted) && p - a._startTime <= 2e-10 || (u[d++] = a)));
                    for (o = d; --o > -1;)
            ...
            o._init = function() {
                ...
                if (o.startAt) {
                    ...
                    if (s.overwrite = !1, s.immediateRender = !0, s.lazy = l && !1 !== o.lazy, s.startAt = s.delay = null, this._startAt = M.to(this.target, 0, s), l)
                        if (this._time > 0) this._startAt = null;
                        else if (0 !== a) return
                } else if (o.runBackwards && 0 !== a)
                    if (this._startAt) this._startAt.render(-1, !0), this._startAt.kill(), this._startAt = null;
                    else {
                        for (n in 0 !== this._time && (l = !1), i = {}, o) W[n] && "autoCSS" !== n || (i[n] = o[n]);
                ...
                if (this._ease = h = h ? h instanceof w ? h : "function" == typeof h ? new w(h, o.easeParams) : x[h] || M.defaultEase : M.defaultEase, o.easeParams instanceof Array && h.config && (this._ease = h.config.apply(h, o.easeParams)), this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null, this._targets)
                ...
                var o, r, a, l, h, c;
                if (null == e) return !1;
                for (o in R[e._gsTweenID] && V(), this.vars.css || e.style && e !== t && e.nodeType && H.css && !1 !== this.vars.autoCSS && function(t, e) {
                        var i, n = {};
                ...
                } else i[o] = j.call(this, e, o, "get", c, o, 0, null, this.vars.stringFilter);
                return s && this._kill(s, e) ? this._initProps(e, i, n, s) : this._overwrite > 1 && this._firstPT && n.length > 1 && Q(e, this, i, this._overwrite, n) ? (this._kill(i, e), this._initProps(e, i, n, s)) : (this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration) && (R[e._gsTweenID] = !0), a)
            }, o.render = function(t, e, i) {
                var n, s, o, r, a = this._time,
                    l = this._duration,
                    h = this._rawPrevTime;
                if (t >= l - 1e-7) this._totalTime = this._time = l, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (n = !0, s = "onComplete", i = i || this._timeline.autoRemoveChildren), 0 === l && (this._initted || !this.vars.lazy || i) && (this._startTime === this._timeline._duration && (t = 0), (0 > h || 0 >= t && t >= -1e-7 || h === c && "isPause" !== this.data) && h !== t && (i = !0, h > c && (s = "onReverseComplete")), this._rawPrevTime = r = !e || t || h === t ? t : c);
                    ...
                    var p = t / l,
                        u = this._easeType,
                        d = this._easePower;
                    (1 === u || 3 === u && p >= .5) && (p = 1 - p), 3 === u && (p *= 2), 1 === d ? p *= p : 2 === d ? p *= p * p : 3 === d ? p *= p * p * p : 4 === d && (p *= p * p * p * p), this.ratio = 1 === u ? 1 - p : 2 === u ? p : .5 > t / l ? p / 2 : 1 - p / 2
                } else this.ratio = this._ease.getRatio(t / l);
                if (this._time !== a || i) {
                    if (!this._initted) {
                        if (this._init(), !this._initted || this._gc) return;
                        if (!i && this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration)) return this._time = this._totalTime = a, this._rawPrevTime = h, A.push(this), void(this._lazy = [t, e]);
                ...
                var n, s, o, r, a, l, h, c, p, u = i && this._time && i._startTime === this._startTime && this._timeline === i._timeline;
                if ((d(e) || z(e)) && "number" != typeof e[0])
                    ...
                    if (a) {
                        if (h = t || a, c = t !== s && "all" !== s && t !== a && ("object" != typeof t || !t._tempKill), i && (M.onOverwrite || this.vars.onOverwrite)) {
                            for (o in h) a[o] && (p || (p = []), p.push(o));
                            if ((p || !t) && !Z(this, i, e, p)) return !1
                        }
                        for (o in h)(r = a[o]) && (u && (r.f ? r.t[r.p](r.s) : r.t[r.p] = r.s, l = !0), r.pg && r.t._kill(h) && (l = !0), r.pg && 0 !== r.t._overwriteProps.length || (r._prev ? r._prev._next = r._next : r === this._firstPT && (this._firstPT = r._next), r._next && (r._next._prev = r._prev), r._next = r._prev = null), delete a[o]), c && (s[o] = 1);
                ...
                if (null == t) return [];
                var i, n, s, o;
                if (t = "string" != typeof t ? t : M.selector(t) || t, (d(t) || z(t)) && "number" != typeof t[0]) {
            ...
            if (o = J.prototype, J.version = "1.18.0", J.API = 2, o._firstPT = null, o._addTween = j, o.setRatio = $, o._kill = function(t) {
                    ...
                    for (var e = t.length; --e > -1;) t[e].API === J.API && (H[(new t[e])._propName] = t[e]);
                    return !0
                }, g.plugin = function(t) {
    ...
    function(t, e) {
        function i(i) {
            if (void 0 === i) throw new Error('Pathformer [constructor]: "element" parameter is required');
            if (i.constructor === String && !(i = e.getElementById(i))) throw new Error('Pathformer [constructor]: "element" parameter is not related to an existing ID');
        ...
        i.prototype.TYPES = ["line", "ellipse", "circle", "polygon", "polyline", "rect"], i.prototype.ATTR_WATCH = ["cx", "cy", "points", "r", "rx", "ry", "x", "x1", "x2", "y", "y1", "y2"], i.prototype.scan = function(t) {
            for (var e, i, n, s = t.querySelectorAll(this.TYPES.join(",")), o = 0; o < s.length; o++) i = (0, this[(e = s[o]).tagName.toLowerCase() + "ToPath"])(this.parseAttr(e.attributes)), n = this.pathMaker(e, i), e.parentNode.replaceChild(n, e)
            ...
            return e.d = "M" + i + " " + n + " ", e.d += "L" + (i + s) + " " + n + " ", e.d += "L" + (i + s) + " " + (n + o) + " ", e.d += "L" + i + " " + (n + o) + " Z", e
        }, i.prototype.polylineToPath = function(t) {
            var e, i, n = {},
                s = t.points.trim().split(" ");
            if (-1 === t.points.indexOf(",")) {
                var o = [];
                for (e = 0; e < s.length; e += 2) o.push(s[e] + "," + s[e + 1]);
                s = o
            }
            for (i = "M" + s[0], e = 1; e < s.length; e++) - 1 !== s[e].indexOf(",") && (i += "L" + s[e]);
            return n.d = i, n
            ...
            var e = {},
                ...
                h = o;
            return e.d = "M" + r + "," + a + "A" + i + "," + n + " 0,1,1 " + l + "," + h + "A" + i + "," + n + " 0,1,1 " + r + "," + h, e
            ...
            var e = {},
                ...
                l = s;
            return e.d = "M" + o + "," + r + "A" + i + "," + i + " 0,1,1 " + a + "," + l + "A" + i + "," + i + " 0,1,1 " + o + "," + l, e
        }, i.prototype.pathMaker = function(t, i) {
            var n, s, o = e.createElementNS("http://www.w3.org/2000/svg", "path");
            for (n = 0; n < t.attributes.length; n++) s = t.attributes[n], -1 === this.ATTR_WATCH.indexOf(s.name) && o.setAttribute(s.name, s.value);
            for (n in i) o.setAttribute(n, i[n]);
            return o
            ...
            var e = 1 - Math.cos(.5 * t * Math.PI),
                i = Math.pow(e, 1.5),
                n = Math.pow(1 - t, 2);
            return 1 - n + (1 - Math.abs(Math.cos(2.5 * i * Math.PI))) * n
        }, n.prototype.setElement = function(i, n) {
            if (void 0 === i) throw new Error('Vivus [constructor]: "element" parameter is required');
            if (i.constructor === String && !(i = e.getElementById(i))) throw new Error('Vivus [constructor]: "element" parameter is not related to an existing ID');
            if (this.parentEl = i, n && n.file) {
                var s = e.createElement("object");
                s.setAttribute("type", "image/svg+xml"), s.setAttribute("data", n.file), s.setAttribute("built-by-vivus", "true"), i.appendChild(s), i = s
            }
            ...
            var i = ["delayed", "sync", "async", "nsync", "oneByOne", "scenario", "scenario-sync"],
                s = ["inViewport", "manual", "autostart"];
            if (void 0 !== e && e.constructor !== Object) throw new Error('Vivus [constructor]: "options" parameter must be an object');
            if ((e = e || {}).type && -1 === i.indexOf(e.type)) throw new Error("Vivus [constructor]: " + e.type + " is not an existing animation `type`");
            if (this.type = e.type || i[0], e.start && -1 === s.indexOf(e.start)) throw new Error("Vivus [constructor]: " + e.start + " is not an existing `start` option");
            if (this.start = e.start || s[0], this.isIE = -1 !== t.navigator.userAgent.indexOf("MSIE") || -1 !== t.navigator.userAgent.indexOf("Trident/") || -1 !== t.navigator.userAgent.indexOf("Edge/"), this.duration = r(e.duration, 120), this.delay = r(e.delay, null), this.dashGap = r(e.dashGap, 1), this.forceRender = e.hasOwnProperty("forceRender") ? !!e.forceRender : this.isIE, this.reverseStack = !!e.reverseStack, this.selfDestroy = !!e.selfDestroy, this.onReady = e.onReady, this.map = [], this.frameLength = this.currentFrame = this.delayUnit = this.speed = this.handle = null, this.ignoreInvisible = !!e.hasOwnProperty("ignoreInvisible") && !!e.ignoreInvisible, this.animTimingFunction = e.animTimingFunction || n.LINEAR, this.pathTimingFunction = e.pathTimingFunction || n.LINEAR, this.delay >= this.duration) throw new Error("Vivus [constructor]: delay must be shorter than duration")
        }, n.prototype.setCallback = function(t) {
            if (t && t.constructor !== Function) throw new Error('Vivus [constructor]: "callback" parameter must be a function');
            this.callback = t || function() {}
        }, n.prototype.mapping = function() {
            var e, i, n, s, o, a, l, h;
            for (h = a = l = 0, i = this.el.querySelectorAll("path"), e = 0; e < i.length; e++) n = i[e], this.isInvisible(n) || (o = {
                el: n,
                length: Math.ceil(n.getTotalLength())
            }, isNaN(o.length) ? t.console && console.warn && console.warn("Vivus [mapping]: cannot retrieve a path element length", n) : (this.map.push(o), n.style.strokeDasharray = o.length + " " + (o.length + 2 * this.dashGap), n.style.strokeDashoffset = o.length + this.dashGap, o.length += this.dashGap, a += o.length, this.renderPath(e)));
            for (a = 0 === a ? 1 : a, this.delay = null === this.delay ? this.duration / 3 : this.delay, this.delayUnit = this.delay / (i.length > 1 ? i.length - 1 : 1), this.reverseStack && this.map.reverse(), e = 0; e < this.map.length; e++) {
                switch (o = this.map[e], this.type) {
                    case "delayed":
                        ...
                        break;
                    case "oneByOne":
                        o.startAt = l / a * this.duration, o.duration = o.length / a * this.duration;
                        break;
                    case "sync":
                    case "async":
                    case "nsync":
                        ...
                        break;
                    case "scenario-sync":
                        n = o.el, s = this.parseAttr(n), o.startAt = h + (r(s["data-delay"], this.delayUnit) || 0), o.duration = r(s["data-duration"], this.duration), h = void 0 !== s["data-async"] ? o.startAt : o.startAt + o.duration, this.frameLength = Math.max(this.frameLength, o.startAt + o.duration);
                        break;
                    case "scenario":
                        n = o.el, s = this.parseAttr(n), o.startAt = r(s["data-start"], this.delayUnit) || 0, o.duration = r(s["data-duration"], this.duration), this.frameLength = Math.max(this.frameLength, o.startAt + o.duration)
                }
                l += o.length, this.frameLength = this.frameLength || this.duration
            }
            ...
            var t, e, i, n;
            for (n = this.animTimingFunction(this.currentFrame / this.frameLength) * this.frameLength, t = 0; t < this.map.length; t++) e = (n - (i = this.map[t]).startAt) / i.duration, e = this.pathTimingFunction(Math.max(0, Math.min(1, e))), i.progress !== e && (i.progress = e, i.el.style.strokeDashoffset = Math.floor(i.length * (1 - e)), this.renderPath(t))
        ...
        }, s = t.requestAnimationFrame || t.webkitRequestAnimationFrame || t.mozRequestAnimationFrame || t.oRequestAnimationFrame || t.msRequestAnimationFrame || function(e) {
            return t.setTimeout(e, 1e3 / 60)
        }, o = t.cancelAnimationFrame || t.webkitCancelAnimationFrame || t.mozCancelAnimationFrame || t.oCancelAnimationFrame || t.msCancelAnimationFrame || function(e) {
    ...
    function(t, e) {
        ...
        function e(e) {
            this.VERSION = "0.2.10", this.loaded = !1, this.markers = [], this.circles = [], this.oMap = !1, this.view_all_key = "all", this.infowindow = null, this.maxZIndex = 0, this.ln = 0, this.oMap = !1, this.oBounds = null, this.map_div = null, this.canvas_map = null, this.controls_wrapper = null, this.current_control = null, this.current_index = null, this.Polyline = null, this.Polygon = null, this.Fusion = null, this.directionsService = null, this.directionsDisplay = null, this.o = {
                ...
                beforeShow: function(t, e, i) {},
                afterShow: function(t, e, i) {},
                afterCreateMarker: function(t, e, i) {},
                beforeCloseInfowindow: function(t, e) {},
                afterCloseInfowindow: function(t, e) {},
                beforeOpenInfowindow: function(t, e, i) {},
                afterOpenInfowindow: function(t, e, i) {},
                afterRoute: function(t, e, i) {},
                onPolylineClick: function(t) {},
                onPolygonClick: function(t) {},
                circleRadiusChanged: function(t, e, i) {},
                circleCenterChanged: function(t, e, i) {},
                drag: function(t, e, i) {},
                dragEnd: function(t, e, i) {},
                dragStart: function(t, e, i) {}
            }, this.AddControl("dropdown", i), this.AddControl("list", n), e && "directions" === e.type && (!e.show_markers && (e.show_markers = !1), !e.show_infowindows && (e.show_infowindows = !1)), t.extend(!0, this.o, e)
        }
        var i, n;
        return i = {
            ...
            getHtml: function() {
                var e, i, n = this,
                    s = "";
                if (this.ln > 1) {
                    for (s += '<select class="dropdown controls ' + this.o.controls_cssclass + '">', this.ShowOnMenu(this.view_all_key) && (s += '<option value="' + this.view_all_key + '">' + this.o.view_all_text + "</option>"), i = 0; i < this.ln; i += 1) this.ShowOnMenu(i) && (s += '<option value="' + (i + 1) + '">' + (this.o.locations[i].title || "#" + (i + 1)) + "</option>");
                    s = t(s += "</select>").bind("change", function() {
                        n.ViewOnMap(this.value)
                    })
                }
                return e = this.o.controls_title, this.o.controls_title && (e = t('<div class="controls_title"></div>').css(this.o.controls_applycss ? {
                    fontWeight: "bold",
                    fontSize: this.o.controls_on_map ? "12px" : "inherit",
                    padding: "3px 10px 5px 0"
                } : {}).append(this.o.controls_title)), this.html_element = t('<div class="wrap_controls"></div>').append(e).append(s), this.html_element
            }
        }, n = {
            html_a: function(e, i, n) {
                var s = this,
                    o = i || e + 1,
                    r = n || this.o.locations[e].title,
                    a = t('<a data-load="' + o + '" id="ullist_a_' + o + '" href="#' + o + '" title="' + r + '"><span>' + (r || "#" + (e + 1)) + "</span></a>");
            ...
            getHtml: function() {
                var e, i, s = t("<ul class='ullist controls " + this.o.controls_cssclass + "'></ul>").css(this.o.controls_applycss ? {
                    margin: 0,
                    padding: 0,
                    listStyleType: "none"
                } : {});
                for (this.ShowOnMenu(this.view_all_key) && s.append(t("<li></li>").append(n.html_a.call(this, !1, this.view_all_key, this.o.view_all_text))), i = 0; i < this.ln; i++) this.ShowOnMenu(i) && s.append(t("<li></li>").append(n.html_a.call(this, i)));
                return e = this.o.controls_title, this.o.controls_title && (e = t('<div class="controls_title"></div>').css(this.o.controls_applycss ? {
                    fontWeight: "bold",
                    padding: "3px 10px 5px 0",
                    fontSize: this.o.controls_on_map ? "12px" : "inherit"
        ...
        }, e.prototype.controls = {}, e.prototype.create_objMap = function() {
            var e, i = 0;
            ...
            for (e in i = 0, this.o.styles) this.o.styles.hasOwnProperty(e) && (i++, this.oMap.mapTypes.set("map_style_" + i, new google.maps.StyledMapType(this.o.styles[e], {
                name: e
            })), this.oMap.setMapTypeId("map_style_" + i))
        }, e.prototype.add_markers_to_objMap = function() {
            var t, e, i = this.o.type || "marker";
            switch (i) {
                case "marker":
            ...
            var i = t.extend({}, this.o.locations[e]),
                n = void 0 === i.visible ? void 0 : i.visible;
            return !i.type && (i.type = this.o.type), i.map = this.oMap, i.position = new google.maps.LatLng(i.lat, i.lon), i.zIndex = void 0 === i.zIndex ? 1e4 : i.zIndex + 100, i.visible = void 0 === n ? this.o.show_markers : n, this.o.maxZIndex = i.zIndex > this.maxZIndex ? i.zIndex : this.maxZIndex, i.image && (i.icon = new google.maps.MarkerImage(i.image, new google.maps.Size(i.image_w || 32, i.image_h || 32), new google.maps.Point(0, 0), new google.maps.Point((i.image_w || 32) / 2, (i.image_h || 32) / 2))), i
        }, e.prototype.create_objCircle = function(e) {
            var i, n, s;
            return s = t.extend({}, e), i = t.extend({}, this.o.stroke_options), n = t.extend({}, this.o.circle_options), t.extend(i, e.stroke_options || {}), t.extend(s, i), t.extend(n, e.circle_options || {}), t.extend(s, n), s.center = e.position, s.draggable = !1, s.zIndex = e.zIndex > 0 ? e.zIndex - 10 : 1, s
        }, e.prototype.add_markerEv = function(t, e, i) {
            var n = this;
            google.maps.event.addListener(i, "click", function(s) {
                n.CloseInfoWindow(), n.o.beforeShow.call(n, t, e, i), n.o.show_infowindows && !1 !== e.show_infowindow && n.open_infowindow(t, i, s), n.o.pan_on_click && !1 !== e.pan_on_click && (n.oMap.panTo(e.position), e.zoom && n.oMap.setZoom(e.zoom)), n.current_control && n.o.generate_controls && n.current_control.activateCurrent && n.current_control.activateCurrent.call(n, t + 1), n.current_index = t, n.o.afterShow.call(n, t, e, i)
            ...
            google.maps.event.addListener(i, "click", function() {
                ...
                n.o.circleCenterChanged.call(n, t, e, i)
            }), google.maps.event.addListener(i, "radius_changed", function() {
                n.o.circleRadiusChanged.call(n, t, e, i)
            }), e.draggable && this.add_dragEv(t, e, i)
        }, e.prototype.add_dragEv = function(t, e, i) {
            var n = this;
            google.maps.event.addListener(i, "drag", function(s) {
                var o, r;
                if (i.getPosition) o = i.getPosition();
                else {
                    if (!i.getCenter) return;
                    o = i.getCenter()
                }
                if (n.circles[t] && n.circles[t].setCenter(o), n.Polyline ? r = "Polyline" : n.Polygon && (r = "Polygon"), r) {
                    for (var a = n[r].getPath().getArray(), l = [], h = 0; h < a.length; ++h) l[h] = t === h ? new google.maps.LatLng(o.lat(), o.lng()) : new google.maps.LatLng(a[h].lat(), a[h].lng());
                    n[r].setPath(new google.maps.MVCArray(l)), n.add_polyEv(r)
                }
                n.o.drag.call(n, t, e, i)
            }), google.maps.event.addListener(i, "dragend", function() {
                n.o.dragEnd.call(n, t, e, i)
            }), google.maps.event.addListener(i, "dragstart", function() {
                n.o.dragStart.call(n, t, e, i)
            }), google.maps.event.addListener(i, "center_changed", function() {
                n.markers[t] && i.getCenter && n.markers[t].setPosition(i.getCenter()), n.o.drag.call(n, t, e, i)
            })
        }, e.prototype.add_polyEv = function(t) {
            var e = this;
            google.maps.event.addListener(this[t].getPath(), "set_at", function(i, n) {
                e.trigger_polyEv(t, i, n)
            }), google.maps.event.addListener(this[t].getPath(), "insert_at", function(i, n) {
                e.trigger_polyEv(t, i, n)
            })
        }, e.prototype.trigger_polyEv = function(t, e, i) {
            var n = this[t].getPath().getAt(e),
                s = new google.maps.LatLng(n.lat(), n.lng());
            this.markers[e] && this.markers[e].setPosition(s), this.circles[e] && this.circles[e].setCenter(s), this.o["on" + t + "Changed"](e, i, this[t].getPath().getArray())
        }, e.prototype.create = {
            marker: function(t, e, i) {
                if ("circle" === e.type && !i) {
                    var n = this.create_objCircle(e);
                    e.visible || (n.draggable = e.draggable), i = new google.maps.Circle(n), this.add_circleEv(t, n, i), this.circles[t] = i
                }
                return e.type = "marker", i = new google.maps.Marker(e), this.add_markerEv(t, e, i), this.oBounds.extend(e.position), this.markers[t] = i, this.o.afterCreateMarker.call(this, t, e, i), i
            },
            circle: function() {
                var t, e, i, n;
                for (t = 0; t < this.ln; t++) "circle" === (e = this.create_objPoint(t)).type && (i = this.create_objCircle(e), e.visible || (i.draggable = e.draggable), n = new google.maps.Circle(i), this.add_circleEv(t, i, n), this.circles[t] = n), e.type = "marker", this.create.marker.call(this, t, e, n)
            },
            polyline: function() {
            ...
            polygon: function() {
                ...
                this.Polygon ? this.Polygon.setOptions(s) : this.Polygon = new google.maps.Polygon(s), google.maps.event.addListener(this.Polygon, "click", function(t) {
                    n.o.onPolygonClick.call(n, t)
            ...
            directions: function() {
                var e, i, n, s, o, r = this,
                    a = [],
                    l = 0;
                for (e = 0; e < this.ln; e++) i = this.create_objPoint(e), 0 === e ? s = i.position : e === this.ln - 1 ? o = i.position : (n = !0 === this.o.locations[e].stopover, a.push({
                    location: i.position,
                    stopover: n
                })), this.create.marker.call(this, e, i);
                this.o.directions_options.origin = s, this.o.directions_options.destination = o, this.o.directions_options.waypoints = a, this.directionsService || (this.directionsService = new google.maps.DirectionsService), this.directionsDisplay ? this.directionsDisplay.setOptions({
                    draggable: this.o.draggable
                }) : this.directionsDisplay = new google.maps.DirectionsRenderer({
                    draggable: this.o.draggable
                }), this.directionsDisplay.setMap(this.oMap), this.o.directions_panel && (this.o.directions_panel = t(this.o.directions_panel), this.directionsDisplay.setPanel(this.o.directions_panel.get(0))), this.o.draggable && google.maps.event.addListener(this.directionsDisplay, "directions_changed", function() {
                    var t = r.directionsDisplay.getDirections();
                    l = r.compute_distance(r.directionsDisplay.directions), r.o.afterRoute.call(r, l, t.status, t)
                }), this.directionsService.route(this.o.directions_options, function(t, e) {
                    e === google.maps.DirectionsStatus.OK && (l = r.compute_distance(t), r.directionsDisplay.setDirections(t)), r.o.afterRoute.call(r, l, e, t)
                })
            }
            ...
            var e, i = 0,
                n = t.routes[0],
                s = n.legs.length;
            for (e = 0; e < s; e++) i += n.legs[e].distance.value;
            return i
            ...
            bubble: function(t) {
                ...
                t.infoWindowMaxWidth && (i.maxWidth = t.infoWindowMaxWidth), this.infowindow = new google.maps.InfoWindow(i), google.maps.event.addListener(this.infowindow, "closeclick", function() {
                    e.CloseInfoWindow()
                })
            }
        }, e.prototype.open_infowindow = function(t, e, i) {
            var n = this.o.locations[t],
                s = this.o.infowindow_type;
            n.html && this.type_to_open[s] && (this.o.beforeOpenInfowindow.call(this, t, n, e), this.type_to_open[s].call(this, n), this.infowindow.open(this.oMap, e), this.o.afterOpenInfowindow.call(this, t, n, e))
            ...
            var e = t('<div class="on_gmap ' + this.o.controls_type + ' gmap_controls"></div>').css(this.o.controls_applycss ? {
                ...
                i = t(this.get_html_controls()).css(this.o.controls_applycss ? {
                    background: "#fff",
                    padding: "5px",
            ...
            e.append(i), this.oMap.controls[this.o.controls_position].clear(), this.oMap.controls[this.o.controls_position].push(e.get(0))
            ...
            for (var e = this.markers.length - 1; e >= 0; e -= 1) try {
                this.markers[e] && this.markers[e].setMap(null)
            } catch (e) {
                t.debug("init_map::markers::setMap", e.stack)
            }
            this.markers.length = 0, this.markers = [];
            for (var i = this.circles.length - 1; i >= 0; i -= 1) try {
                this.circles[i] && this.circles[i].setMap(null)
            } catch (e) {
                t.debug("init_map::circles::setMap", e.stack)
            }
            this.circles.length = 0, this.circles = [], this.o.controls_on_map && this.oMap.controls && this.oMap.controls[this.o.controls_position].forEach(function(e, i) {
                try {
                    t.oMap.controls[this.o.controls_position].removeAt(i)
                } catch (e) {
            ...
            if (t === this.view_all_key && this.o.view_all && this.ln > 1) return !0;
            if ("number" == typeof((t = parseInt(t, 10)) - 0) && t >= 0 && t < this.ln && !1 !== this.o.locations[t].on_menu) return !0;
            return !1
        }, e.prototype.ViewOnMap = function(t) {
            if (t === this.view_all_key) this.o.beforeViewAll.call(this), this.current_index = t, this.o.locations.length > 0 && this.o.generate_controls && this.current_control && this.current_control.activateCurrent && this.current_control.activateCurrent.apply(this, [t]), this.oMap.fitBounds(this.oBounds), this.o.afterViewAll.call(this);
            else if ("number" == typeof((t = parseInt(t, 10)) - 0) && t > 0 && t <= this.ln) try {
        ...
        }, e.prototype.AddLocations = function(e, i) {
            var n = this;
            return t.isArray(e) && t.each(e, function(t, e) {
                n.o.locations.push(e)
            }), t.isPlainObject(e) && this.o.locations.push(e), i && this.Load(), this
        }, e.prototype.AddLocation = function(e, i, n) {
            return t.isPlainObject(e) && this.o.locations.splice(i, 0, e), n && this.Load(), this
        }, e.prototype.RemoveLocations = function(e, i) {
            var n = this,
                s = 0;
            return t.isArray(e) ? t.each(e, function(t, e) {
                e - s < n.ln && n.o.locations.splice(e - s, 1), s++
            }) : e < this.ln && this.o.locations.splice(e, 1), i && this.Load(), this
        }, e.prototype.Loaded = function() {
            return this.loaded
        }, e.prototype._init = function() {
            this.ln = this.o.locations.length;
            for (var e = 0; e < this.ln; e++) {
                var i = t.extend({}, this.o.shared);
                this.o.locations[e] = t.extend(i, this.o.locations[e]), this.o.locations[e].html && (this.o.locations[e].html = this.o.locations[e].html.replace("%index", e + 1), this.o.locations[e].html = this.o.locations[e].html.replace("%title", this.o.locations[e].title || ""))
            }
            return this.map_div = t(this.o.map_div), this.controls_wrapper = t(this.o.controls_div), this
        }, e.prototype.Load = function(e) {
            t.extend(!0, this.o, e), e && e.locations && (this.o.locations = e.locations), this._init(), !1 === this.o.visualRefresh ? google.maps.visualRefresh = !1 : google.maps.visualRefresh = !0, this.init_map(), this.create_objMap(), this.add_markers_to_objMap(), this.ln > 1 && this.o.generate_controls || this.o.force_generate_controls ? (this.o.generate_controls = !0, this.generate_controls()) : this.o.generate_controls = !1;
            var i = this;
            if (this.loaded) this.perform_load();
            else
                for (var n in google.maps.event.addListenerOnce(this.oMap, "idle", function() {
                        i.perform_load()
                    }), this.o.listeners) this.o.listeners.hasOwnProperty(n) && google.maps.event.addListener(this.oMap, n, this.o.listeners[n]);
    ...
    function(t, e, i) {
        function n(i, n, s) {
            ...
            return n && (o.id = K + n), s && (o.style.cssText = s), t(o)
        }
        ...
        function o(e, i) {
            i !== Object(i) && (i = {}), this.cache = {}, this.el = e, this.value = function(e) {
                var n;
                return void 0 === this.cache[e] && (void 0 !== (n = t(this.el).attr("data-cbox-" + e)) ? this.cache[e] = n : void 0 !== i[e] ? this.cache[e] = i[e] : void 0 !== Z[e] && (this.cache[e] = Z[e])), this.cache[e]
            }, this.get = function(e) {
                var i = this.value(e);
        ...
        function a(t, e) {
            return Math.round((/%/.test(t) ? ("x" === e ? C.width() : s()) / 100 : 1) * parseInt(t, 10))
        }
        ...
        function p(t) {
            p.str !== t && (y.add(v).removeClass(p.str).addClass(t), p.str = t)
        }
        ...
        function d(i) {
            var s;
            if (!Y) {
                if (s = t(i).data(Q), function(e) {
                        B = 0, e && !1 !== e && "nofollow" !== e ? (k = t("." + J).filter(function() {
                            return new o(this, t.data(this, Q)).get("rel") === e
                        }), -1 === (B = k.index(D.el)) && (k = k.add(D.el), B = k.length - 1)) : k = t(D.el)
                    }((D = new o(i, s)).get("rel")), !q) {
                    q = X = !0, p(D.get("className")), y.css({
                        visibility: "hidden",
                        display: "block",
                        opacity: ""
                    }), P = n(at, "LoadedContent", "width:0; height:0; overflow:hidden; visibility:hidden"), w.css({
                        width: "",
                        height: ""
                    }).append(P), j = x.height() + S.height() + w.outerHeight(!0) - w.height(), F = b.width() + T.width() + w.outerWidth(!0) - w.width(), H = P.outerHeight(!0), N = P.outerWidth(!0);
                    var r = a(D.get("initialWidth"), "x"),
                        l = a(D.get("initialHeight"), "y"),
                        h = D.get("maxWidth"),
                        d = D.get("maxHeight");
                    D.w = Math.max((!1 !== h ? Math.min(r, a(h, "x")) : r) - N - F, 0), D.h = Math.max((!1 !== d ? Math.min(l, a(d, "y")) : l) - H - j, 0), P.css({
                        width: "",
                        height: D.h
                    }), V.position(), u(tt), D.get("onOpen"), $.add(I).hide(), y.focus(), D.get("trapFocus") && e.addEventListener && (e.addEventListener("focus", c, !0), rt.one(st, function() {
                ...
                v.css({
                    ...
                    visibility: "visible"
                }).show(), D.get("closeButton") ? L.html(D.get("close")).appendTo(w) : L.appendTo("<div/>"), g()
            }
        }

        function f() {
            y || (G = !1, C = t(i), y = n(at).attr({
                id: Q,
                class: !1 === t.support.opacity ? K + "IE" : "",
                role: "dialog",
                tabindex: "-1"
            }).hide(), v = n(at, "Overlay").hide(), O = t([n(at, "LoadingOverlay")[0], n(at, "LoadingGraphic")[0]]), _ = n(at, "Wrapper"), w = n(at, "Content").append(I = n(at, "Title"), M = n(at, "Current"), R = t('<button type="button"/>').attr({
                id: K + "Previous"
            }), A = t('<button type="button"/>').attr({
                id: K + "Next"
            }), z = t('<button type="button"/>').attr({
                id: K + "Slideshow"
            }), O), L = t('<button type="button"/>').attr({
                id: K + "Close"
            }), _.append(n(at).append(n(at, "TopLeft"), x = n(at, "TopCenter"), n(at, "TopRight")), n(at, !1, "clear:left").append(b = n(at, "MiddleLeft"), w, T = n(at, "MiddleRight")), n(at, !1, "clear:left").append(n(at, "BottomLeft"), S = n(at, "BottomCenter"), n(at, "BottomRight"))).find("div div").css({
                float: "left"
            }), E = n(at, !1, "position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"), $ = A.add(R).add(M).add(z)), e.body && !y.parent().length && t(e.body).append(v, y.append(_, E))
        }

        function m() {
            function i(t) {
                t.which > 1 || t.shiftKey || t.altKey || t.metaKey || t.ctrlKey || (t.preventDefault(), d(this))
            }
            return !!y && (G || (G = !0, A.click(function() {
                V.next()
            }), R.click(function() {
                V.prev()
            }), L.click(function() {
                ...
                D.get("overlayClose") && V.close()
            }), t(e).bind("keydown." + K, function(t) {
                var e = t.keyCode;
                q && D.get("escKey") && 27 === e && (t.preventDefault(), V.close()), q && D.get("arrowKey") && k[1] && !t.altKey && (37 === e ? (t.preventDefault(), R.click()) : 39 === e && (t.preventDefault(), A.click()))
            }), t.isFunction(t.fn.on) ? t(e).on("click." + K, "." + J, i) : t("." + J).live("click." + K, i)), !0)
        }

        function g() {
            var e, s, o, r = V.prep,
                c = ++lt;
            if (X = !0, W = !1, u(ot), u(et), D.get("onLoad"), D.h = D.get("height") ? a(D.get("height"), "y") - H - j : D.get("innerHeight") && a(D.get("innerHeight"), "y"), D.w = D.get("width") ? a(D.get("width"), "x") - N - F : D.get("innerWidth") && a(D.get("innerWidth"), "x"), D.mw = D.w, D.mh = D.h, D.get("maxWidth") && (D.mw = a(D.get("maxWidth"), "x") - N - F, D.mw = D.w && D.w < D.mw ? D.w : D.mw), D.get("maxHeight") && (D.mh = a(D.get("maxHeight"), "y") - H - j, D.mh = D.h && D.h < D.mh ? D.h : D.mh), e = D.get("href"), U = setTimeout(function() {
                    O.show()
                }, 100), D.get("inline")) {
                var p = t(e).eq(0);
                o = t("<div>").hide().insertBefore(p), rt.one(ot, function() {
                    o.replaceWith(p)
                }), r(p)
            } else D.get("iframe") ? r(" ") : D.get("html") ? r(D.get("html")) : l(D, e) ? (e = h(D, e), W = D.get("createImg"), t(W).addClass(K + "Photo").bind("error." + K, function() {
                r(n(at, "Error").html(D.get("imgError")))
            }).one("load", function() {
                c === lt && setTimeout(function() {
                    var e;
                    D.get("retinaImage") && i.devicePixelRatio > 1 && (W.height = W.height / i.devicePixelRatio, W.width = W.width / i.devicePixelRatio), D.get("scalePhotos") && (s = function() {
                        W.height -= W.height * e, W.width -= W.width * e
                    }, D.mw && W.width > D.mw && (e = (W.width - D.mw) / W.width, s()), D.mh && W.height > D.mh && (e = (W.height - D.mh) / W.height, s())), D.h && (W.style.marginTop = Math.max(D.mh - W.height, 0) / 2 + "px"), k[1] && (D.get("loop") || k[B + 1]) && (W.style.cursor = "pointer", t(W).bind("click." + K, function() {
                        V.next()
                    })), W.style.width = W.width + "px", W.style.height = W.height + "px", r(W)
                }, 1)
            }), W.src = e) : e && E.load(e, D.get("data"), function(e, i) {
                c === lt && r("error" === i ? n(at, "Error").html(D.get("xhrError")) : t(this).contents())
            })
        }
        var v, y, _, w, x, b, T, S, k, C, P, E, O, I, M, z, A, R, L, $, D, j, F, H, N, B, W, q, X, Y, U, V, G, Z = {
                html: !1,
                photo: !1,
                iframe: !1,
                inline: !1,
            ...
            ct = function() {
                ...
                function e() {
                    (D.get("loop") || k[B + 1]) && (t(), r = setTimeout(V.next, D.get("slideshowSpeed")))
                }

                function i() {
                    z.html(D.get("slideshowStop")).unbind(l).one(l, n), rt.bind(it, e).bind(et, t), y.removeClass(a + "off").addClass(a + "on")
                }

                function n() {
                    t(), rt.unbind(it, e).unbind(et, t), z.html(D.get("slideshowStart")).unbind(l).one(l, function() {
                        V.next(), i()
                    }), y.removeClass(a + "on").addClass(a + "off")
                }

                function s() {
                    o = !1, z.hide(), t(), rt.unbind(it, e).unbind(et, t), y.removeClass(a + "off " + a + "on")
                }
                var o, r, a = K + "Slideshow_",
                    l = "click." + K;
                return function() {
                    o ? D.get("slideshow") || (rt.unbind(nt, s), s()) : D.get("slideshow") && k[1] && (o = !0, rt.one(nt, s), D.get("slideshowAuto") ? i() : n(), z.show())
                }
            }();
        t[Q] || (t(f), (V = t.fn[Q] = t[Q] = function(e, i) {
            var n = this;
            return e = e || {}, t.isFunction(n) && (n = t("<a/>"), e.open = !0), n[0] ? (f(), m() && (i && (e.onComplete = i), n.each(function() {
                var i = t.data(this, Q) || {};
                t.data(this, Q, t.extend(i, e))
            }).addClass(J), new o(n[0], e).get("open") && d(n[0])), n) : n
        }).position = function(e, i) {
            function n() {
                x[0].style.width = S[0].style.width = w[0].style.width = parseInt(y[0].style.width, 10) - F + "px", w[0].style.height = b[0].style.height = T[0].style.height = parseInt(y[0].style.height, 10) - j + "px"
            }
            var o, r, l, h = 0,
                c = 0,
                p = y.offset();
            if (C.unbind("resize." + K), y.css({
                    top: -9e4,
                    left: -9e4
                }), r = C.scrollTop(), l = C.scrollLeft(), D.get("fixed") ? (p.top -= r, p.left -= l, y.css({
                    position: "fixed"
                })) : (h = r, c = l, y.css({
                    position: "absolute"
                })), c += !1 !== D.get("right") ? Math.max(C.width() - D.w - N - F - a(D.get("right"), "x"), 0) : !1 !== D.get("left") ? a(D.get("left"), "x") : Math.round(Math.max(C.width() - D.w - N - F, 0) / 2), h += !1 !== D.get("bottom") ? Math.max(s() - D.h - H - j - a(D.get("bottom"), "y"), 0) : !1 !== D.get("top") ? a(D.get("top"), "y") : Math.round(Math.max(s() - D.h - H - j, 0) / 2), y.css({
                    top: p.top,
                    left: p.left,
                    visibility: "visible"
                }), _[0].style.width = _[0].style.height = "9999px", o = {
                    width: D.w + N + F,
                    height: D.h + H + j,
                    top: h,
                    left: c
                ...
                var u = 0;
                t.each(o, function(t) {
                    return o[t] !== ht[t] ? void(u = e) : void 0
                }), e = u
            }
            ht = o, e || y.css(o), y.dequeue().animate(o, {
                duration: e || 0,
                complete: function() {
                    n(), X = !1, _[0].style.width = D.w + N + F + "px", _[0].style.height = D.h + H + j + "px", D.get("reposition") && setTimeout(function() {
                        C.bind("resize." + K, V.position)
                    }, 1), t.isFunction(i) && i()
                },
                step: n
            })
            ...
            var e;
            q && ((t = t || {}).width && (D.w = a(t.width, "x") - N - F), t.innerWidth && (D.w = a(t.innerWidth, "x")), P.css({
                width: D.w
            }), t.height && (D.h = a(t.height, "y") - H - j), t.innerHeight && (D.h = a(t.innerHeight, "y")), t.innerHeight || t.height || (e = P.scrollTop(), P.css({
                height: "auto"
            }), D.h = P.height()), P.css({
                height: D.h
            }), e && P.scrollTop(e), V.position("none" === D.get("transition") ? 0 : D.get("speed")))
        }, V.prep = function(i) {
            if (q) {
                var s, a = "none" === D.get("transition") ? 0 : D.get("speed");
                P.remove(), (P = n(at, "LoadedContent").append(i)).hide().appendTo(E.show()).css({
                    width: (D.w = D.w || P.width(), D.w = D.mw && D.mw < D.w ? D.mw : D.w, D.w),
                    overflow: D.get("scrolling") ? "auto" : "hidden"
                }).css({
                    height: (D.h = D.h || P.height(), D.h = D.mh && D.mh < D.h ? D.mh : D.h, D.h)
                }).prependTo(w), E.hide(), t(W).css({
                    float: "none"
                }), p(D.get("className")), s = function() {
                    function i() {
                        !1 === t.support.opacity && y[0].style.removeAttribute("filter")
                    }
                    var n, s, c = k.length;
                    q && (s = function() {
                        clearTimeout(U), O.hide(), u(it), D.get("onComplete")
                    }, I.html(D.get("title")).show(), P.show(), c > 1 ? ("string" == typeof D.get("current") && M.html(D.get("current").replace("{current}", B + 1).replace("{total}", c)).show(), A[D.get("loop") || c - 1 > B ? "show" : "hide"]().html(D.get("next")), R[D.get("loop") || B ? "show" : "hide"]().html(D.get("previous")), ct(), D.get("preloading") && t.each([r(-1), r(1)], function() {
                        var i = k[this],
                            n = new o(i, t.data(i, Q)),
                            s = n.get("href");
                        s && l(n, s) && (s = h(n, s), e.createElement("img").src = s)
                    })) : $.hide(), D.get("iframe") ? (n = D.get("createIframe"), D.get("scrolling") || (n.scrolling = "no"), t(n).attr({
                        src: D.get("href"),
                        class: K + "Iframe"
                    }).one("load", s).appendTo(P), rt.one(ot, function() {
                        n.src = "//about:blank"
                    }), D.get("fastIframe") && t(n).trigger("load")) : s(), "fade" === D.get("transition") ? y.fadeTo(a, 1, i) : i())
                }, "fade" === D.get("transition") ? y.fadeTo(a, 0, function() {
                    V.position(0, s)
                }) : V.position(a, s)
            }
        }, V.next = function() {
            !X && k[1] && (D.get("loop") || k[B + 1]) && (B = r(1), d(k[B]))
        }, V.prev = function() {
            !X && k[1] && (D.get("loop") || B) && (B = r(-1), d(k[B]))
        }, V.close = function() {
            q && !Y && (Y = !0, q = !1, u(nt), D.get("onCleanup"), C.unbind("." + K), v.fadeTo(D.get("fadeOut") || 0, 0), y.stop().fadeTo(D.get("fadeOut") || 0, 0, function() {
                y.hide(), v.hide(), u(ot), P.remove(), setTimeout(function() {
                    Y = !1, u(st), D.get("onClosed")
                }, 1)
            }))
        }, V.remove = function() {
            y && (y.stop(), t[Q].close(), y.stop(!1, !0).remove(), v.remove(), Y = !1, y = null, t("." + J).removeData(Q).removeClass(J), t(e).unbind("click." + K).unbind("keydown." + K))
        }, V.element = function() {
            return t(D.el)
        }, V.settings = Z)
