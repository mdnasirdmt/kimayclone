...
function gl_initVideoBackgrounds() {
    jQuery("[data-gl-video-bg]").each(function() {
        ...
        i.data("glVideoBg") ? (e = i.data("glVideoBg"), (t = glExtractYoutubeId(e)) && (i.find(".gl_video-bg").remove(), insertYoutubeVideoAsBackground(i, t)), jQuery(window).on("grid:items:added", function(e, t) {
            i.has(t).length && glResizeVideoBackground(i)
        })) : i.find(".gl_video-bg").remove()
    })
}
...
document.documentElement.className += " js_active ", document.documentElement.className += "ontouchstart" in document.documentElement ? " gl_mobile " : " gl_desktop ",
    function() {
        ...
        function t(e) {
            ...
            t.hasClass("gl_toggle_active") ? i.slideUp({
                duration: 300,
                complete: function() {
            ...
            t.each(function(e) {
                ...
                jQuery(this).find(".spb_tab").each(function() {
                    ...
                    if (e.preventDefault(), n) {
                        i = t.tabs("option", "selected");
                        jQuery(this).parent().hasClass("spb_next_slide") ? i++ : i--, 0 > i ? i = t.tabs("length") - 1 : i >= t.tabs("length") && (i = 0), t.tabs("select", i)
                    } else {
        ...
        function t() {
            var e = i(".gl_row-o-full-height:first");
            if (e.length) {
                var t, n, o;
                t = i(window).height(), (n = e.offset().top) < t && (o = 100 - n / (t / 100), e.css("min-height", o + "vh"))
            }
            i(document).trigger("gl-full-height-row", e)
        }
        var i = window.jQuery;
