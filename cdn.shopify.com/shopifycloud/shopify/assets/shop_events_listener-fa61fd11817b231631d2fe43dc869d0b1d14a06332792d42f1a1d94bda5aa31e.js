! function() {
    ...
    e(function(e, t) {
        ...
        function s(e, a) {
            if (e.length != a.length) throw Error("Payload body and response have different number of items");
            e.forEach(function(e, t) {
                var n = 1;
                try {
                    n = parseInt(a[t].quantity, 10) || 1
                } catch (r) {
                    console && console.warn && console.warn("[shop_events_listener] Error in handleBulkItemCartAddResponse: " + r.message)
                }
                l(e, n)
            })
        }
        ...
        function i(e, t) {
            ...
            var a = !0,
                ...
                i = undefined;
            try {
                for (var c, d = decodeURI(e).split("&")[Symbol.iterator](); !(a = (c = d.next()).done); a = !0) {
                    var s = c.value.split("="),
            ...
            return c(a, null, [{
                ...
                value: function r(o) {
                    try {
                        ...
                        a.ADD_TO_CART_REGEX.test(t) && a._parsePayloadResponse(o, function(e) {
                            var t = Object.keys(e);
        ...
        h.ADD_TO_CART_REGEX = /^(?:\/[a-zA-Z]+(?:\-[a-zA-Z]+)?)?\/cart\/add(?:\.js|\.json)?$/, t["default"] = h,
            function() {
                function r(e, t, n) {
                ...
                function a(e) {
                    if (!((e = e || window.event).defaultPrevented || e.isDefaultPrevented && e.isDefaultPrevented())) {
                        ...
                        if (t && (t.getAttribute("action") || t.getAttribute("href"))) try {
                            var n = t.id || t.elements.id,
                                r = d((n.options ? n.options[n.selectedIndex] : n).value);
                            r.quantity = String(t.quantity ? t.quantity.value : 1), window.ShopifyAnalytics.lib.track("Added Product", r);
                            var a = f({
                                referer: window.location.href
                            }, r);
                            window.ShopifyAnalytics.lib.track("monorail://trekkie_storefront_track_added_product/1.1", a)
                        } catch (o) {
                            console && console.warn && console.warn("[shop_events_listener] Error in handleSubmitCartAdd: " + o.message)
                        }
                    }
                }
                ...
                function c(e) {
                    try {
                        ...
                        var a = d(window.ShopifyAnalytics.meta.selectedVariantId = r);
                ...
                function n(e) {
                    ...
                    if (window.ShopifyAnalytics.meta.products) {
                        var a = s(e, window.ShopifyAnalytics.meta.products);
                        t = a.product, n = a.variant
                    } else window.ShopifyAnalytics.meta.product && (n = u(e, t = window.ShopifyAnalytics.meta.product));
                    return t ? (r = {
                        productId: t.id,
                        productGid: t.gid,
                        brand: t.vendor,
                ...
                r(window, "load", function() {
                    for (var e = 0; e < document.forms.length; e++) {
                        ...
                        t && 0 <= t.indexOf("/cart/add") && (r(document.forms[e], "submit", a), r(document.forms[e], "change", i), c(document.forms[e]));
