/* clarity-js v0.6.34: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    ...
    function O(t, e) {
        qa() && t && e && "string" == typeof t && "string" == typeof e && t.length < 255 && e.length < 255 && (E = {
            key: t,
            value: e
        }, Ur(24))
    }
    ...
    function _(t, e) {
        void 0 === e && (e = 1), t in N || (N[t] = 0), t in S || (S[t] = 0), N[t] += e, S[t] += e
    }

    function T(t, e) {
        null !== e && (t in N || (N[t] = 0), t in S || (S[t] = 0), N[t] += e, S[t] += e)
    }

    function x(t, e) {
        null !== e && !1 === isNaN(e) && (t in N || (N[t] = 0), (e > N[t] || 0 === N[t]) && (S[t] = e, N[t] = e))
    }
    ...
    function R() {
        ...
        M = {
            gap: t - C
        }, Ur(25), M.gap < 3e5 ? j = D(R, z) : Ha && (O("clarity", "suspend"), ni(), ["mousemove", "touchstart"].forEach((function(t) {
    ...
    function U(t) {
        qa() && u.lean && (u.lean = !1, P = {
            key: t
        }, ha(), u.upgrade && u.upgrade(t), Ur(3))
    }
    var B = Object.freeze({
            __proto__: null,
            get data() {
    ...
    function G(t, e) {
        if (qa() && t && e && "string" == typeof t && t.length < 255) {
            for (var n = (t in V ? V[t] : []), r = 0; r < e.length; r++) "string" == typeof e[r] && e[r].length < 255 && n.push(e[r]);
            V[t] = n
        }
    }
    ...
    function et(t) {
        return Q(this, void 0, void 0, (function() {
            ...
            return $(this, (function(r) {
                switch (r.label) {
                    case 0:
                        return r.trys.push([0, 3, , 4]), tt ? (e = new ReadableStream({
                            start: function(e) {
                                return Q(this, void 0, void 0, (function() {
    ...
    function at() {
        N = {}, S = {}, _(5), rt.forEach((function(t) {
            return Ta(t.start)()
        }))
    }

    function it() {
        rt.slice().reverse().forEach((function(t) {
            return Ta(t.stop)()
        })), N = {}, S = {}
    }
        ...
        if (void 0 === r && (r = !1), t) switch (n) {
            ...
            case 1:
                switch (e) {
                    ...
                    case "placeholder":
                        return function(t) {
                            for (var e = -1, n = !1, r = !1, a = !1, i = null, o = 0; o < t.length; o++) {
                                var u = t.charCodeAt(o);
                                n = n || u >= 48 && u <= 57, r = r || 64 === u, a = 9 === u || 10 === u || 13 === u || 32 === u, (0 === o || o === t.length - 1 || a) && ((n || r) && (null === i && (i = t.split("")), lt(i, e, a ? o : o + 1)), a && (n = !1, r = !1, e = o))
                            }
                            return i ? i.join("") : t
                        }(t);
                    case "input":
    ...
    function ft(t, e) {
        ...
        var n = t.attributes,
            ...
            a = e || n && !("class" in n) || dt.indexOf(t.tag) >= 0 ? ":nth-of-type(" + t.position + ")" : "";
        switch (t.tag) {
            case "STYLE":
            case "TITLE":
            case "LINK":
            ...
            default:
                ...
                if (e) {
                    ...
                    i = (o = "BODY" !== t.tag && o ? o.filter((function(t) {
                        return !ht(t)
                    })) : []).length > 0 ? "" + r + t.tag + "." + o.join(".") + a : i, i = u && !1 === ht(u) ? function(t) {
    ...
    function kt() {
        var t = vt.shift();
        t && (gt = t, t.task().then((function() {
            t.id === la() && (t.resolve(), gt = null, kt())
        })).catch((function(e) {
            t.id === la() && (e && Tr(0, 1, e.name, e.message, e.stack), gt = null, kt())
        })))
    }

    function Et(t) {
        var e = St(t);
        return e in pt ? performance.now() - pt[e].start > pt[e].yield ? 0 : 1 : 2
    }
    ...
    var Tt = window.requestIdleCallback || function(t, e) {
    ...
    function Rt(t, e, n) {
        return void 0 === e && (e = null), void 0 === n && (n = null), Q(this, void 0, void 0, (function() {
            var r, a, i, o, s, c, d, f, h, p, v, g, y, w, k, E, O, M, N, S, _, T, x, D, I, C;
            return $(this, (function(z) {
                switch (z.label) {
                    case 0:
                        ...
                        return [3, 11];
                    case 1:
                        return i = xt, a.push(i.width), a.push(i.height), m(t, i.width, i.height), gr(a), [3, 11];
                    case 2:
                        for (o = 0, s = Xn; o < s.length; o++) c = s[o], (a = [c.time, 7]).push(c.data.id), a.push(c.data.interaction), a.push(c.data.visibility), a.push(c.data.name), gr(a);
                        return Qn(), [3, 11];
                    case 3:
                        for (d = 0, f = Dt; d < f.length; d++) h = f[d], a.push(h.id), a.push(h.width), a.push(h.height);
                        return jt(), gr(a), [3, 11];
                    case 4:
                        ...
                        v = 0, g = p, z.label = 5;
                    case 5:
                        return v < g.length ? (y = g[v], 0 !== (w = Et(e)) ? [3, 7] : [4, Nt(e)]) : [3, 9];
                    case 6:
                        w = z.sent(), z.label = 7;
                    case 7:
                        if (2 === w) return [3, 9];
                        for (k = y.data, E = y.metadata.active, O = y.metadata.suspend, M = y.metadata.privacy, N = function(t) {
                                var e = t.metadata.privacy;
                                return "*T" === t.data.tag && !(0 === e || 1 === e)
                            }(y), S = E ? ["tag", "attributes", "value"] : ["tag"], function(t) {
                                if (!1 !== It && (Ct = null === Ct ? new ResizeObserver(zt) : Ct)) {
                                    var e = zn(t);
                                    if (e && null !== e.metadata.size && 0 === e.metadata.size.length) {
                                        ...
                                        if (n && n.nodeType === Node.ELEMENT_NODE) {
                                            ...
                                            e.metadata.size = [Math.floor(100 * a.width), Math.floor(100 * a.height)], Ct.observe(r)
                                        }
                                    }
                                }
                            }(y.id), _ = 0, T = S; _ < T.length; _++)
                            if (k[x = T[_]]) switch (x) {
                                case "tag":
                                    D = y.metadata.size, I = N ? -1 : 1, a.push(y.id * I), y.parent && E && a.push(y.parent), y.previous && E && a.push(y.previous), a.push(O ? "*M" : k[x]), D && 2 === D.length && a.push("#" + At(D[0]) + "." + At(D[1]));
                                    break;
                                case "attributes":
                                    for (C in k[x]) void 0 !== k[x][C] && a.push(Yt(C, k[x][C], M));
                                    break;
                                case "value":
    ...
    function Xt() {
        ...
        null !== xt && s === xt.width && v === xt.height || null === s || null === v || (xt = {
            width: s,
            height: v
        }, Rt(8))
    }
    ...
    function ee(t) {
        ...
        if (e && e.type && n) {
            ...
            te.length > 0 && te[te.length - 1].data.target === a.target && te.pop(), te.push({
                time: l(),
                event: 27,
                data: a
            }), I($t), $t = D(ne, 500, 27)
    ...
    function se(t, e, n) {
        ...
        if (i)
            for (var u = 0; u < i.length; u++) {
                ...
                c = c && r ? c + Math.round(r.offsetLeft) : c, d = d && r ? d + Math.round(r.offsetTop) : d, null !== c && null !== d && ce({
                    time: o,
                    event: t,
                    data: {
                        target: $n(n),
    ...
    function ce(t) {
        switch (t.event) {
            ...
            case 19:
                ...
                }(n, t) && ie.pop(), ie.push(t), I(oe), oe = D(le, 500, t.event);
                break;
            default:
    ...
    function ge(t) {
        ...
        if ((null !== t || 0 !== i || 0 !== o) && null !== i && null !== o) {
            ...
            }(c, u) && pe.pop(), pe.push(u), I(ve), ve = D(me, 500, 10)
        }
    }
    ...
    function ke(t) {
        ...
        if (null !== e && !(null === e.anchorNode && null === e.focusNode || e.anchorNode === e.focusNode && e.anchorOffset === e.focusOffset)) {
            ...
            null !== ye && null !== be.start && n !== e.anchorNode && (I(we), Ee(21)), be = {
                start: e.anchorNode,
                startOffset: e.anchorOffset,
                end: e.focusNode,
                endOffset: e.focusOffset
            }, ye = e, I(we), we = D(Ee, 500, 21)
        }
    }
    ...
    function ze(t) {
        ...
        }(t), t.nodeType === Node.DOCUMENT_NODE && (Ut(t), function(t) {
            Da(t, "cut", Kt.bind(this, 0), !0), Da(t, "copy", Kt.bind(this, 1), !0), Da(t, "paste", Kt.bind(this, 2), !0)
        }(t), function(t) {
            Da(t, "mousedown", ue.bind(this, 13, t), !0), Da(t, "mouseup", ue.bind(this, 14, t), !0), Da(t, "mousemove", ue.bind(this, 12, t), !0), Da(t, "mousewheel", ue.bind(this, 15, t), !0), Da(t, "dblclick", ue.bind(this, 16, t), !0), Da(t, "touchstart", se.bind(this, 17, t), !0), Da(t, "touchend", se.bind(this, 18, t), !0), Da(t, "touchmove", se.bind(this, 19, t), !0), Da(t, "touchcancel", se.bind(this, 20, t), !0)
        }(t), function(t) {
            Da(t, "input", ee, !0)
        }(t), function(t) {
            Da(t, "selectstart", ke.bind(this, t), !0), Da(t, "selectionchange", ke.bind(this, t), !0)
        }(t), function(t) {
            Da(t, "submit", _e, !0)
        }(t))
    }
    var je = Object.freeze({
            __proto__: null,
            start: function() {
                nr = [], ar(), Gt(), Qt(), de(), re(), Da(window, "resize", fe), fe(), Da(document, "visibilitychange", Ie), Ie(), pe = [], ge(), Oe(), Te(), Da(window, "pagehide", xe)
            },
            stop: function() {
                nr = [], ar(), Gt(), Qt(), I(oe), ie.length > 0 && le(ie[ie.length - 1].event), I($t), re(), he(), Ce(), I(ve), pe = [], Oe(), I(we), Te(), De()
            },
            observe: ze
        }),
        Le = /[^0-9\.]/g;
    ...
    function Re(t) {
        for (var e = 0, n = Object.keys(t); e < n.length; e++) {
            var r = n[e],
                a = t[r];
            if ("@type" === r && "string" == typeof a) switch (a = (a = a.toLowerCase()).indexOf("article") >= 0 || a.indexOf("posting") >= 0 ? "article" : a) {
                case "article":
                case "recipe":
                    ta(5, t[r]), ta(8, t.creator), ta(18, t.headline);
                    break;
                case "product":
                    ta(5, t[r]), ta(10, t.name), ta(12, t.sku), t.brand && ta(6, t.brand.name);
                    break;
                case "aggregaterating":
                    t.ratingValue && (x(11, Ae(t.ratingValue, 100)), x(18, Ae(t.bestRating)), x(19, Ae(t.worstRating))), x(12, Ae(t.ratingCount)), x(17, Ae(t.reviewCount));
                    break;
                case "person":
                    ta(8, t.name);
                    break;
                case "offer":
                    ta(7, t.availability), ta(14, t.itemCondition), ta(13, t.priceCurrency), ta(12, t.sku), x(13, Ae(t.price));
                    break;
                case "brand":
                    ta(6, t.name)
            }
    ...
    function Xe(e, n) {
        ...
        switch (e.nodeType) {
            ...
            case Node.DOCUMENT_FRAGMENT_NODE:
                var c = e;
                if (c.host)
                    if (Mn(c), "function" === typeof c.constructor && c.constructor.toString().indexOf("[native code]") >= 0) {
                        We(c);
                ...
                break;
            case Node.TEXT_NODE:
                if (i = i || e.parentNode, "update" === a || i && Rn(i) && "STYLE" !== i.tagName) {
                    var p = {
                        tag: "*T",
                        value: e.nodeValue
                    };
            ...
            case Node.ELEMENT_NODE:
                ...
                switch (i = e.parentElement ? e.parentElement : e.parentNode ? e.parentNode : null, "http://www.w3.org/2000/svg" === v.namespaceURI && (g = "svg:" + g), g) {
                    ...
                    case "IFRAME":
                        ...
                        Tn(O) && (! function(t) {
                            !1 === Rn(t) && Da(t, "load", on.bind(this, t, "childList"), !0)
    ...
    function Pe(t) {
        ...
        try {
            ...
            if (Tr(1, 1, t ? t.name : null), t && "SecurityError" !== t.name) throw t
        }
        if (null !== n)
        ...
        return Q(this, void 0, void 0, (function() {
            ...
            return $(this, (function(c) {
                switch (c.label) {
                    ...
                    case 2:
                        return n < r.length ? (a = r[n], 0 !== (i = Et(t)) ? [3, 4] : [4, Nt(t)]) : [3, 6];
                    case 3:
                        i = c.sent(), c.label = 4;
                    case 4:
                        if (2 === i) return [3, 6];
                        switch (o = a.target, (u = function(t, e) {
                            ...
                            return t.type
                        }(a, t)) && o && o.ownerDocument && Mn(o.ownerDocument), u && o && o.nodeType == Node.DOCUMENT_FRAGMENT_NODE && o.host && Mn(o), u) {
                            case "attributes":
                                Xe(o, 3);
                                break;
                            case "characterData":
    ...
    function an(t, e) {
        return void 0 === e && (e = !1), Ze.indexOf(t) < 0 && Ze.push(t), Ke && I(Ke), Ke = D((function() {
            ! function(t) {
    ...
    var un = 1,
        ...
        cn = ["addr", "cell", "code", "dob", "email", "mob", "name", "phone", "secret", "social", "ssn", "tel", "zip", "pass", "card", "account", "cvv", "ccv"],
    ...
    function On() {
        un = 1, dn = [], fn = [], hn = [], pn = {}, vn = [], gn = [], bn = new WeakMap, yn = new WeakMap, wn = new WeakMap
    }
    ...
    function Sn(t, e, n, r) {
        var a = Nn(t, !0),
            ...
            l = Fn(t) ? a : null,
            d = null;
        i >= 0 && fn[i] && ((c = fn[i]).children.push(a), l = null === l ? c.region : l, d = c.fragment, s = c.metadata.privacy), s = function(t, e, n, r) {
                var a = e.attributes,
                    i = e.tag.toUpperCase();
                ...
                return r
            }(t, n, c, s), n.attributes && "data-clarity-region" in n.attributes && (Vn(t, n.attributes["data-clarity-region"]), l = a), dn[a] = t, fn[a] = {
                id: a,
                parent: i,
                previous: o,
                children: [],
    ...
    function _n(t, e, n, r) {
        ...
        if (a in fn) {
            ...
            c.fragment && mn[c.fragment] && (u = !0), In(c), Hn(a, r, fn[a].fragment, u, s)
        }
    }
    ...
    function In(t) {
        ...
        t.selector = [ft(i), ft(i, !0)], t.hash = t.selector.map((function(t) {
            return t ? f(t) : null
    ...
    function Hn(t, e, n, r, a) {
        if (void 0 === n && (n = null), void 0 === r && (r = !0), void 0 === a && (a = !1), n && !mn[n]) {
            var i = Cn(n),
                o = zn(n);
        ...
        var u = hn.indexOf(t);
        u >= 0 && 1 === e && a ? (hn.splice(u, 1), hn.push(t)) : -1 === u && r && hn.push(t)
    }
    var Xn = [],
        Wn = null,
        qn = {},
    ...
    function Vn(t, e) {
        !1 === Wn.has(t) && (Wn.set(t, e), (Bn = null === Bn && Un ? new IntersectionObserver(Gn, {
            threshold: [0, .2, .4, .6, .8, 1]
        }) : Bn) && t && t.nodeType === Node.ELEMENT_NODE && Bn.observe(t))
    }
    ...
    function Jn() {
        for (var t = [], e = 0, n = Pn; e < n.length; e++) {
            var r = n[e],
                a = Nn(r.node);
            a in qn || (a ? (r.data.id = a, qn[a] = r.data, Xn.push(Kn(r.data))) : t.push(r))
        }
    ...
    function Gn(t) {
        for (var e = 0, n = t; e < n.length; e++) {
            ...
            if (Wn.has(a) && i.width + i.height > 0 && u.width > 0 && u.height > 0) {
                ...
                Zn(a, c, c.interaction, d ? 13 : l ? 10 : 0), c.visibility >= 13 && Bn && Bn.unobserve(a)
            }
        }
        Xn.length > 0 && Rt(7)
    }
    ...
    function Zn(t, e, n, r) {
        ...
        e.interaction = n > e.interaction ? n : e.interaction, e.visibility = r > e.visibility ? r : e.visibility, e.id ? (e.id in qn && a || !(e.id in qn)) && (qn[e.id] = e, Xn.push(Kn(e))) : Pn.push({
            node: t,
            data: e
        })
    }
    ...
    function tr(t, e) {
        ...
        if (t) {
            var r = jn(t);
            null !== r && (n.id = r.id, n.hash = r.hash, n.privacy = r.metadata.privacy, r.region && function(t, e) {
                var n = Cn(t),
                    r = t in qn ? qn[t] : {
                        id: t,
                        visibility: 0,
    ...
    function er(t) {
        return Q(this, void 0, void 0, (function() {
            var e, n, r, a, i, o, u, s, c, d, f, h, p, v, g, b, w, k, E, O, M, N, S, _, T, x, D, I, C;
            return $(this, (function(z) {
                switch (e = l(), n = [e, t], t) {
                    case 13:
                    case 14:
                    ...
                    case 19:
                    case 20:
                        for (r = 0, a = ie; r < a.length; r++) I = a[r], (i = tr(I.data.target, I.event)).id > 0 && ((n = [I.time, I.event]).push(i.id), n.push(I.data.x), n.push(I.data.y), gr(n), m(I.event, I.data.x, I.data.y));
                        de();
                        break;
                    case 9:
                        for (o = 0, u = Pt; o < u.length; o++) I = u[o], s = tr(I.data.target, I.event), n = [I.time, I.event], c = s.hash.join("."), n.push(s.id), n.push(I.data.x), n.push(I.data.y), n.push(I.data.eX), n.push(I.data.eY), n.push(I.data.button), n.push(I.data.reaction), n.push(I.data.context), n.push(ut(I.data.text, "click", s.privacy)), n.push(I.data.link), n.push(c), gr(n), ir(I.time, I.event, c, I.data.x, I.data.y, I.data.reaction, I.data.context);
                        Gt();
                        break;
                    case 38:
                        for (d = 0, f = Zt; d < f.length; d++) I = f[d], n = [I.time, I.event], (T = tr(I.data.target, I.event)).id > 0 && (n.push(T.id), n.push(I.data.action), gr(n));
                        Qt();
                        break;
                    case 11:
                        h = ae, n.push(h.width), n.push(h.height), m(t, h.width, h.height), he(), gr(n);
                        break;
                    case 26:
                        p = Me, n.push(p.name), De(), gr(n);
                        break;
                    case 27:
                        for (v = 0, g = te; v < g.length; v++) I = g[v], b = tr(I.data.target, I.event), (n = [I.time, I.event]).push(b.id), n.push(I.data.value), gr(n);
                        re();
                        break;
                    case 21:
                        (w = be) && (k = tr(w.start, t), E = tr(w.end, t), n.push(k.id), n.push(w.startOffset), n.push(E.id), n.push(w.endOffset), Oe(), gr(n));
                        break;
                    case 10:
                        for (O = 0, M = pe; O < M.length; O++) I = M[O], (N = tr(I.data.target, I.event)).id > 0 && ((n = [I.time, I.event]).push(N.id), n.push(I.data.x), n.push(I.data.y), gr(n), m(I.event, I.data.x, I.data.y));
                        pe = [];
                        break;
                    case 39:
                        for (S = 0, _ = Se; S < _.length; S++) I = _[S], n = [I.time, I.event], (T = tr(I.data.target, I.event)).id > 0 && (n.push(T.id), gr(n));
                        Te();
                        break;
                    case 22:
                        for (x = 0, D = rr; x < D.length; x++) I = D[x], (n = [I.time, I.event]).push(I.data.type), n.push(I.data.hash), n.push(I.data.x), n.push(I.data.y), n.push(I.data.reaction), n.push(I.data.context), gr(n, !1);
                        ar();
                        break;
                    case 28:
    ...
    var or, ur, sr, cr, lr, dr = 0,
        fr = 0,
        hr = null,
        pr = 0;

    function vr() {
        cr = !0, dr = 0, fr = 0, pr = 0, or = [], ur = [], sr = {}, lr = null
    }
    ...
    function gr(t, e) {
        if (void 0 === e && (e = !0), cr) {
            ...
            n - pr > 2 * i && (I(hr), hr = null), e && null === hr && (25 !== r && L(), hr = D(br, i), pr = n, Vr(fr))
        }
    }

    function mr() {
        I(hr), br(!0), dr = 0, fr = 0, pr = 0, or = [], ur = [], sr = {}, lr = null, cr = !1
    }
    ...
    function br(t) {
        return void 0 === t && (t = !1), Q(this, void 0, void 0, (function() {
            ...
            return $(this, (function(l) {
                switch (l.label) {
                    case 0:
                        return hr = null, (e = !1 === u.lean && fr > 0 && (fr < 1048576 || Ea.sequence > 0)) && x(1, 1), Jn(),
                            function() {
                                var t = [];
                                rr = [];
                                for (var e = Ea.start + Ea.duration, n = Math.max(e - 2e3, 0), r = 0, a = nr; r < a.length; r++) {
                                    var i = a[r];
                                    i.time >= n && (i.time <= e && rr.push(i), t.push(i))
                                }
                                nr = t, er(22)
                            }(), ot(), n = !0 === t, r = JSON.stringify(Na(n)), a = "[" + ur.join() + "]", i = e ? "[" + or.join() + "]" : "", o = function(t) {
                    ...
                    case 2:
                        c = l.sent(), l.label = 3;
                    case 3:
                        return T(2, (s = c) ? s.length : o.length), yr(o, s, Ea.sequence, n), ur = [], e && (or = [], fr = 0, dr = 0), [2]
                }
            }))
        }))
    }
    ...
    function wr(t, e) {
        var n = sr[e];
        t && 4 === t.readyState && n && ((t.status < 200 || t.status > 208) && n.attempts <= 1 ? t.status >= 400 && t.status < 500 ? Fr(6) : (0 === t.status && (u.upload = u.fallback ? u.fallback : u.upload), yr(n.data, null, e)) : (lr = {
            sequence: e,
            attempts: n.attempts,
            status: t.status
        }, n.attempts > 1 && Ur(2), 200 === t.status && t.responseText && function(t) {
        ...
        }(t.responseText), 0 === t.status && (yr(n.data, null, e, !0), Fr(3)), t.status >= 200 && t.status <= 208 && kr(e), delete sr[e]))
    }
    ...
    function Mr(t) {
        var e = t.error || t;
        if (e.message in Or || (Or[e.message] = 0), Or[e.message]++ >= 5) return !0;
        if (e && e.message) {
            if (Er = {
                    message: e.message,
                    line: t.lineno,
                    ...
                    stack: e.stack,
                    source: t.filename
                }, e.message.indexOf("ResizeObserver") >= 0) return Lt(), !1;
            Nr(31)
        }
        return !0
    }
    ...
    function Nr(t) {
        return Q(this, void 0, void 0, (function() {
            ...
            return $(this, (function(n) {
                switch (e = [l(), t], t) {
                    case 31:
                        e.push(Er.message), e.push(Er.line), e.push(Er.column), e.push(Er.stack), e.push(Er.source), gr(e);
                        break;
                    case 33:
                        Sr && (e.push(Sr.code), e.push(Sr.name), e.push(Sr.message), e.push(Sr.stack), e.push(Sr.severity), gr(e, !1))
                }
                return [2]
            }))
        }))
    ...
    function Tr(t, e, n, r, a) {
        ...
        var i = n ? n + "|" + r : "";
        t in _r && _r[t].indexOf(i) >= 0 || (Sr = {
            code: t,
            name: n,
            message: r,
            stack: a,
            severity: e
        }, t in _r ? _r[t].push(i) : _r[t] = [i], Nr(33))
    }
    var xr, Dr = {},
        Ir = [],
        Cr = {},
    ...
    function Hr(t, e, n) {
        void 0 === n && (n = !1), (!(t in Dr) || t in Dr && Dr[t] !== e || n) && (Dr[t] = e, Ir.push(t))
    }
    ...
    function Ur(t) {
        ...
        switch (t) {
            case 4:
                var n = h;
                n && ((e = [n.time, n.event]).push(n.data.visible), e.push(n.data.docWidth), e.push(n.data.docHeight), e.push(n.data.screenWidth), e.push(n.data.screenHeight), e.push(n.data.scrollX), e.push(n.data.scrollY), e.push(n.data.pointerX), e.push(n.data.pointerY), e.push(n.data.activityTime), gr(e, !1)), g();
                break;
            case 25:
                e.push(M.gap), gr(e);
                break;
    ...
    function Vr(t) {
        if (0 === xr.check) {
            var e = xr.check;
            e = Ea.sequence >= 128 ? 1 : e, e = l() > 72e5 ? 2 : e, (e = t > 10485760 ? 2 : e) !== xr.check && Fr(e)
        }
    }
    ...
    function ta(t, e) {
        e && (e = "" + e, t in Zr || (Zr[t] = []), Zr[t].indexOf(e) < 0 && (Zr[t].push(e), t in Kr || (Kr[t] = []), Kr[t].push(e), Zr[t].length > 128 && Fr(5)))
    }
    ...
    function oa() {
        ...
        var t = navigator && "userAgent" in navigator ? navigator.userAgent : "",
            ...
            n = function() {
                ...
                if (e) {
                    var n = e.split("|");
                    n.length >= 5 && t.ts - ma(n[1]) < 18e5 && (t.session = n[0], t.count = ma(n[2]) + 1, t.upgrade = ma(n[3]), t.upload = n.length >= 6 ? "https://" + n[5] + "/" + n[4] : "https://" + n[4])
                }
                return t
            }(),
            r = ba();
        ra = {
            ...
            sessionId: n.session,
            pageNum: n.count
        }, u.lean = u.track && null !== n.upgrade ? 0 === n.upgrade : u.lean, u.upload = u.track && "string" == typeof u.upload && n.upload && n.upload.length > "https://".length ? n.upload : u.upload, ta(0, t), ta(3, e), ta(1, location.href), ta(2, document.referrer), ta(15, function() {
            var t = ga();
            ...
            return t
        }()), ta(16, document.documentElement.lang), ta(17, document.dir), navigator && (ta(9, navigator.userLanguage || navigator.language), x(26, navigator.webdriver ? 1 : 0), ua()), x(0, n.ts), x(1, 0), screen && (x(14, Math.round(screen.width)), x(15, Math.round(screen.height)), x(16, Math.round(screen.colorDepth)));
    ...
    function ua() {
        navigator.userAgentData && navigator.userAgentData.getHighEntropyValues && navigator.userAgentData.getHighEntropyValues(["model", "platform", "platformVersion", "uaFullVersion"]).then((function(t) {
            var e;
            ta(22, t.platform), ta(23, t.platformVersion), null === (e = t.brands) || void 0 === e || e.forEach((function(t) {
                ta(24, t.name + "~" + t.version)
            })), ta(25, t.model), x(27, t.mobile ? 1 : 0)
        }))
    }
    ...
    function ca(t, e) {
        void 0 === e && (e = !0), ra && !1 === e && t(ra, !u.lean), aa.push({
            callback: t,
            wait: e
        })
    }
    ...
    function ha() {
        var t = Math.round(Date.now()),
            ...
            n = u.lean ? 0 : 1;
        ! function(t) {
            aa.length > 0 && aa.forEach((function(e) {
                !e.callback || e.wait && !t || e.callback(ra, !u.lean)
            }))
        }(n), wa("_clsk", [ra.sessionId, t, ra.pageNum, n, e].join("|"), 1)
    }
    ...
    function va(t, e) {
        ...
        (null === t.expiry || Math.abs(n - t.expiry) >= 1 || t.consent !== e) && wa("_clck", [ra.userId, 1, n.toString(36), e].join("|"), 365)
    }
    ...
    function ba() {
        ...
        if (e && e.length > 0) {
            ...
            n.length > 2 && (t.expiry = ma(n[2], 36)), n.length > 3 && 1 === ma(n[3]) && (t.consent = 1), u.track = u.track || 1 === t.consent, t.id = u.track ? n[0] : t.id
        }
        return t
    }
    ...
    function wa(t, e, n) {
        if (u.track && (navigator && navigator.cookieEnabled || pa(document, "cookie"))) {
            var r = new Date;
            ...
            try {
                if (null === ia) {
                    for (var i = location.hostname ? location.hostname.split(".") : [], o = i.length - 1; o >= 0; o--)
                        if (ia = "." + i[o] + (ia || ""), o < i.length - 1 && (document.cookie = a + ";domain=" + ia, ya(t) === e)) return;
                    ia = ""
                }
            } catch (t) {
                ia = ""
    ...
    function Na(t) {
        return Ea.start = Ea.start + Ea.duration, Ea.duration = l() - Ea.start, Ea.sequence++, Ea.upload = t && "sendBeacon" in navigator ? 1 : 0, Ea.end = t ? 1 : 0, [Ea.version, Ea.sequence, Ea.start, Ea.duration, Ea.projectId, Ea.userId, Ea.sessionId, Ea.pageNum, Ea.upload, Ea.end]
    }
    ...
    function Da(t, e, n, r) {
        void 0 === r && (r = !1), n = Ta(n);
        try {
            t[s("addEventListener")](e, n, r), xa.push({
                event: e,
                target: t,
                listener: n,
                capture: r
    ...
    function Xa() {
        Ha = !0, c = performance.now(), yt(), Ia(), Sa(), ja = Ya(), La = 0, Da(window, "popstate", Aa), null === Ca && (Ca = history.pushState, history.pushState = function() {
            ...
            function(t) {
                Q(this, void 0, void 0, (function() {
                    ...
                    return $(this, (function(r) {
                        switch (e = l(), n = [e, t], t) {
                            case 29:
                                n.push(Fa.fetchStart), n.push(Fa.connectStart), n.push(Fa.connectEnd), n.push(Fa.requestStart), n.push(Fa.responseStart), n.push(Fa.responseEnd), n.push(Fa.domInteractive), n.push(Fa.domComplete), n.push(Fa.loadEventStart), n.push(Fa.loadEventEnd), n.push(Fa.redirectCount), n.push(Fa.size), n.push(Fa.type), n.push(Fa.protocol), n.push(Fa.encodedSize), n.push(Fa.decodedSize), Ja(), gr(n, !1)
                        }
                        return [2]
                    }))
                }))
    ...
    var Za = ["navigation", "resource", "longtask", "first-input", "layout-shift", "largest-contentful-paint"];
    ...
    function Ka() {
        try {
            ...
            for (var t = 0, e = Za; t < e.length; t++) {
                var n = e[t];
                PerformanceObserver.supportedEntryTypes.indexOf(n) >= 0 && ("layout-shift" === n && T(9, 0), Va.observe({
                    type: n,
                    buffered: !0
                }))
            }
    ...
    var ti = [Object.freeze({
        ...
        __proto__: null,
        start: function() {
            Ht(), Xt(), Qn(), Bn = null, Wn = new WeakMap, qn = {}, Pn = [], Un = !!window.IntersectionObserver, kn(),
                function() {
                    if (Be = [], Ze = [], Ke = null, Qe = 0, $e = {}, null === Fe && (Fe = CSSStyleSheet.prototype.insertRule, CSSStyleSheet.prototype.insertRule = function() {
                        ...
                        try {
                            Element.prototype.attachShadow = function() {
                                return qa() ? an(Ge.apply(this, arguments)) : Ge.apply(this, arguments)
                            }
                        } catch (t) {
                            Ge = null
                        }
                    ...
                    Ta(Xt)(), Ta(Jn)()
                })), jt(), Ct = null, It = !!window.ResizeObserver
        },
        stop: function() {
            Qn(), Wn = null, qn = {}, Pn = [], Bn && (Bn.disconnect(), Bn = null), Un = !1, En(),
                function() {
        ...
        start: function() {
            Ja(),
                function() {
                    window.PerformanceObserver && PerformanceObserver.supportedEntryTypes ? "complete" !== document.readyState ? Da(window, "load", D.bind(this, Ka, 0)) : Ka() : Tr(3, 0)
                }()
        },
        stop: function() {
    ...
    function ei(t) {
        void 0 === t && (t = null),
            function() {
                try {
                    return !1 === Ha && "undefined" != typeof Promise && window.MutationObserver && document.createTreeWalker && "now" in Date && "now" in performance && "undefined" != typeof WeakMap
                } catch (t) {
                    return !1
                }
            }() && (Pa(t), Xa(), at(), ti.forEach((function(t) {
                return Ta(t.start)()
            })))
    }

    function ni() {
        qa() && (ti.slice().reverse().forEach((function(t) {
            return Ta(t.stop)()
        })), it(), Wa())
    }
    var ri = Object.freeze({
        ...
        start: ei,
        pause: function() {
            qa() && (O("clarity", "pause"), null === mt && (mt = new Promise((function(t) {
                bt = t
            }))))
        },
        resume: function() {
            qa() && (mt && (bt(), mt = null, null === gt && kt()), O("clarity", "resume"))
        },
        stop: ni,
        consent: da,
        event: O,
